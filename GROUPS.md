...
Please read <http://minecraft.gamepedia.com/Breaking> to learn how digging times work in Minecraft, as VoxelCraft is based on the same system.
...
* `soil_fungus=1`: Nether fungus will grow on this
