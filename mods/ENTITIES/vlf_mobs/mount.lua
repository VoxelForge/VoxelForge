...
function vlf_mobs.attach(entity, player)
...
function vlf_mobs.drive(entity, moving_anim, stand_anim, can_fly, dtime)
...
function vlf_mobs.fly_drive(entity, dtime, speed, shoots, arrow, moving_anim, stand_anim)
	local ctrl = entity.driver:get_player_control()
	local velo = entity.object:get_velocity()
...
vlf_mobs.mob_class.drive = vlf_mobs.drive
vlf_mobs.mob_class.fly_drive = vlf_mobs.fly_drive
vlf_mobs.mob_class.attach = vlf_mobs.attach
