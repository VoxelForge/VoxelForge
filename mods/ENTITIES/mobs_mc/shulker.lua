...
vlf_mobs.register_mob("mobs_mc:shulker", {
	...
	animation = {
		stand_start = 0, stand_end = 25, stand_speed = 25,
		walk_start = 45, walk_end = 65, walk_speed = 25, walk_loop = false,
		run_start = 65, run_end = 85, run_speed = 50, run_loop = false,
        punch_start = 80,  punch_end = 100, punch_speed = 25,
	},
	view_range = 16,
	fear_height = 0,
	walk_velocity = 0,
...
vlf_mobs.register_arrow("mobs_mc:shulkerbullet", {
	...
	hit_player = function (self, player)
	    vlf_entity_effects.give_effect_by_level ("levitation", player, 1, 10)
	    vlf_mobs.get_arrow_damage_func (4) (self, player)
	end,
	hit_mob = function (self, mob)
	    vlf_entity_effects.give_effect_by_level ("levitation", mob, 1, 10)
