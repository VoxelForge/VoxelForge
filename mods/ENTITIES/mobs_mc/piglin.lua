...
local trading_items = {
	...
	{ itemstring = "vlf_effects:water", weight = 40, amount_min = 1, amount_max = 1 },
	...
	{ itemstring = "vlf_effects:fire_resistance", weight = 8, amount_min = 1, amount_max = 1 },
	{ itemstring = "vlf_effects:fire_resistance_splash", weight = 8, amount_min = 1, amount_max = 1 },
