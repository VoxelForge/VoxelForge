...
minetest.register_node("mobs_mc:firefly_spawner", {
    ...
    post_effect_color = {a=255, r=0x1C, g=0x3C, b=0x5C},
})
...
minetest.register_lbm({
    ...
    action = function(pos, node, metadata, run_at_every_load)
        ...
        if biome_match then
        	...
        	if not minetest.get_node(pos_below).name == "mobs_mc:firefly_spawner" or not minetest.get_node(pos_below).name == "air" then
