...
local wither_head = minetest.registered_nodes["vlf_heads:wither_skeleton"]
local old_on_place = wither_head.on_place
minetest.override_item("vlf_heads:wither_skeleton",{
	on_place = function(itemstack, placer, pointed)
		local n = minetest.get_node(vector.offset(pointed.above,0,-1,0))
		if n and n.name  == "vlf_nether:soul_sand" then
