...
local names = { S("Oak Boat"), S("Spruce Boat"), S("Birch Boat"), S("Jungle Boat"), S("Acacia Boat"), S("Dark Oak Boat"), S("Mangrove Boat"), S("Oak Boat with Chest"), S("Spruce Boat with Chest"), S("Birch Boat with Chest"), S("Jungle Boat with Chest"), S("Acacia Boat with Chest"), S("Dark Oak Boat with Chest"), S("Mangrove Boat with Chest") }
