...
### Mob definition table
{
	...
	'immune_to'			is a table that holds specific damage when being hit by certain items e.g.
	...
	'animation'		holds a table containing animation names and settings for use with mesh models:
		Using '_loop = false' setting will stop any of the animations from looping.
		'speed_normal' is used for animation speed for compatibility with some older mobs.
	{
