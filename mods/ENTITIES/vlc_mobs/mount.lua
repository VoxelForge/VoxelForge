...
function vlc_mobs.attach(entity, player)
	...
	minetest.after(0.2, function(name)
		...
		if player then
			vlc_player.player_set_animation(player, "sit_mount" , 30)
		end
...
function vlc_mobs.detach(player, offset)
...
function vlc_mobs.drive(entity, moving_anim, stand_anim, can_fly, dtime)
...
function vlc_mobs.fly_drive(entity, dtime, speed, shoots, arrow, moving_anim, stand_anim)
	local ctrl = entity.driver:get_player_control()
	local velo = entity.object:get_velocity()
...
vlc_mobs.mob_class.drive = vlc_mobs.drive
vlc_mobs.mob_class.fly_drive = vlc_mobs.fly_drive
vlc_mobs.mob_class.attach = vlc_mobs.attach
