...
function vlf_luck.apply_luck_modifier(player_name, modifier_name, amount)
	applied_luck[player_name][modifier_name] = amount
end

function vlf_luck.remove_luck_modifier(player_name, modifier_name)
	applied_luck[player_name][modifier_name] = nil
end

function vlf_luck.get_luck(player_name)
	local luck = 0
