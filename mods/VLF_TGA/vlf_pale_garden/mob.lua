        ...
        for y = -2, 2 do
            for z = -2, 2 do
                if math.abs(x) + math.abs(y) + math.abs(z) <= 2 then
                    ...
                    if node and node.name == "vlf_trees:tree_pale_oak" then
...
vlf_mobs.register_mob("vlf_pale_garden:creaking", creaking)
vlf_mobs.register_mob("vlf_pale_garden:creaking_transient", creaking_transient)
vlf_mobs.register_egg("vlf_pale_garden:creaking", S("Creaking"), "#A56C68", "#663939", 0)
