...
minetest.register_chatcommand("xp", {
	...
	func = function(name, params)
		...
		return true, S("Added @1 XP to @2, total: @3, experience level: @4", tostring(xp), player:get_player_name(), tostring(vlc_experience.get_xp(player)), tostring(vlc_experience.get_level(player)))
	end,
})
