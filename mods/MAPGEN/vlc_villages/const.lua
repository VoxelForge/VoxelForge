...
function settlements.debug(message)
	...
	-- minetest.log("warning", "[vlc_villages] "..message)
	minetest.log("verbose", "[vlc_villages] "..message)
end
...
function settlements.grundstellungen()
	settlements.surface_mat = settlements.Set {
		...
		--"vlc_core:dry_dirt_with_grass",
		"vlc_core:dirt_with_grass_snow",
		--"vlc_core:dirt_with_dry_grass",
		"vlc_core:podzol",
		"vlc_core:sand",
		"vlc_core:redsand",
		--"vlc_core:silver_sand",
		"vlc_core:snow"
	}
end
--
...
--schem_path = minetest.get_modpath("vlc_schematics") .. "/schems/new/"
--
-- list of schematics
--
