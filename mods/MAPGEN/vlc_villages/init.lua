...
minetest.register_node("vlc_villages:structblock", {drawtype="airlike",groups = {not_in_creative_inventory=1},})
...
if minetest.get_modpath("mobs_mc") then
  vlc_mobs:register_spawn("mobs_mc:villager", --name
    {"vlc_core:stonebrickcarved"}, --nodes
    15, --max_light
    0, --min_light
    20, --chance
...
if mg_name ~= "singlenode" then
	vlc_mapgen_core.register_generator("villages", nil, function(minp, maxp, blockseed)
		...
		if n and n.name == "vlc_villages:structblock" then return end
		...
		minetest.set_node(minp,{name="vlc_villages:structblock"})
...
minetest.register_lbm({
	name = "vlc_villages:structblock",
	run_at_every_load = true,
	nodenames = {"vlc_villages:structblock"},
...
if minetest.is_creative_enabled("") then
	minetest.register_craftitem("vlc_villages:tool", {
		description = S("vlc_villages build tool"),
	...
	vlc_wip.register_experimental_item("vlc_villages:tool")
end
