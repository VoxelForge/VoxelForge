...
vlf_structures.register_structure("pillager_outpost",{
	...
	filenames = {
		modpath.."/schematics/vlf_structures_pillager_outpost.mts",
		modpath.."/schematics/vlf_structures_pillager_outpost_2.mts"
	},
	loot = {
	...
	after_place = function(p, _, pr)
		...
		vlf_structures.spawn_mobs("mobs_mc:parrot",{"vlf_pressureplates:pressure_plate_stone_off"},p1,p2,pr,3)
		vlf_structures.spawn_mobs("mobs_mc:iron_golem",{"vlf_redstone:button_stone_off"},p1,p2,pr,1)
