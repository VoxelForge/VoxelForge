...
local def = {
	...
	y_offset = -5,
	filenames = {
		vlf_structures.schempath.."/schems/vlf_structures_ruined_portal_1.mts",
		vlf_structures.schempath.."/schems/vlf_structures_ruined_portal_2.mts",
		vlf_structures.schempath.."/schems/vlf_structures_ruined_portal_3.mts",
		vlf_structures.schempath.."/schems/vlf_structures_ruined_portal_4.mts",
		vlf_structures.schempath.."/schems/vlf_structures_ruined_portal_5.mts",
		vlf_structures.schempath.."/schems/vlf_structures_ruined_portal_6.mts",
		vlf_structures.schempath.."/schems/vlf_structures_ruined_portal_99.mts",
	},
	after_place = function(pos, def, pr)
		...
		minetest.bulk_set_node(get_replacements(lava,20,pr),{name="vlf_nether:magma"})
		minetest.bulk_set_node(get_replacements(rack,7,pr),{name="vlf_nether:magma"})
		minetest.bulk_set_node(get_replacements(obby,30,pr),{name="vlf_core:crying_obsidian"})
		minetest.bulk_set_node(get_replacements(obby,10,pr),{name="air"})
		minetest.bulk_set_node(get_replacements(brick,50,pr),{name="vlf_core:stonebrickcracked"})
		brick = minetest.find_nodes_in_area(p1,p2,{"vlf_core:stonebrick"})
		minetest.bulk_set_node(get_replacements(brick,50,pr),{name="vlf_core:stonebrickmossy"})
	end,
	loot = {
