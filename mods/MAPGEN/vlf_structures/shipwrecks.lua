...
local schems = {
	modpath.."/schematics/vlf_structures_shipwreck_full_damaged.mts",
	modpath.."/schematics/vlf_structures_shipwreck_full_normal.mts",
	modpath.."/schematics/vlf_structures_shipwreck_full_back_damaged.mts",
	modpath.."/schematics/vlf_structures_shipwreck_half_front.mts",
	modpath.."/schematics/vlf_structures_shipwreck_half_back.mts",
}
...
vlf_structures.register_structure("shipwreck",{
	...
	after_place = function(p, _, pr)
		...
		if sand and #sand > 0 then
			...
			minetest.swap_node(cpos, {name = "vlf_chests:chest_small"})
		...
		["vlf_chests:chest_small"] = {
			{
				...
				items = {
					...
					{ itemstring = "vlf_armor:helmet_leather_enchanted", weight = 3, func = function(stack, _)
							vlf_enchanting.enchant_uniform_randomly(stack, {"soul_speed"}) end },
					{ itemstring = "vlf_armor:chestplate_leather_enchanted", weight = 3, func = function(stack, _)
							vlf_enchanting.enchant_uniform_randomly(stack, {"soul_speed"}) end },
					{ itemstring = "vlf_armor:leggings_leather_enchanted", weight = 3, func = function(stack, _)
							vlf_enchanting.enchant_uniform_randomly(stack, {"soul_speed"}) end },
					{ itemstring = "vlf_armor:boots_leather_enchanted", weight = 3, func = function(stack, _)
							vlf_enchanting.enchant_uniform_randomly(stack, {"soul_speed"}) end },
