...
vlf_structures.register_structure("ancient_hermitage",{
	...
	sidelen = 32,
	filenames = {
		modpath.."/schematics/vlf_structures_ancient_hermitage.mts",
		modpath.."/schematics/vlf_structures_ancient_hermitage_2.mts",
		modpath.."/schematics/vlf_structures_ancient_hermitage_3.mts",
		modpath.."/schematics/vlf_structures_ancient_hermitage_4.mts",
	},
