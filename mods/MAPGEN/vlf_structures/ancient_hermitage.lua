...
vlf_structures.register_structure("ancient_hermitage",{
	...
	sidelen = 32,
	filenames = {
		vlf_structures.schempath.."/schems/vlf_structures_ancient_hermitage.mts",
		vlf_structures.schempath.."/schems/vlf_structures_ancient_hermitage_2.mts",
		vlf_structures.schempath.."/schems/vlf_structures_ancient_hermitage_3.mts",
		vlf_structures.schempath.."/schems/vlf_structures_ancient_hermitage_4.mts",
	},
