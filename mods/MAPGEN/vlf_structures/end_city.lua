...
vlf_structures.register_structure("end_shipwreck",{
	...
	sidelen = 32,
	filenames = {
		vlf_structures.schempath.."/schems/vlf_structures_end_shipwreck_1.mts",
	},
...
vlf_structures.register_structure("end_boat",{
	...
	sidelen = 20,
	filenames = {
		vlf_structures.schempath.."/schems/vlf_structures_end_boat.mts",
	},
