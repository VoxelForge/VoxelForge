...
local function makegeode(pos,def,pr)
	...
	minetest.emerge_area(p1, p2, function(blockpos, action, calls_remaining, param)
		...
		for k,v in pairs(minetest.find_nodes_in_area(p1,p2,{"vlf_amethyst:amethyst_block"})) do
				...
				if an.name ~= "vlf_amethyst:amethyst_block" then
					if minetest.get_item_group(an.name,"material_stone") > 0 then
						...
						if pr:next(1,5) == 1 then
							set_node_no_bedrock(v,{name="vlf_amethyst:budding_amethyst"})
						end
						all_amethyst = false
					elseif an.name ~= "vlf_amethyst:amethyst_block" and an.name ~= "air" and an.name ~= "vlf_amethyst:budding_amethyst" then
						all_amethyst = false
					end
				end
			end
		...
		for k,v in pairs(minetest.find_nodes_in_area_under_air(p1,p2,{"vlf_amethyst:amethyst_block","vlf_amethyst:budding_amethyst"})) do
