...
vlf_structures.register_structure("desert_well",{
	...
	y_offset = -2,
	biomes = { "Desert" },
	filenames = { modpath.."/schematics/vlf_structures_desert_well.mts" },
		...
		if minetest.registered_nodes["vlf_sus_nodes:sand"] then
			...
			if #sus_poss > 0 then
				...
				for i = 1,pr:next(1,#sus_poss) do
					minetest.swap_node(sus_poss[i],{name="vlf_sus_nodes:sand"})
...
vlf_structures.register_structure("fossil",{
	...
	biomes = { "Desert" },
	filenames = {
		modpath.."/schematics/vlf_structures_fossil_skull_1.mts", -- 4×5×5
		modpath.."/schematics/vlf_structures_fossil_skull_2.mts", -- 5×5×5
		modpath.."/schematics/vlf_structures_fossil_skull_3.mts", -- 5×5×7
		modpath.."/schematics/vlf_structures_fossil_skull_4.mts", -- 7×5×5
		modpath.."/schematics/vlf_structures_fossil_spine_1.mts", -- 3×3×13
		modpath.."/schematics/vlf_structures_fossil_spine_2.mts", -- 5×4×13
		modpath.."/schematics/vlf_structures_fossil_spine_3.mts", -- 7×4×13
		modpath.."/schematics/vlf_structures_fossil_spine_4.mts", -- 8×5×13
	},
})

vlf_structures.register_structure("boulder",{
	filenames = {
		modpath.."/schematics/vlf_structures_boulder_small.mts",
		modpath.."/schematics/vlf_structures_boulder_small.mts",
		modpath.."/schematics/vlf_structures_boulder_small.mts",
		modpath.."/schematics/vlf_structures_boulder.mts",
...
vlf_structures.register_structure("ice_spike_small",{
	filenames = { modpath.."/schematics/vlf_structures_ice_spike_small.mts"	},
},true) --is spawned as a normal decoration. this is just for /spawnstruct
vlf_structures.register_structure("ice_spike_large",{
	sidelen = 6,
	filenames = { modpath.."/schematics/vlf_structures_ice_spike_large.mts"	},
},true) --is spawned as a normal decoration. this is just for /spawnstruct
