...
vlf_structures.register_structure("nether_outpost",{
	...
	filenames = { modpath.."/schematics/vlf_nether_fortresses_nether_outpost.mts" },
	y_offset = 0,
...
local nbridges = {
		modpath.."/schematics/vlf_nether_fortresses_nether_bridge_1.mts",
		modpath.."/schematics/vlf_nether_fortresses_nether_bridge_2.mts",
		modpath.."/schematics/vlf_nether_fortresses_nether_bridge_3.mts",
		modpath.."/schematics/vlf_nether_fortresses_nether_bridge_4.mts",
}
...
vlf_structures.register_structure("nether_outpost_with_bridges",{
	...
	after_place = function(pos, _, pr)
		...
		for _,leg in pairs(legs) do
			while minetest.get_item_group(vlf_vars.get_node(vector.offset(leg,0,-1,0)).name, "solid") == 0 do
				leg = vector.offset(leg,0,-1,0)
				table.insert(bricks,leg)
			end
		end
		vlf_util.bulk_swap_node(bricks, {name = "vlf_nether:nether_brick", param2 = 2})
...
vlf_structures.register_structure("nether_bulwark",{
	...
	y_max = vlf_vars.mg_nether_max - 30,
	filenames = {
		modpath.."/schematics/vlf_nether_fortresses_nether_bulwark_1.mts",
		modpath.."/schematics/vlf_nether_fortresses_nether_bulwark_2.mts",
		modpath.."/schematics/vlf_nether_fortresses_nether_bulwark_3.mts",
		modpath.."/schematics/vlf_nether_fortresses_nether_bulwark_4.mts",
	},
	daughters = {{
			files = {
				modpath.."/schematics/vlf_nether_fortresses_nether_bulwark_interior_1.mts",
				modpath.."/schematics/vlf_nether_fortresses_nether_bulwark_interior_2.mts",
				modpath.."/schematics/vlf_nether_fortresses_nether_bulwark_interior_3.mts",
				modpath.."/schematics/vlf_nether_fortresses_nether_bulwark_interior_4.mts",
			},
