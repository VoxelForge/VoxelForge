...
--[[ Special biome field: _vlf_biome_type:
...
local function register_classic_superflat_biome()
	...
	minetest.register_biome({
		...
		depth_filler = 3,
		node_stone = "vlf_core:dirt",
		y_min = vlf_vars.mg_overworld_min - 512,
...
local function register_biomes()
	...
	* Desert M
	...
	minetest.register_biome({
		...
		node_filler = "vlf_core:dirt",
		depth_filler = 2,
		node_water_top = "vlf_core:ice",
		depth_water_top = 1,
		node_river_water = "vlf_core:ice",
	...
	minetest.register_biome({
		...
		node_top = "vlf_core:dirt_with_grass_snow",
		depth_top = 1,
		node_filler = "vlf_core:dirt",
		depth_filler = 2,
		node_riverbed = "vlf_core:sand",
	...
	minetest.register_biome({
		...
		node_water_top = "vlf_core:ice",
		depth_water_top = 1,
		node_filler = "vlf_core:sandstone",
		depth_filler = 2,
		node_riverbed = "vlf_core:sand",
		depth_riverbed = 2,
		y_min = 1,
	...
	minetest.register_biome({
		name = "Mesa",
		node_top = "vlf_colorblocks:hardened_clay",
		depth_top = 1,
		node_filler = "vlf_colorblocks:hardened_clay",
		node_riverbed = "vlf_core:redsand",
		depth_riverbed = 1,
		node_stone = "vlf_colorblocks:hardened_clay",
		y_min = 11,
		y_max = vlf_vars.mg_overworld_max,
		humidity_point = 0,
		heat_point = 100,
	...
	minetest.register_biome({
		name = "Mesa_sandlevel",
		node_top = "vlf_core:redsand",
		depth_top = 1,
		node_filler = "vlf_colorblocks:hardened_clay_orange",
		depth_filler = 3,
		node_riverbed = "vlf_core:redsand",
		depth_riverbed = 1,
		node_stone = "vlf_colorblocks:hardened_clay_orange",
		y_min = -4,
		y_max = 10,
		humidity_point = 0,
		heat_point = 100,
	...
	minetest.register_biome({
		...
		depth_top = 1,
		node_filler = "vlf_colorblocks:hardened_clay",
		node_riverbed = "vlf_colorblocks:hardened_clay",
		depth_riverbed = 1,
		node_stone = "vlf_colorblocks:hardened_clay",
		y_min = 4,
		y_max = vlf_vars.mg_overworld_max,
	...
	minetest.register_biome({
		...
		node_top = "vlf_core:dirt_with_grass",
		depth_top = 1,
		node_filler = "vlf_core:coarse_dirt",
		depth_filler = 2,
		node_riverbed = "vlf_core:redsand",
		depth_riverbed = 1,
		node_stone = "vlf_colorblocks:hardened_clay",
	...
	minetest.register_biome({
		name = "MangroveSwamp",
		node_top = "vlf_mud:mud",
		depth_top = 1,
		node_filler = "vlf_mud:mud",
		depth_filler = 3,
		node_riverbed = "vlf_core:dirt",
		depth_riverbed = 2,
		y_min = 1,
	...
	minetest.register_biome({
		name = "DeepDark",
		node_top = "vlf_sculk:sculk",
		depth_top = 1,
		node_filler = "vlf_deepslate:deepslate",
		node_riverbed = "vlf_deepslate:deepslate",
		depth_riverbed = 1,
		node_stone = "vlf_deepslate:deepslate",
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = table.merge(stonelike, {"vlf_deepslate:deepslate"}),
		sidelen = 16,
		fill_ratio = 10,
		biomes = { "DeepDark" },
		y_min = vlf_vars.mg_overworld_min,
	...
	for i=1, #overworld_biomes do
		...
		minetest.register_biome({
			...
			heat_point = minetest.registered_biomes[biome].heat_point,
			humidity_point = minetest.registered_biomes[biome].humidity_point,
			y_min = vlf_vars.mg_overworld_min_old,
...
local function register_dimension_biomes()
	...
	minetest.register_decoration({
		...
		height = 6,
		max_height = 10,
		decoration = "vlf_nether:netherrack",
		flags = "all_ceilings",
		param2 = 0,
	})
	minetest.register_decoration({
		...
		sidelen = 16,
		fill_ratio = 10,
		y_min = vlf_vars.mg_nether_min - 10,
		y_max = vlf_vars.mg_lava_nether_max,
		height = 7,
		max_height = 14,
		decoration = "vlf_nether:netherrack",
	...
	minetest.register_biome({
		name = "Nether",
		node_filler = "vlf_nether:netherrack",
		node_stone = "vlf_nether:netherrack",
		node_top = "vlf_nether:netherrack",
		node_water = "air",
		node_river_water = "air",
		node_cave_liquid = "air",
		y_min = vlf_vars.mg_nether_min,

		y_max = vlf_vars.mg_nether_max + 80,
		heat_point = 100,
		humidity_point = 0,
		_vlf_biome_type = "hot",
		_vlf_palette_index = 17,
--		_vlf_skycolor = nether_skycolor,
--		_vlf_fogcolor = "#330808"
	})

	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_nether:netherrack","vlf_nether:glowstone","vlf_blackstone:nether_gold","vlf_nether:quartz_ore","vlf_core:gravel","vlf_nether:soul_sand","vlf_nether:glowstone","vlf_nether:magma"},
		sidelen = 16,
		fill_ratio = 10,
		biomes = { "Nether" },
		y_min = vlf_vars.mg_lava_nether_max,
		y_max = vlf_vars.mg_nether_deco_max,
		decoration = "vlf_nether:netherrack",
		flags = "all_floors",
		param2 = 0,
	})
	...
	minetest.register_biome({
		...
		node_filler = "vlf_nether:netherrack",
		node_stone = "vlf_nether:netherrack",
		node_top = "vlf_blackstone:soul_soil",
		node_water = "air",
		node_river_water = "air",
		node_cave_liquid = "air",
		y_min = vlf_vars.mg_nether_min,
...
--		_vlf_fogcolor = "#1B4745"
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_nether:netherrack","vlf_nether:glowstone","vlf_nether:magma"},
		sidelen = 16,
		fill_ratio = 10,
		biomes = { "SoulsandValley" },
		y_min = vlf_vars.mg_lava_nether_max,
		y_max = vlf_vars.mg_nether_deco_max,
		decoration = "vlf_blackstone:soul_soil",
	...
	minetest.register_ore({
		ore_type       = "blob",
		ore            = "vlf_nether:soul_sand",
		wherein        = { "vlf_nether:netherrack", "vlf_blackstone:soul_soil" },
		clust_scarcity = 100,
		clust_num_ores = 225,
		clust_size     = 15,
		biomes = { "SoulsandValley" },
	...
	minetest.register_biome({
		...
		node_filler = "vlf_nether:netherrack",
		node_stone = "vlf_nether:netherrack",
		node_top = "vlf_crimson:crimson_nylium",
		node_water = "air",
		node_river_water = "air",
		node_cave_liquid = "air",
		y_min = vlf_vars.mg_nether_min,
...
--		_vlf_fogcolor = "#330303"
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_nether:netherrack","vlf_nether:glowstone","vlf_blackstone:nether_gold","vlf_nether:quartz_ore","vlf_core:gravel","vlf_nether:soul_sand","vlf_nether:magma","vlf_blackstone:blackstone"},
		sidelen = 16,
		fill_ratio = 10,
		biomes = { "CrimsonForest" },
		y_min = vlf_vars.mg_lava_nether_max,
		y_max = vlf_vars.mg_nether_deco_max,
		decoration = "vlf_crimson:crimson_nylium",
		flags = "all_floors",
		param2 = 0,
	})
	minetest.register_biome({
		...
		node_filler = "vlf_nether:netherrack",
		node_stone = "vlf_nether:netherrack",
		node_top = "vlf_crimson:warped_nylium",
		node_water = "air",
		node_river_water = "air",
		node_cave_liquid = "air",
		y_min = vlf_vars.mg_nether_min,
...
--		_vlf_fogcolor = "#1A051A"
	...
	minetest.register_decoration({
		...
		y_min = vlf_vars.mg_lava_nether_max,
		y_max = vlf_vars.mg_nether_deco_max,
		decoration = "vlf_crimson:warped_nylium",
		flags = "all_floors",
		param2 = 0,
	})
	minetest.register_biome({
		...
		node_filler = "vlf_nether:netherrack",
		node_stone = "vlf_nether:netherrack",
		node_top = "vlf_blackstone:basalt",
		node_water = "air",
		node_river_water = "air",
		node_cave_liquid = "air",
		y_min = vlf_vars.mg_nether_min,
...
--		_vlf_fogcolor = "#685F70"
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_nether:netherrack","vlf_nether:glowstone","vlf_blackstone:nether_gold","vlf_nether:quartz_ore","vlf_core:gravel","vlf_nether:soul_sand","vlf_blackstone:blackstone","vlf_nether:magma"},
		sidelen = 16,
		fill_ratio = 10,
		biomes = { "BasaltDelta" },
		y_min = vlf_vars.mg_lava_nether_max,
		y_max = vlf_vars.mg_nether_deco_max,
		decoration = "vlf_blackstone:basalt",
		flags = "all_floors",
		param2 = 0,
	})
	...
	minetest.register_ore({
	ore_type       = "blob",
	ore            = "vlf_blackstone:blackstone",
	wherein        =  {"vlf_nether:netherrack","vlf_nether:glowstone","vlf_core:gravel"},
	clust_scarcity = 100,
	clust_num_ores = 400,
	clust_size     = 20,
	biomes = { "BasaltDelta" },
...
--		_vlf_fogcolor = end_fogcolor
	...
	minetest.register_biome({
		...
		humidity_point = 500,
		vertical_blend = 16,
		max_pos = {x = 1250, y = vlf_vars.mg_end_min + 512, z = 1250},
...
--		_vlf_fogcolor = end_fogcolor
	...
	minetest.register_biome({
		...
		node_river_water = "air",
		node_cave_liquid = "air",
		max_pos = {x = 650, y = vlf_vars.mg_end_min + 512, z = 650},
		min_pos = {x = -650, y = vlf_vars.mg_end_min, z = -650},
		heat_point = 50,
		humidity_point = 50,
		vertical_blend = 16,
		_vlf_biome_type = "medium",
...
local function register_biome_ores()
	...
	minetest.register_ore({
		ore_type       = "scatter",
		ore            = "vlf_monster_eggs:monster_egg_stone",
	...
	minetest.register_ore({
		ore_type       = "scatter",
		ore            = "vlf_blackstone:blackstone_gilded",
		wherein        = "vlf_blackstone:blackstone",
		clust_scarcity = 4775,
		clust_num_ores = 2,
		clust_size     = 2,
		y_min          = vlf_vars.mg_nether_min,
	...
	minetest.register_ore({
		ore_type       = "scatter",
		ore            = "vlf_blackstone:nether_gold",
...
local function register_biomelike_ores()
	...
	minetest.register_ore({
		ore_type	= "sheet",
		ore		= "vlf_core:coarse_dirt",
		wherein		= {"vlf_core:podzol", "vlf_core:dirt"},
		clust_scarcity	= 1,
		clust_num_ores	= 12,
		clust_size	= 10,
		y_min		= vlf_vars.mg_overworld_min,
	...
	minetest.register_ore({
		ore_type	= "sheet",
		ore		= "vlf_core:coarse_dirt",
		wherein		= {"vlf_core:dirt_with_grass", "vlf_core:dirt"},
		column_height_max = 1,
	...
	minetest.register_ore({
		ore_type	= "blob",
		ore		= "air",
		wherein		= {"group:hardened_clay", "group:sand","vlf_core:coarse_dirt"},
		clust_scarcity	= 4000,
		clust_size	= 5,
		y_min		= vlf_vars.mg_overworld_min,
		y_max		= vlf_vars.mg_overworld_max,
	...
	minetest.register_ore({
		ore_type	= "blob",
		ore		= "vlf_core:redsandstone",
		wherein		= {"vlf_colorblocks:hardened_clay_orange"},
		clust_scarcity	= 300,
		clust_size	= 8,
		y_min		= vlf_vars.mg_overworld_min,
		y_max		= vlf_vars.mg_overworld_max,
	...
	minetest.register_decoration({
		...
		deco_type = "simple",
		place_on = {"vlf_core:dirt"},
		fill_ratio = 10,
		biomes = { "ExtremeHillsM" },
		decoration = "vlf_core:dirt_with_grass",
		place_offset_y = -1,
	...
	local function stratum(y_min, height, color, seed, is_perfect)
		...
		minetest.register_ore({
			ore_type = "stratum",
			ore = "vlf_colorblocks:hardened_clay_"..color,
			-- Only paint uncolored so the biome can choose
			-- a color in advance.
			wherein = {"vlf_colorblocks:hardened_clay"},
			y_min = y_min,
			y_max = y_max,
...
local function register_dimension_ores()
	...
	minetest.register_ore({
		...
		clust_size      = 5,
		y_min           = vlf_vars.mg_nether_min,
		y_max           = vlf_worlds.layer_to_y(64, "nether"),
		noise_threshold = 0.0,
		noise_params    = {
			offset = 0.5,
			scale = 0.1,
	...
	minetest.register_ore({
		ore_type       = "blob",
		ore            = "vlf_nether:magma",
		wherein         = {"vlf_nether:netherrack"},
		clust_scarcity = 8*8*8,
		clust_num_ores = 45,
		clust_size     = 6,
		y_min          = vlf_worlds.layer_to_y(23, "nether"),
		y_max          = vlf_worlds.layer_to_y(37, "nether"),
		noise_params = {
			offset  = 0,
			scale   = 1,
			spread  = {x=250, y=250, z=250},
	...
	minetest.register_ore({
		ore_type        = "blob",
		ore             = "vlf_nether:glowstone",
		wherein         = {"vlf_nether:netherrack"},
		clust_scarcity  = 26 * 26 * 26,
		clust_size      = 5,
		y_min           = vlf_vars.mg_lava_nether_max + 10,
		y_max           = vlf_vars.mg_nether_max - 13,
		noise_threshold = 0.0,
		noise_params    = {
			offset = 0.5,
			scale = 0.1,
	...
	minetest.register_ore({
		ore_type       = "scatter",
		ore            = "vlf_nether:nether_lava_source",
		wherein         = {"vlf_nether:netherrack"},
	...
	minetest.register_ore({
		...
		biomes         = lava_biomes,
		y_min          = vlf_vars.mg_nether_min,
		y_max          = vlf_vars.mg_lava_nether_max + 1,
	})
	...
	minetest.register_ore({
		...
		clust_size     = 1,
		biomes         = lava_biomes,
		y_min           = vlf_vars.mg_lava_nether_max + 2,
		y_max           = vlf_vars.mg_lava_nether_max + 12,
	})
	...
	minetest.register_ore({
		...
		clust_size     = 1,
		biomes         = lava_biomes,
		y_min           = vlf_vars.mg_lava_nether_max + 13,
		y_max           = vlf_vars.mg_lava_nether_max + 48,
	})
	minetest.register_ore({
		ore_type       = "scatter",
		ore            = "vlf_nether:nether_lava_source",
		...
		clust_size     = 1,
		biomes         = lava_biomes,
		y_min           = vlf_vars.mg_lava_nether_max + 49,
		y_max           = vlf_vars.mg_nether_max - 13,
	})
	...
	minetest.register_ore({
		ore_type        = "stratum",
		ore             = "vlf_end:end_stone",
		wherein         = {"air"},
		biomes          = {"EndSmallIslands","Endborder"},
		y_min           = vlf_vars.mg_end_min+64,
		y_max           = vlf_vars.mg_end_min+80,
		clust_num_ores  = 3375,
		clust_size      = 15,

		noise_params = {
			offset  = vlf_vars.mg_end_min+70,
			scale   = -1,
...
function vlf_biomes.register_grass_decoration(grasstype, offset, scale, biomes)
	local place_on, seed, node
	if grasstype == "fern" then
		node = "vlf_flowers:fern"
		place_on = {"group:grass_block_no_snow", "vlf_core:podzol","vlf_mud:mud"}
		seed = 333
	...
	for b=1, #biomes do
		local param2 = minetest.registered_biomes[biomes[b]]._vlf_palette_index
		minetest.register_decoration({
			deco_type = "simple",
			place_on = place_on,
			sidelen = 16,
...
local register_grass_decoration = vlf_biomes.register_grass_decoration

function vlf_biomes.register_seagrass_decoration(grasstype, offset, scale, biomes)
	local seed, nodes, surfaces, param2, param2_max, y_max
	if grasstype == "seagrass" then
		seed = 16
		param2 = 3
		surfaces = { "vlf_core:dirt", "vlf_core:sand", "vlf_core:gravel", "vlf_core:redsand" }
		nodes = { "vlf_ocean:seagrass_dirt", "vlf_ocean:seagrass_sand", "vlf_ocean:seagrass_gravel", "vlf_ocean:seagrass_redsand" }
		y_max = 0
	elseif grasstype == "kelp" then
		seed = 32
		param2 = 16
		param2_max = 96
		surfaces = { "vlf_core:dirt", "vlf_core:sand", "vlf_core:gravel" }
		nodes = { "vlf_ocean:kelp_dirt", "vlf_ocean:kelp_sand", "vlf_ocean:kelp_gravel" }
		y_max = -6
	end
	local noise = {
		offset = offset,
...
local register_seagrass_decoration = vlf_biomes.register_seagrass_decoration
...
local function register_coral_decos(ck)
	...
	minetest.register_decoration({
		deco_type = "schematic",
		place_on = {"group:sand","vlf_core:gravel","vlf_mud:mud"},
		sidelen = 80,
		noise_params = noise,
		biomes = warm_oceans,
		y_min = coral_min,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_ocean:"..c.."_coral_block"},
		sidelen = 16,
		fill_ratio = 3,
		y_min = coral_min,
		y_max = coral_max,
		decoration = "vlf_ocean:"..c.."_coral",
		biomes = warm_oceans,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_ocean:horn_coral_block"},
		sidelen = 16,
		fill_ratio = 7,
		y_min = coral_min,
		y_max = coral_max,
		decoration = "vlf_ocean:"..c.."_coral_fan",
		biomes = warm_oceans,
		flags = "force_placement, all_floors",
		height = 1,
		height_max = 1,
...
local function register_decorations()
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_sculk:sculk"},
		sidelen = 16,
		fill_ratio = 0.1,
		decoration = "vlf_sculk:catalyst",
		biomes = {"DeepDark"},
		flags = "all_floors",
	})
	-- Coral Reefs
	...
	minetest.register_decoration({
		decoration = "vlf_lush_caves:moss",
		deco_type = "simple",
		place_on = table.merge(stonelike, {"vlf_core:stone","vlf_deepslate:deepslate","vlf_deepslate:tuff", "vlf_core:gravel", "vlf_core:bedrock"}),
		biomes = lushcaves,
		fill_ratio = 10,
		flags = "all_floors, all_ceilings",
		y_min = vlf_vars.mg_overworld_min,
	...
	minetest.register_decoration({
		decoration = "vlf_flowers:tallgrass",
		deco_type = "simple",
		place_on = {"vlf_lush_caves:moss"},
		biomes = lushcaves,
		fill_ratio = 1,
		flags = "all_floors",
		y_min = vlf_vars.mg_overworld_min,
	...
	minetest.register_decoration({
		decoration = "vlf_lush_caves:cave_vines",
		deco_type = "simple",
		place_on = {"vlf_lush_caves:moss"},
		height = 1,
		height_max = 4,
	...
	minetest.register_decoration({
		decoration = "vlf_lush_caves:cave_vines_lit",
		deco_type = "simple",
		place_on = {"vlf_lush_caves:moss"},
		height = 1,
		height_max = 4,
	...
	minetest.register_decoration({
			decoration = "vlf_lush_caves:azalea",
			deco_type = "simple",
			place_on = {"vlf_lush_caves:moss"},
			biomes = lushcaves,
			fill_ratio = 0.2,
	...
	minetest.register_decoration({
			decoration = "vlf_lush_caves:azalea_flowering",
			deco_type = "simple",
			place_on = {"vlf_lush_caves:moss"},
			biomes = lushcaves,
			fill_ratio = 0.05,
	...
	minetest.register_decoration({
		decoration = "vlf_lush_caves:cave_vines_lit",
		deco_type = "simple",
		place_on = {"vlf_lush_caves:cave_vines_lit","vlf_lush_caves:cave_vines"},
		height = 1,
		height_max = 4,
		fill_ratio = 0.1,
		flags = "all_ceilings",
	...
	minetest.register_decoration({
		place_on = {"vlf_lush_caves:rooted_dirt"},
		decoration = "vlf_lush_caves:hanging_roots",
		deco_type = "simple",
		fill_ratio = 10,
		flags = "all_ceilings",
		biomes = lushcaves,
	...
	minetest.register_decoration({
		decoration = "vlf_lush_caves:spore_blossom",
		deco_type = "simple",
		place_on = {"vlf_lush_caves:moss"},
		spawn_by = {"air"},
		num_spawn_by = 4,
	...
	minetest.register_decoration({
		decoration = "vlf_lush_caves:moss_carpet",
		deco_type = "simple",
		place_on = table.merge(stonelike, {"vlf_deepslate:deepslate", "vlf_core:gravel","vlf_lush_caves:moss"}),
		fill_ratio = 0.1,
		flags = "all_floors",
		y_min = vlf_vars.mg_overworld_min,
		biomes = lushcaves,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = "vlf_lush_caves:moss","vlf_core:clay",
		fill_ratio = 0.5,
		biomes = lushcaves,
		decoration = "vlf_flowers:tallgrass",
		y_min = vlf_vars.mg_overworld_min,
	...
	minetest.register_decoration({
		...
		y_min = coral_min,
		y_max = coral_max,
		decoration = "vlf_ocean:dead_brain_coral_block",
		biomes = warm_oceans,
		flags = "force_placement",
		height = 1,
		height_max = 1,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_ocean:dead_brain_coral_block"},
		sidelen = 16,
		fill_ratio = 3,
		y_min = coral_min,
		y_max = coral_max,
		decoration = "vlf_ocean:sea_pickle_1_dead_brain_coral_block",
		biomes = warm_oceans,
		flags = "force_placement, all_floors",
		height = 1,
		height_max = 1,
	...
	minetest.register_decoration({
		...
		y_min = coral_min,
		y_max = coral_max,
		decoration = "vlf_ocean:sea_pickle_2_dead_brain_coral_block",
		biomes = warm_oceans,
		flags = "force_placement, all_floors",
		height = 1,
		height_max = 1,
	...
	minetest.register_decoration({
		...
		y_min = coral_min,
		y_max = coral_max,
		decoration = "vlf_ocean:sea_pickle_3_dead_brain_coral_block",
		biomes = warm_oceans,
		flags = "force_placement, all_floors",
		height = 1,
		height_max = 1,
	...
	minetest.register_decoration({
		...
		y_min = coral_min,
		y_max = coral_max,
		decoration = "vlf_ocean:sea_pickle_4_dead_brain_coral_block",
		biomes = warm_oceans,
		flags = "force_placement, all_floors",
		height = 1,
		height_max = 1,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_core:dirt_with_grass","vlf_core:podzol"},
		sidelen = 16,
		noise_params = {
			offset = 0,
			scale = 0.012,
		...
		y_max = vlf_vars.mg_overworld_max,
		y_min = 2,
		decoration = "vlf_sweet_berry:sweet_berry_bush_3"
	})
	...
	for i=1, 4 do
		...
		minetest.register_decoration({
			deco_type = "schematic",
			place_on = {"group:grass_block", "vlf_core:dirt", },
			sidelen = 80,
			noise_params = {
				offset = -0.0007,
				scale = 0.001,
	...
	minetest.register_decoration({
		deco_type = "schematic",
		place_on = {"vlf_core:dirt_with_grass", "vlf_core:dirt"},
		sidelen = 16,
		noise_params = {
			offset = 0.015,
			scale = 0.002,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"group:grass_block_no_snow", "vlf_core:dirt", "vlf_mud:mud"},
		fill_ratio = 0.004,
		height = 7,
		height_max = 15,
	...
	for i=1,3 do
		minetest.register_decoration({
			...
			y_min = 1,
			y_max = vlf_vars.mg_overworld_max,
			decoration = "vlf_bamboo:bamboo"..i,
		})
	end
	...
	minetest.register_decoration({
		name = "vlf_biomes:mangrove_tree_1",
		deco_type = "schematic",
	...
	minetest.register_decoration({
		name = "vlf_biomes:mangrove_tree_2",
		deco_type = "schematic",
		place_on = {"vlf_mud:mud"},
		sidelen = 80,
		fill_ratio = 0.0045,
	...
	minetest.register_decoration({
		name = "vlf_biomes:mangrove_tree_3",
		deco_type = "schematic",
		place_on = {"vlf_mud:mud"},
		sidelen = 80,
		fill_ratio = 0.023,
	...
	minetest.register_decoration({
		...
		y_min = 0,
		y_max = 0,
		decoration = "vlf_mangrove:water_logged_roots",
		flags = "place_center_x, place_center_z, force_placement",
	})

	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_mangrove:mangrove_roots"},
	...
	minetest.register_decoration({
		...
		biomes = {"MangroveSwamp","MangroveSwamp_shore"},
		place_offset_y = -1,
		decoration = "vlf_mangrove:mangrove_mud_roots",
		flags = "place_center_x, place_center_z, force_placement",
	})
	minetest.register_decoration({
		deco_type = "simple",
		...
		fill_ratio = 0.008,
		biomes = {"MangroveSwamp","MangroveSwamp_shore"},
		decoration = "vlf_core:deadbush",
		flags = "place_center_x, place_center_z",
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_core:water_source"},
		sidelen = 80,
		fill_ratio = 0.035,
		biomes = {"MangroveSwamp","MangroveSwamp_shore"},
		decoration = "vlf_flowers:waterlily",
	...
	-- Huge spruce
	quick_spruce(3000, 0.0030, "vlf_core_spruce_huge_1.mts", {"MegaSpruceTaiga"})
	quick_spruce(4000, 0.0036, "vlf_core_spruce_huge_2.mts", {"MegaSpruceTaiga"})
	quick_spruce(6000, 0.0036, "vlf_core_spruce_huge_3.mts", {"MegaSpruceTaiga"})
	quick_spruce(6600, 0.0036, "vlf_core_spruce_huge_4.mts", {"MegaSpruceTaiga"})

	quick_spruce(3000, 0.0008, "vlf_core_spruce_huge_up_1.mts", {"MegaTaiga"})
	quick_spruce(4000, 0.0008, "vlf_core_spruce_huge_up_2.mts", {"MegaTaiga"})
	quick_spruce(6000, 0.0008, "vlf_core_spruce_huge_up_3.mts", {"MegaTaiga"})
	...
	quick_spruce(5000, 0.00250, "vlf_core_spruce_2.mts", {"MegaSpruceTaiga", "MegaTaiga"})

	quick_spruce(11000, 0.000025, "vlf_core_spruce_5.mts", {"ExtremeHills", "ExtremeHillsM"})
	quick_spruce(2500, 0.00005, "vlf_core_spruce_1.mts", {"ExtremeHills", "ExtremeHillsM"})
	quick_spruce(7000, 0.00005, "vlf_core_spruce_3.mts", {"ExtremeHills", "ExtremeHillsM"})
	quick_spruce(9000, 0.00005, "vlf_core_spruce_4.mts", {"ExtremeHills", "ExtremeHillsM"})

	quick_spruce(11000, 0.001, "vlf_core_spruce_5.mts", {"ExtremeHills+", "ExtremeHills+_snowtop"}, 50)
	quick_spruce(2500, 0.002, "vlf_core_spruce_1.mts", {"ExtremeHills+", "ExtremeHills+_snowtop"}, 50)
	quick_spruce(7000, 0.003, "vlf_core_spruce_3.mts", {"ExtremeHills+", "ExtremeHills+_snowtop"}, 50)
	quick_spruce(9000, 0.002, "vlf_core_spruce_4.mts", {"ExtremeHills+", "ExtremeHills+_snowtop"}, 50)
	...
	for a=1, 7 do
		minetest.register_decoration({
			deco_type = "schematic",
			place_on = {"vlf_core:dirt_with_grass", "vlf_core:dirt", "vlf_core:coarse_dirt"},
			sidelen = 16,
			fill_ratio = 0.0002,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_core:dirt_with_grass_snow"},
		sidelen = 80,
		fill_ratio = 10,
		flags = "all_floors",
		y_min = vlf_vars.mg_overworld_min,
		y_max = vlf_vars.mg_overworld_max,
		decoration = "vlf_core:snow",
	})
	...
	minetest.register_decoration({
		...
		y_min = vlf_vars.mg_overworld_min,
		y_max = vlf_vars.mg_overworld_max,
		decoration = "vlf_mushrooms:mushroom_red",
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = table.merge(stonelike, {"vlf_deepslate:deepslate"}),
		...
		y_min = vlf_vars.mg_overworld_min,
		y_max = vlf_vars.mg_overworld_max,
		decoration = "vlf_mushrooms:mushroom_brown",
	})

	-- Mossy cobblestone boulder (3×3)
	minetest.register_decoration({
		deco_type = "schematic",
		place_on = {"vlf_core:podzol", "vlf_core:dirt", "vlf_core:coarse_dirt"},
		sidelen = 80,
		noise_params = {
			offset = 0.00015,
			scale = 0.001,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_core:dirt", "vlf_core:coarse_dirt", "group:grass_block_no_snow", "group:sand", "vlf_core:podzol", "vlf_core:reeds"},
		sidelen = 16,
		noise_params = {
			offset = -0.3,
			scale = 0.7,
		...
		y_min = 1,
		y_max = vlf_vars.mg_overworld_max,
		decoration = "vlf_core:reeds",
		height = 1,
		height_max = 3,
		spawn_by = { "vlf_core:water_source", "group:frosted_ice" },
		num_spawn_by = 1,
	})
	minetest.register_decoration({
		deco_type = "simple",
	...
	-- Doubletall grass
	function vlf_biomes.register_doubletall_grass(offset, scale, biomes)
		...
		for b=1, #biomes do
			...
			minetest.register_decoration({
				...
				schematic = {
					...
					data = {
						{ name = "air", prob = 0 },
						{ name = "vlf_flowers:double_grass", param1=255, param2=param2 },
						{ name = "vlf_flowers:double_grass_top", param1=255, param2=param2 },
					},
				},
				place_on = {"group:grass_block_no_snow"},
				sidelen = 16,
	...
	-- Large ferns
	function vlf_biomes.register_double_fern(offset, scale, biomes)
		for b=1, #biomes do
			local param2 = minetest.registered_biomes[biomes[b]]._vlf_palette_index
			minetest.register_decoration({
				deco_type = "schematic",
				schematic = {
					...
					data = {
						{ name = "air", prob = 0 },
						{ name = "vlf_flowers:double_fern", param1=255, param2=param2 },
						{ name = "vlf_flowers:double_fern_top", param1=255, param2=param2 },
					},
				},
				place_on = {"group:grass_block_no_snow", "vlf_core:podzol"},
				sidelen = 16,
				noise_params = {
					offset = offset,
					scale = scale,
	...
	local register_double_fern = vlf_biomes.register_double_fern
	...
	-- Large flowers
	function vlf_biomes.register_large_flower(name, biomes, seed, offset, flower_forest_offset)
		local maxi
		...
		for i=1, maxi do
			...
			minetest.register_decoration({
				...
				schematic = {
					...
					data = {
						{name = "air", prob = 0},
						{name = "vlf_flowers:" .. name, param1 = 255, },
						{name = "vlf_flowers:" .. name .. "_top", param1 = 255, },
					},
				},
				place_on = {"group:grass_block_no_snow", "vlf_core:dirt"},
	...
	local register_large_flower = vlf_biomes.register_large_flower
	...
	local lily_schem = {
		{ name = "vlf_core:water_source" },
		{ name = "vlf_flowers:waterlily" },
	}
	...
	minetest.register_decoration({
		deco_type = "simple",
		decoration = "vlf_farming:pumpkin",
		param2 = 0,
		param2_max = 3,
		place_on = {"group:grass_block_no_snow"},
		sidelen = 16,
	...
	minetest.register_decoration({
		...
		y_min = vlf_vars.mg_overworld_min,
		y_max = vlf_vars.mg_overworld_max,
		decoration = "vlf_cherry_blossom:pink_petals",
	})
...
"ExtremeHillsM_deep_ocean","ExtremeHills+_deep_ocean","MegaTaiga_deep_ocean","MegaSpruceTaiga_deep_ocean","Plains_deep_ocean","SunflowerPlains_deep_ocean","Forest_deep_ocean","FlowerForest_deep_ocean","BirchForest_deep_ocean","BirchForestM_deep_ocean","RoofedForest_deep_ocean","Swampland_deep_ocean","Jungle_deep_ocean","JungleM_deep_ocean","JungleEdge_deep_ocean","JungleEdgeM_deep_ocean","MushroomIsland_deep_ocean"
	...
	minetest.register_decoration({
		...
		schematic = {
			...
			data = {
				...
				{ name = "vlf_flowers:tallgrass", param2 = minetest.registered_biomes["IcePlains"]._vlf_palette_index },
			},
		},
	})
	minetest.register_decoration({
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"group:sand", "vlf_core:podzol", "vlf_core:dirt", "vlf_core:dirt_with_grass", "vlf_core:coarse_dirt", "group:hardened_clay"},
		sidelen = 16,
		noise_params = {
			offset = 0.0,
			scale = 0.035,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"group:sand", "vlf_core:dirt", "vlf_core:dirt_with_grass", "vlf_core:coarse_dirt"},
		sidelen = 16,
		noise_params = {
			offset = 0.1,
			scale = 0.035,
	...
	-- Small Mushrooms
	local mushrooms = {"vlf_mushrooms:mushroom_red", "vlf_mushrooms:mushroom_brown"}
	...
	for m=1, #mushrooms do
		...
		minetest.register_decoration({
			deco_type = "simple",
			place_on = {"group:grass_block_no_snow", "vlf_core:dirt", "vlf_core:podzol", "vlf_core:mycelium", "vlf_core:stone", "vlf_core:andesite", "vlf_core:diorite", "vlf_core:granite"},
			sidelen = 16,
			noise_params = {
				offset = 0,
				scale = 0.003,
	...
	function vlf_biomes.register_flower(name, biomes, seed, is_in_flower_forest)
...
local function register_dimension_decorations()
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_nether:netherrack","vlf_nether:magma"},
		sidelen = 16,
		fill_ratio = 0.04,
		biomes = {"Nether"},
		y_min = vlf_vars.mg_lava_nether_max + 1,
		y_max = vlf_vars.mg_nether_max  - 1,
		flags = "all_floors",
		decoration = "vlf_fire:eternal_fire",
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_nether:netherrack"},
		sidelen = 16,
		fill_ratio = 0.013,
		biomes = {"Nether"},
		y_min = vlf_vars.mg_lava_nether_max + 1,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_crimson:warped_nylium"},
		sidelen = 16,
		fill_ratio = 0.02,
		biomes = {"WarpedForest"},
		y_min = vlf_vars.mg_lava_nether_max + 1,
		...
		flags = "all_floors",
		decoration = "vlf_crimson:warped_fungus",
	})
	minetest.register_decoration({
		deco_type = "schematic",
		name = "vlf_biomes:warped_tree1",
		place_on = {"vlf_crimson:warped_nylium"},
		sidelen = 16,
		fill_ratio = 0.007,
		biomes = {"WarpedForest"},
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_crimson:warped_nylium","vlf_crimson:twisting_vines"},
		sidelen = 16,
		fill_ratio = 0.032,
		biomes = {"WarpedForest"},
		y_min = vlf_vars.mg_lava_nether_max + 1,
		...
		height = 2,
		height_max = 8,
		decoration = "vlf_crimson:twisting_vines",
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_crimson:warped_nylium"},
		...
		flags = "all_floors",
		max_height = 5,
		decoration = "vlf_crimson:warped_roots",
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_crimson:crimson_nylium"},
		sidelen = 16,
		fill_ratio = 0.052,
		biomes = {"WarpedForest"},
		y_min = vlf_vars.mg_lava_nether_max + 1,
		flags = "all_floors",
		decoration = "vlf_crimson:nether_sprouts",
	})
	-- CRIMSON FOREST
	minetest.register_decoration({
		deco_type = "simple",
		...
		y_max = vlf_vars.mg_nether_max  - 10,
		flags = "all_floors",
		decoration = "vlf_crimson:crimson_fungus",
	})
	minetest.register_decoration({
		deco_type = "schematic",
		name = "vlf_biomes:crimson_tree",
		place_on = {"vlf_crimson:crimson_nylium"},
		sidelen = 16,
		fill_ratio = 0.008,
		biomes = {"CrimsonForest"},
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_crimson:warped_nylium","vlf_crimson:weeping_vines","vlf_nether:netherrack"},
		sidelen = 16,
		fill_ratio = 0.063,
		biomes = {"CrimsonForest"},
		y_min = vlf_vars.mg_lava_nether_max + 1,
		...
		height = 2,
		height_max = 8,
		decoration = "vlf_crimson:weeping_vines",
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_crimson:crimson_nylium"},
		...
		flags = "all_floors",
		max_height = 5,
		decoration = "vlf_crimson:crimson_roots",
	})

	--SOULSAND VALLEY
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlf_blackstone:soul_soil","vlf_nether:soul_sand"},
		sidelen = 16,
		fill_ratio = 0.062,
		biomes = {"SoulsandValley"},
		y_min = vlf_vars.mg_lava_nether_max + 1,
		flags = "all_floors",
		max_height = 5,
		decoration = "vlf_blackstone:soul_fire",
	})
	minetest.register_decoration({
		deco_type = "schematic",
		place_on = {"vlf_blackstone:soul_soil","vlf_nether:soulsand"},
		sidelen = 16,
		fill_ratio = 0.000212,
		biomes = {"SoulsandValley"},
		y_min = vlf_vars.mg_lava_nether_max + 1,
	...
	minetest.register_decoration({
		deco_type = "simple",
		decoration = "vlf_blackstone:basalt",
		place_on = {"vlf_blackstone:basalt","vlf_nether:netherrack","vlf_blackstone:blackstone"},
		sidelen = 80,
		height_max = 55,
		noise_params={
			offset = -0.0085,
		...
		biomes = {"BasaltDelta"},
		y_min = vlf_vars.mg_lava_nether_max + 1,
		y_max = vlf_vars.mg_nether_deco_max - 50,
	...
	minetest.register_decoration({
		...
		biomes = {"BasaltDelta"},
		y_min = vlf_vars.mg_lava_nether_max + 1,
		y_max = vlf_vars.mg_nether_deco_max - 15,
		flags = "all_floors, all ceilings",
	})
	minetest.register_decoration({
		deco_type = "simple",
	...
	minetest.register_decoration({
		deco_type = "simple",
		decoration = "vlf_nether:nether_lava_source",
		place_on = {"vlf_blackstone:basalt","vlf_nether:netherrack","vlf_blackstone:blackstone"},
		...
		place_offset_y  = -1,
		y_min = vlf_vars.mg_lava_nether_max + 1,
		y_max = vlf_vars.mg_nether_max - 5,
		flags = "all_floors, force_placement",
	})
	...
	minetest.register_decoration({
		...
		decoration = "vlf_end:chorus_plant",
		height = 1,
		height_max = 8,
		biomes = { "End", "EndMidlands", "EndHighlands", "EndBarrens", "EndSmallIslands" },
	})
	minetest.register_decoration({
		name = "vlf_biomes:chorus_plant",
		deco_type = "simple",
		place_on = {"vlf_end:chorus_plant"},
		flags = "all_floors",
		sidelen = 16,
		fill_ratio = 10,
		--[[noise_params = {
		...
		y_min = vlf_vars.mg_end_min,
		y_max = vlf_vars.mg_end_max,
		decoration = "vlf_end:chorus_flower",
		height = 1,
		biomes = { "End", "EndMidlands", "EndHighlands", "EndBarrens", "EndSmallIslands" },
	})

	deco_id_chorus_plant = minetest.get_decoration_id("vlf_biomes:chorus_plant")
...
if vlf_biomes.biome_to_retain ~= "None" then
	...
	--minetest.log("info", "Biome to Retain: " .. tostring(vlf_biomes.biome_to_retain) .. " ")
