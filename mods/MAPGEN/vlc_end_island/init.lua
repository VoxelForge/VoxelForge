...
local c_end_stone = minetest.get_content_id("vlc_end:end_stone")
local y_offset = -2

vlc_mapgen_core.register_generator("end_island", function(vm, data, data2, emin, emax, area, minp, maxp, blockseed)
	...
	local nn = minetest.find_nodes_in_area_under_air(minp,maxp,{"vlc_end:end_stone"})
