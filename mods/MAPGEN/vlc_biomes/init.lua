...
local mod_vlc_schematics = minetest.get_modpath("vlc_schematics")
...
--[[ Special biome field: _vlc_biome_type:
...
local function register_classic_superflat_biome()
	...
	minetest.register_biome({
		name = "flat",
		node_top = "vlc_core:dirt_with_grass",
		depth_top = 1,
		node_filler = "vlc_core:dirt",
		depth_filler = 3,
		node_stone = "vlc_core:dirt",
		y_min = vlc_vars.mg_overworld_min - 512,
		y_max = vlc_vars.mg_overworld_max,
		humidity_point = 50,
		heat_point = 50,
		_vlc_biome_type = "medium",
		_vlc_palette_index = 0,
		_vlc_skycolor = "#78A7FF",
		_vlc_fogcolor = overworld_fogcolor
	})
end
...
local function register_biomes()
	...
	* Desert M
	...
	minetest.register_biome({
		...
		node_top = "vlc_core:snowblock",
		depth_top = 1,
		node_filler = "vlc_core:dirt",
		depth_filler = 2,
		node_water_top = "vlc_core:ice",
		depth_water_top = 1,
		node_river_water = "vlc_core:ice",
		node_riverbed = "vlc_core:sand",
		depth_riverbed = 2,
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		humidity_point = 24,
		heat_point = -5,
		_vlc_biome_type = "snowy",
		_vlc_palette_index = 2,
		_vlc_skycolor = "#7FA1FF",
		_vlc_fogcolor = overworld_fogcolor
	})
	minetest.register_biome({
		name = "IcePlainsSpikes_ocean",
		node_top = "vlc_core:gravel",
		depth_top = 2,
		node_filler = "vlc_core:gravel",
		depth_filler = 3,
		node_river_water = "vlc_core:ice",
		node_riverbed = "vlc_core:sand",
		depth_riverbed = 2,
	...
	minetest.register_biome({
		name = "ColdTaiga",
		node_dust = "vlc_core:snow",
		node_top = "vlc_core:dirt_with_grass_snow",
		depth_top = 1,
		node_filler = "vlc_core:dirt",
		depth_filler = 2,
		node_riverbed = "vlc_core:sand",
		...
		heat_point = 8,
		_vlc_biome_type = "snowy",
		_vlc_palette_index = 3,
		_vlc_skycolor = "#839EFF",
		_vlc_fogcolor = overworld_fogcolor
	})
	...
	minetest.register_biome({
		...
		node_dust = "vlc_core:snow",
		node_top = "vlc_core:sand",
		depth_top = 2,
		node_water_top = "vlc_core:ice",
		depth_water_top = 1,
		node_filler = "vlc_core:sandstone",
		depth_filler = 2,
		node_riverbed = "vlc_core:sand",
		depth_riverbed = 2,
		y_min = 1,
	...
	minetest.register_biome({
		...
		humidity_point = 76,
		heat_point = 10,
		_vlc_biome_type = "cold",
		_vlc_palette_index = 4,
		_vlc_skycolor = "#7CA3FF",
		_vlc_fogcolor = overworld_fogcolor
	})
	minetest.register_biome({
	...
	minetest.register_biome({
		...
		heat_point = 8,
		_vlc_biome_type = "cold",
		_vlc_palette_index = 5,
		_vlc_skycolor = "#7DA3FF",
		_vlc_fogcolor = overworld_fogcolor
	})
	minetest.register_biome({
	...
	minetest.register_biome({
		...
		heat_point = 45,
		_vlc_biome_type = "cold",
		_vlc_palette_index = 6,
		_vlc_skycolor = "#7DA2FF",
		_vlc_fogcolor = overworld_fogcolor
	})
	minetest.register_biome({
	...
	minetest.register_biome({
		...
		heat_point = 45,
		_vlc_biome_type = "medium",
		_vlc_palette_index = 13,
		_vlc_skycolor = "#79A6FF",
		_vlc_fogcolor = overworld_fogcolor
	})
	minetest.register_biome({
		name = "Forest_beach",
	...
	minetest.register_biome({
		...
		heat_point = 31,
		_vlc_biome_type = "medium",
		_vlc_palette_index = 15,
		_vlc_skycolor = "#7AA5FF",
		_vlc_fogcolor = overworld_fogcolor
	})
	minetest.register_biome({
	...
	minetest.register_biome({
		...
		node_riverbed = "vlc_core:sand",
		depth_riverbed = 2,
		node_stone = "vlc_core:sandstone",
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		humidity_point = 26,
		heat_point = 94,
		_vlc_biome_type = "hot",
		_vlc_palette_index = 17,
		_vlc_skycolor = "#6EB1FF",
		_vlc_fogcolor = overworld_fogcolor
	})
	minetest.register_biome({
		name = "Desert_ocean",
	...
	minetest.register_biome({
		name = "Mesa",
		node_top = "vlc_colorblocks:hardened_clay",
		depth_top = 1,
		node_filler = "vlc_colorblocks:hardened_clay",
		node_riverbed = "vlc_core:redsand",
		depth_riverbed = 1,
		node_stone = "vlc_colorblocks:hardened_clay",
		y_min = 11,
		y_max = vlc_vars.mg_overworld_max,
		humidity_point = 0,
		heat_point = 100,
		_vlc_biome_type = "hot",
		_vlc_palette_index = 19,
		_vlc_skycolor = "#6EB1FF",
		_vlc_fogcolor = overworld_fogcolor
	})
	...
	minetest.register_biome({
		name = "Mesa_sandlevel",
		node_top = "vlc_core:redsand",
		depth_top = 1,
		node_filler = "vlc_colorblocks:hardened_clay_orange",
		depth_filler = 3,
		node_riverbed = "vlc_core:redsand",
		depth_riverbed = 1,
		node_stone = "vlc_colorblocks:hardened_clay_orange",
		y_min = -4,
		y_max = 10,
		humidity_point = 0,
		heat_point = 100,
	...
	minetest.register_biome({
		...
		depth_top = 1,
		node_filler = "vlc_colorblocks:hardened_clay",
		node_riverbed = "vlc_colorblocks:hardened_clay",
		depth_riverbed = 1,
		node_stone = "vlc_colorblocks:hardened_clay",
		y_min = 4,
		y_max = vlc_vars.mg_overworld_max,
	...
	minetest.register_biome({
		...
		node_top = "vlc_core:dirt_with_grass",
		depth_top = 1,
		node_filler = "vlc_core:coarse_dirt",
		depth_filler = 2,
		node_riverbed = "vlc_core:redsand",
		depth_riverbed = 1,
		node_stone = "vlc_colorblocks:hardened_clay",
	...
	minetest.register_biome({
		...
		heat_point = 81,
		_vlc_biome_type = "medium",
		_vlc_palette_index = 24,
		_vlc_skycolor = "#77A8FF",
		_vlc_fogcolor = overworld_fogcolor
	})
	minetest.register_biome({
		name = "Jungle_shore",
		node_top = "vlc_core:dirt",
		depth_top = 1,
		node_filler = "vlc_core:dirt",
		depth_filler = 3,
		node_riverbed = "vlc_core:sand",
	...
	minetest.register_biome({
		name = "MangroveSwamp",
		node_top = "vlc_mud:mud",
		depth_top = 1,
		node_filler = "vlc_mud:mud",
		depth_filler = 3,
		node_riverbed = "vlc_core:dirt",
		depth_riverbed = 2,
		y_min = 1,
	...
	minetest.register_biome({
		name = "DeepDark",
		node_top = "vlc_sculk:sculk",
		depth_top = 1,
		node_filler = "vlc_deepslate:deepslate",
		node_riverbed = "vlc_deepslate:deepslate",
		depth_riverbed = 1,
		node_stone = "vlc_deepslate:deepslate",
		y_min = vlc_vars.mg_overworld_min,
		y_max = vlc_vars.mg_overworld_min_old,
		humidity_point = 0,
		heat_point = 60,
		vertical_blend = 8,
		_vlc_biome_type = "hot",
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = table.merge(stonelike, {"vlc_deepslate:deepslate"}),
		sidelen = 16,
		fill_ratio = 10,
		biomes = { "DeepDark" },
		y_min = vlc_vars.mg_overworld_min,
		y_max = vlc_vars.mg_overworld_min_old,
		decoration = "vlc_sculk:sculk",
		flags = "all_floors",
		param2 = 0,
	})
	...
	minetest.register_biome({
		...
		depth_filler = 3,
		node_riverbed = "vlc_core:sand",
		node_cave_liquid = "vlc_core:water_source",
		depth_riverbed = 2,
		y_min = 2,
		y_max = 20,
		vertical_blend = 1,
	...
	for i=1, #overworld_biomes do
		...
		minetest.register_biome({
			...
			depth_riverbed = 2,
			vertical_blend = 5,
			_vlc_biome_type = minetest.registered_biomes[biome]._vlc_biome_type,
			_vlc_palette_index = minetest.registered_biomes[biome]._vlc_palette_index,
			_vlc_skycolor = ocean_skycolor,
			_vlc_fogcolor = overworld_fogcolor
		})
		...
		minetest.register_biome({
			...
			heat_point = minetest.registered_biomes[biome].heat_point,
			humidity_point = minetest.registered_biomes[biome].humidity_point,
			y_min = vlc_vars.mg_overworld_min_old,
			y_max = DEEP_OCEAN_MIN - 1,
			_vlc_biome_type = minetest.registered_biomes[biome]._vlc_biome_type,
			_vlc_palette_index = minetest.registered_biomes[biome]._vlc_palette_index,
			_vlc_skycolor = minetest.registered_biomes[biome]._vlc_skycolor,
			_vlc_fogcolor = minetest.registered_biomes[biome]._vlc_fogcolor,
		})
		minetest.register_biome({
...
local function register_dimension_biomes()
	...
	minetest.register_decoration({
		...
		height = 6,
		max_height = 10,
		decoration = "vlc_nether:netherrack",
		flags = "all_ceilings",
		param2 = 0,
	})
	minetest.register_decoration({
		...
		sidelen = 16,
		fill_ratio = 10,
		y_min = vlc_vars.mg_nether_min - 10,
		y_max = vlc_vars.mg_lava_nether_max,
		height = 7,
		max_height = 14,
		decoration = "vlc_nether:netherrack",
	...
	minetest.register_biome({
		name = "Nether",
		node_filler = "vlc_nether:netherrack",
		node_stone = "vlc_nether:netherrack",
		node_top = "vlc_nether:netherrack",
		node_water = "air",
		node_river_water = "air",
		node_cave_liquid = "air",
		y_min = vlc_vars.mg_nether_min,

		y_max = vlc_vars.mg_nether_max + 80,
		heat_point = 100,
		humidity_point = 0,
		_vlc_biome_type = "hot",
		_vlc_palette_index = 17,
--		_vlc_skycolor = nether_skycolor,
--		_vlc_fogcolor = "#330808"
	})

	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_nether:netherrack","vlc_nether:glowstone","vlc_blackstone:nether_gold","vlc_nether:quartz_ore","vlc_core:gravel","vlc_nether:soul_sand","vlc_nether:glowstone","vlc_nether:magma"},
		sidelen = 16,
		fill_ratio = 10,
		biomes = { "Nether" },
		y_min = vlc_vars.mg_lava_nether_max,
		y_max = vlc_vars.mg_nether_deco_max,
		decoration = "vlc_nether:netherrack",
		flags = "all_floors",
		param2 = 0,
	})
	...
	minetest.register_biome({
		...
		node_filler = "vlc_nether:netherrack",
		node_stone = "vlc_nether:netherrack",
		node_top = "vlc_blackstone:soul_soil",
		node_water = "air",
		node_river_water = "air",
		node_cave_liquid = "air",
		y_min = vlc_vars.mg_nether_min,
		...
		_vlc_palette_index = 17,
--		_vlc_skycolor = nether_skycolor,
--		_vlc_fogcolor = "#1B4745"
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_nether:netherrack","vlc_nether:glowstone","vlc_nether:magma"},
		sidelen = 16,
		fill_ratio = 10,
		biomes = { "SoulsandValley" },
		y_min = vlc_vars.mg_lava_nether_max,
		y_max = vlc_vars.mg_nether_deco_max,
		decoration = "vlc_blackstone:soul_soil",
	...
	minetest.register_ore({
		ore_type       = "blob",
		ore            = "vlc_nether:soul_sand",
		wherein        = { "vlc_nether:netherrack", "vlc_blackstone:soul_soil" },
		clust_scarcity = 100,
		clust_num_ores = 225,
		clust_size     = 15,
		biomes = { "SoulsandValley" },
	...
	minetest.register_biome({
		...
		node_filler = "vlc_nether:netherrack",
		node_stone = "vlc_nether:netherrack",
		node_top = "vlc_crimson:crimson_nylium",
		node_water = "air",
		node_river_water = "air",
		node_cave_liquid = "air",
		y_min = vlc_vars.mg_nether_min,
		...
		_vlc_palette_index = 17,
--		_vlc_skycolor = nether_skycolor,
--		_vlc_fogcolor = "#330303"
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_nether:netherrack","vlc_nether:glowstone","vlc_blackstone:nether_gold","vlc_nether:quartz_ore","vlc_core:gravel","vlc_nether:soul_sand","vlc_nether:magma","vlc_blackstone:blackstone"},
		sidelen = 16,
		fill_ratio = 10,
		biomes = { "CrimsonForest" },
		y_min = vlc_vars.mg_lava_nether_max,
		y_max = vlc_vars.mg_nether_deco_max,
		decoration = "vlc_crimson:crimson_nylium",
		flags = "all_floors",
		param2 = 0,
	})
	minetest.register_biome({
		...
		node_filler = "vlc_nether:netherrack",
		node_stone = "vlc_nether:netherrack",
		node_top = "vlc_crimson:warped_nylium",
		node_water = "air",
		node_river_water = "air",
		node_cave_liquid = "air",
		y_min = vlc_vars.mg_nether_min,
...
--		_vlc_fogcolor = "#1A051A"
	...
	minetest.register_decoration({
		...
		y_min = vlc_vars.mg_lava_nether_max,
		y_max = vlc_vars.mg_nether_deco_max,
		decoration = "vlc_crimson:warped_nylium",
		flags = "all_floors",
		param2 = 0,
	})
	minetest.register_biome({
		...
		node_filler = "vlc_nether:netherrack",
		node_stone = "vlc_nether:netherrack",
		node_top = "vlc_blackstone:basalt",
		node_water = "air",
		node_river_water = "air",
		node_cave_liquid = "air",
		y_min = vlc_vars.mg_nether_min,
		...
		_vlc_palette_index = 17,
--		_vlc_skycolor = nether_skycolor,
--		_vlc_fogcolor = "#685F70"
	})

	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_nether:netherrack","vlc_nether:glowstone","vlc_blackstone:nether_gold","vlc_nether:quartz_ore","vlc_core:gravel","vlc_nether:soul_sand","vlc_blackstone:blackstone","vlc_nether:magma"},
		sidelen = 16,
		fill_ratio = 10,
		biomes = { "BasaltDelta" },
		y_min = vlc_vars.mg_lava_nether_max,
		y_max = vlc_vars.mg_nether_deco_max,
		decoration = "vlc_blackstone:basalt",
		flags = "all_floors",
		param2 = 0,
	})
	...
	minetest.register_ore({
	ore_type       = "blob",
	ore            = "vlc_blackstone:blackstone",
	wherein        =  {"vlc_nether:netherrack","vlc_nether:glowstone","vlc_core:gravel"},
	clust_scarcity = 100,
	clust_num_ores = 400,
	clust_size     = 20,
	biomes = { "BasaltDelta" },
	...
	minetest.register_biome({
		...
		y_max = vlc_vars.mg_end_max + 80,
		heat_point = 1000, --ridiculously high values so End Island always takes precedent
		humidity_point = 1000,
		vertical_blend = 16,
		_vlc_biome_type = "medium",
		_vlc_palette_index = 0,
--		_vlc_skycolor = end_skycolor,
--		_vlc_fogcolor = end_fogcolor
	})
	minetest.register_biome({
		name = "EndBarrens",
		node_stone = "air",
...
--		_vlc_fogcolor = end_fogcolor
	...
	minetest.register_biome({
		...
		humidity_point = 500,
		vertical_blend = 16,
		max_pos = {x = 1250, y = vlc_vars.mg_end_min + 512, z = 1250},
		min_pos = {x = -1250, y = vlc_vars.mg_end_min, z = -1250},
		_vlc_biome_type = "medium",
		_vlc_palette_index = 0,
--		_vlc_skycolor = end_skycolor,
--		_vlc_fogcolor = end_fogcolor
	...
	minetest.register_biome({
		...
		node_river_water = "air",
		node_cave_liquid = "air",
		max_pos = {x = 650, y = vlc_vars.mg_end_min + 512, z = 650},
		min_pos = {x = -650, y = vlc_vars.mg_end_min, z = -650},
		heat_point = 50,
		humidity_point = 50,
		vertical_blend = 16,
		_vlc_biome_type = "medium",
...
local function register_biome_ores()
	...
	minetest.register_ore({
		ore_type       = "scatter",
		ore            = "vlc_core:stone_with_emerald",
		wherein        = stonelike,
		clust_scarcity = 16384,
		clust_num_ores = 1,
		clust_size     = 1,
		y_min          = vlc_worlds.layer_to_y(4),
	...
	minetest.register_ore({
		ore_type       = "scatter",
		ore            = "vlc_monster_eggs:monster_egg_stone",
	...
	minetest.register_ore({
		ore_type       = "scatter",
		ore            = "vlc_core:stone_with_gold",
		wherein        = stonelike,
		clust_scarcity = 3333,
		clust_num_ores = 5,
		clust_size     = 3,
		y_min          = vlc_worlds.layer_to_y(32),
		y_max          = vlc_worlds.layer_to_y(79),
	...
	minetest.register_ore({
		ore_type       = "scatter",
		ore            = "vlc_blackstone:blackstone_gilded",
		wherein        = "vlc_blackstone:blackstone",
		clust_scarcity = 4775,
		clust_num_ores = 2,
		clust_size     = 2,
		y_min          = vlc_vars.mg_nether_min,
	...
	minetest.register_ore({
		ore_type       = "scatter",
		ore            = "vlc_blackstone:nether_gold",
...
local function register_biomelike_ores()
	...
	minetest.register_ore({
		ore_type	= "sheet",
		ore		= "vlc_core:coarse_dirt",
		wherein		= {"vlc_core:podzol", "vlc_core:dirt"},
		clust_scarcity	= 1,
		clust_num_ores	= 12,
		clust_size	= 10,
		y_min		= vlc_vars.mg_overworld_min,
	...
	minetest.register_ore({
		ore_type	= "sheet",
		ore		= "vlc_core:coarse_dirt",
		wherein		= {"vlc_core:dirt_with_grass", "vlc_core:dirt"},
		column_height_max = 1,
	...
	minetest.register_ore({
		ore_type	= "blob",
		ore		= "air",
		wherein		= {"group:hardened_clay", "group:sand","vlc_core:coarse_dirt"},
		clust_scarcity	= 4000,
		clust_size	= 5,
		y_min		= vlc_vars.mg_overworld_min,
		y_max		= vlc_vars.mg_overworld_max,
	...
	minetest.register_ore({
		ore_type	= "blob",
		ore		= "vlc_core:redsandstone",
		wherein		= {"vlc_colorblocks:hardened_clay_orange"},
		clust_scarcity	= 300,
		clust_size	= 8,
		y_min		= vlc_vars.mg_overworld_min,
		y_max		= vlc_vars.mg_overworld_max,
	...
	minetest.register_decoration({
		...
		deco_type = "simple",
		place_on = {"vlc_core:dirt"},
		fill_ratio = 10,
		biomes = { "ExtremeHillsM" },
		decoration = "vlc_core:dirt_with_grass",
		place_offset_y = -1,
	...
	local function stratum(y_min, height, color, seed, is_perfect)
		...
		minetest.register_ore({
			ore_type = "stratum",
			ore = "vlc_colorblocks:hardened_clay_"..color,
			-- Only paint uncolored so the biome can choose
			-- a color in advance.
			wherein = {"vlc_colorblocks:hardened_clay"},
			y_min = y_min,
			y_max = y_max,
...
local function register_dimension_ores()
	...
	minetest.register_ore({
		...
		clust_size      = 5,
		y_min           = vlc_vars.mg_nether_min,
		y_max           = vlc_worlds.layer_to_y(64, "nether"),
		noise_threshold = 0.0,
		noise_params    = {
			offset = 0.5,
			scale = 0.1,
	...
	minetest.register_ore({
		ore_type       = "blob",
		ore            = "vlc_nether:magma",
		wherein         = {"vlc_nether:netherrack"},
		clust_scarcity = 8*8*8,
		clust_num_ores = 45,
		clust_size     = 6,
		y_min          = vlc_worlds.layer_to_y(23, "nether"),
		y_max          = vlc_worlds.layer_to_y(37, "nether"),
		noise_params = {
			offset  = 0,
			scale   = 1,
			spread  = {x=250, y=250, z=250},
	...
	minetest.register_ore({
		ore_type        = "blob",
		ore             = "vlc_nether:glowstone",
		wherein         = {"vlc_nether:netherrack"},
		clust_scarcity  = 26 * 26 * 26,
		clust_size      = 5,
		y_min           = vlc_vars.mg_lava_nether_max + 10,
		y_max           = vlc_vars.mg_nether_max - 13,
		noise_threshold = 0.0,
		noise_params    = {
			offset = 0.5,
			scale = 0.1,
	...
	minetest.register_ore({
		ore_type       = "scatter",
		ore            = "vlc_nether:nether_lava_source",
		wherein         = {"vlc_nether:netherrack"},
	...
	minetest.register_ore({
		...
		biomes         = lava_biomes,
		y_min          = vlc_vars.mg_nether_min,
		y_max          = vlc_vars.mg_lava_nether_max + 1,
	})
	...
	minetest.register_ore({
		...
		clust_size     = 1,
		biomes         = lava_biomes,
		y_min           = vlc_vars.mg_lava_nether_max + 2,
		y_max           = vlc_vars.mg_lava_nether_max + 12,
	})
	...
	minetest.register_ore({
		...
		clust_size     = 1,
		biomes         = lava_biomes,
		y_min           = vlc_vars.mg_lava_nether_max + 13,
		y_max           = vlc_vars.mg_lava_nether_max + 48,
	})
	minetest.register_ore({
		ore_type       = "scatter",
		ore            = "vlc_nether:nether_lava_source",
		...
		clust_size     = 1,
		biomes         = lava_biomes,
		y_min           = vlc_vars.mg_lava_nether_max + 49,
		y_max           = vlc_vars.mg_nether_max - 13,
	})
	...
	minetest.register_ore({
		ore_type        = "stratum",
		ore             = "vlc_end:end_stone",
		wherein         = {"air"},
		biomes          = {"EndSmallIslands","Endborder"},
		y_min           = vlc_vars.mg_end_min+64,
		y_max           = vlc_vars.mg_end_min+80,
		clust_num_ores  = 3375,
		clust_size      = 15,

		noise_params = {
			offset  = vlc_vars.mg_end_min+70,
			scale   = -1,
...
function vlc_biomes.register_grass_decoration(grasstype, offset, scale, biomes)
	local place_on, seed, node
	if grasstype == "fern" then
		node = "vlc_flowers:fern"
		place_on = {"group:grass_block_no_snow", "vlc_core:podzol","vlc_mud:mud"}
		seed = 333
	elseif grasstype == "tallgrass" then
		node = "vlc_flowers:tallgrass"
		place_on = {"group:grass_block_no_snow","vlc_mud:mud"}
		seed = 420
	end
	local noise = {
		offset = offset,
	...
	for b=1, #biomes do
		local param2 = minetest.registered_biomes[biomes[b]]._vlc_palette_index
		minetest.register_decoration({
			deco_type = "simple",
			place_on = place_on,
			sidelen = 16,
...
local register_grass_decoration = vlc_biomes.register_grass_decoration

function vlc_biomes.register_seagrass_decoration(grasstype, offset, scale, biomes)
	local seed, nodes, surfaces, param2, param2_max, y_max
	if grasstype == "seagrass" then
		seed = 16
		param2 = 3
		surfaces = { "vlc_core:dirt", "vlc_core:sand", "vlc_core:gravel", "vlc_core:redsand" }
		nodes = { "vlc_ocean:seagrass_dirt", "vlc_ocean:seagrass_sand", "vlc_ocean:seagrass_gravel", "vlc_ocean:seagrass_redsand" }
		y_max = 0
	elseif grasstype == "kelp" then
		seed = 32
		param2 = 16
		param2_max = 96
		surfaces = { "vlc_core:dirt", "vlc_core:sand", "vlc_core:gravel" }
		nodes = { "vlc_ocean:kelp_dirt", "vlc_ocean:kelp_sand", "vlc_ocean:kelp_gravel" }
		y_max = -6
	end
	local noise = {
		offset = offset,
...
local register_seagrass_decoration = vlc_biomes.register_seagrass_decoration
...
local function register_coral_decos(ck)
	...
	minetest.register_decoration({
		deco_type = "schematic",
		place_on = {"group:sand","vlc_core:gravel","vlc_mud:mud"},
		sidelen = 80,
		noise_params = noise,
		biomes = warm_oceans,
		y_min = coral_min,
		y_max = coral_max,
		schematic = mod_vlc_schematics.."/schems/vlc_structures_coral_"..c.."_1.mts",
		rotation = "random",
		flags = "all_floors,force_placement",
	})
	minetest.register_decoration({
		...
		y_min = coral_min,
		y_max = coral_max,
		schematic = mod_vlc_schematics.."/schems/vlc_structures_coral_"..c.."_2.mts",
		rotation = "random",
		flags = "all_floors,force_placement",
	})
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_ocean:"..c.."_coral_block"},
		sidelen = 16,
		fill_ratio = 3,
		y_min = coral_min,
		y_max = coral_max,
		decoration = "vlc_ocean:"..c.."_coral",
		biomes = warm_oceans,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_ocean:horn_coral_block"},
		sidelen = 16,
		fill_ratio = 7,
		y_min = coral_min,
		y_max = coral_max,
		decoration = "vlc_ocean:"..c.."_coral_fan",
		biomes = warm_oceans,
		flags = "force_placement, all_floors",
		height = 1,
		height_max = 1,
...
local function register_decorations()
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_sculk:sculk"},
		sidelen = 16,
		fill_ratio = 0.1,
		decoration = "vlc_sculk:catalyst",
		biomes = {"DeepDark"},
		flags = "all_floors",
	})
	-- Coral Reefs
	...
	minetest.register_decoration({
		decoration = "vlc_lush_caves:moss",
		deco_type = "simple",
		place_on = table.merge(stonelike, {"vlc_core:stone","vlc_deepslate:deepslate","vlc_deepslate:tuff", "vlc_core:gravel", "vlc_core:bedrock"}),
		biomes = lushcaves,
		fill_ratio = 10,
		flags = "all_floors, all_ceilings",
		y_min = vlc_vars.mg_overworld_min,
	...
	minetest.register_decoration({
		decoration = "vlc_flowers:tallgrass",
		deco_type = "simple",
		place_on = {"vlc_lush_caves:moss"},
		biomes = lushcaves,
		fill_ratio = 1,
		flags = "all_floors",
		y_min = vlc_vars.mg_overworld_min,
	...
	minetest.register_decoration({
		decoration = "vlc_lush_caves:cave_vines",
		deco_type = "simple",
		place_on = {"vlc_lush_caves:moss"},
		height = 1,
		height_max = 4,
	...
	minetest.register_decoration({
		decoration = "vlc_lush_caves:cave_vines_lit",
		deco_type = "simple",
		place_on = {"vlc_lush_caves:moss"},
		height = 1,
		height_max = 4,
	...
	minetest.register_decoration({
			decoration = "vlc_lush_caves:azalea",
			deco_type = "simple",
			place_on = {"vlc_lush_caves:moss"},
			biomes = lushcaves,
			fill_ratio = 0.2,
	...
	minetest.register_decoration({
			decoration = "vlc_lush_caves:azalea_flowering",
			deco_type = "simple",
			place_on = {"vlc_lush_caves:moss"},
			biomes = lushcaves,
			fill_ratio = 0.05,
	...
	minetest.register_decoration({
		decoration = "vlc_lush_caves:cave_vines_lit",
		deco_type = "simple",
		place_on = {"vlc_lush_caves:cave_vines_lit","vlc_lush_caves:cave_vines"},
		height = 1,
		height_max = 4,
		fill_ratio = 0.1,
		flags = "all_ceilings",
	...
	minetest.register_decoration({
		place_on = {"vlc_lush_caves:rooted_dirt"},
		decoration = "vlc_lush_caves:hanging_roots",
		deco_type = "simple",
		fill_ratio = 10,
		flags = "all_ceilings",
		biomes = lushcaves,
	...
	minetest.register_decoration({
		decoration = "vlc_lush_caves:spore_blossom",
		deco_type = "simple",
		place_on = {"vlc_lush_caves:moss"},
		spawn_by = {"air"},
		num_spawn_by = 4,
	...
	minetest.register_decoration({
		decoration = "vlc_lush_caves:moss_carpet",
		deco_type = "simple",
		place_on = table.merge(stonelike, {"vlc_deepslate:deepslate", "vlc_core:gravel","vlc_lush_caves:moss"}),
		fill_ratio = 0.1,
		flags = "all_floors",
		y_min = vlc_vars.mg_overworld_min,
		biomes = lushcaves,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = "vlc_lush_caves:moss","vlc_core:clay",
		fill_ratio = 0.5,
		biomes = lushcaves,
		decoration = "vlc_flowers:tallgrass",
		y_min = vlc_vars.mg_overworld_min,
	...
	minetest.register_decoration({
		...
		y_min = coral_min,
		y_max = coral_max,
		decoration = "vlc_ocean:dead_brain_coral_block",
		biomes = warm_oceans,
		flags = "force_placement",
		height = 1,
		height_max = 1,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_ocean:dead_brain_coral_block"},
		sidelen = 16,
		fill_ratio = 3,
		y_min = coral_min,
		y_max = coral_max,
		decoration = "vlc_ocean:sea_pickle_1_dead_brain_coral_block",
		biomes = warm_oceans,
		flags = "force_placement, all_floors",
		height = 1,
		height_max = 1,
	...
	minetest.register_decoration({
		...
		y_min = coral_min,
		y_max = coral_max,
		decoration = "vlc_ocean:sea_pickle_2_dead_brain_coral_block",
		biomes = warm_oceans,
		flags = "force_placement, all_floors",
		height = 1,
		height_max = 1,
	...
	minetest.register_decoration({
		...
		y_min = coral_min,
		y_max = coral_max,
		decoration = "vlc_ocean:sea_pickle_3_dead_brain_coral_block",
		biomes = warm_oceans,
		flags = "force_placement, all_floors",
		height = 1,
		height_max = 1,
	...
	minetest.register_decoration({
		...
		y_min = coral_min,
		y_max = coral_max,
		decoration = "vlc_ocean:sea_pickle_4_dead_brain_coral_block",
		biomes = warm_oceans,
		flags = "force_placement, all_floors",
		height = 1,
		height_max = 1,
	...
	minetest.register_decoration({
		...
		y_min = coral_min,
		y_max = coral_max,
		schematic = mod_vlc_schematics.."/schems/coral_cora.mts",
		rotation = "random",
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_core:dirt_with_grass","vlc_core:podzol"},
		sidelen = 16,
		noise_params = {
			offset = 0,
			scale = 0.012,
		...
		y_max = vlc_vars.mg_overworld_max,
		y_min = 2,
		decoration = "vlc_sweet_berry:sweet_berry_bush_3"
	})
	...
	minetest.register_decoration({
		...
		y_min = 4,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_structures_ice_spike_large.mts",
		rotation = "random",
	...
	minetest.register_decoration({
		...
		y_min = 4,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_structures_ice_spike_small.mts",
		rotation = "random",
		flags = "place_center_x, place_center_z",
	})
	...
	for i=1, 4 do
		minetest.register_decoration({
			deco_type = "schematic",
			place_on = {"group:grass_block_no_snow", "vlc_core:dirt"},
			sidelen = 80,
			noise_params = {
				offset = 0.000545,
				scale = 0.0011,
			...
			y_min = 1,
			y_max = vlc_vars.mg_overworld_max,
			schematic = mod_vlc_schematics.."/schems/vlc_core_oak_large_"..i..".mts",
			flags = "place_center_x, place_center_z",
			rotation = "random",
		})
		...
		minetest.register_decoration({
			deco_type = "schematic",
			place_on = {"group:grass_block", "vlc_core:dirt", },
			sidelen = 80,
			noise_params = {
				offset = -0.0007,
				scale = 0.001,
	...
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_oak_classic.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	minetest.register_decoration({
	...
	minetest.register_decoration({
		deco_type = "schematic",
		place_on = {"vlc_core:dirt_with_grass", "vlc_core:dirt"},
		sidelen = 16,
		noise_params = {
			offset = 0.015,
			scale = 0.002,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"group:grass_block_no_snow", "vlc_core:dirt", "vlc_mud:mud"},
		fill_ratio = 0.004,
		height = 7,
		height_max = 15,
	...
	for i=1,3 do
		minetest.register_decoration({
			...
			y_min = 1,
			y_max = vlc_vars.mg_overworld_max,
			decoration = "vlc_bamboo:bamboo"..i,
		})
	end
	...
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_oak_classic_bee_nest.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	...
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_oak_balloon.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	...
	minetest.register_decoration({
		...
		y_min = 0,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_oak_swamp.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})

	minetest.register_decoration({
		name = "vlc_biomes:mangrove_tree_1",
		deco_type = "schematic",
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_mangrove_tree_1.mts",
		flags = "place_center_x, place_center_z, force_placement",
		rotation = "random",
	})
	minetest.register_decoration({
		name = "vlc_biomes:mangrove_tree_2",
		deco_type = "schematic",
		place_on = {"vlc_mud:mud"},
		sidelen = 80,
		fill_ratio = 0.0045,
		...
		y_min = -1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_mangrove_tree_2.mts",
		flags = "place_center_x, place_center_z, force_placement",
		rotation = "random",
	})
	minetest.register_decoration({
		name = "vlc_biomes:mangrove_tree_3",
		deco_type = "schematic",
		place_on = {"vlc_mud:mud"},
		sidelen = 80,
		fill_ratio = 0.023,
		...
		y_min = -1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_mangrove_tree_3.mts",
		flags = "place_center_x, place_center_z, force_placement",
		rotation = "random",
	})
	minetest.register_decoration({
		name = "vlc_biomes:mangrove_tree_4",
		deco_type = "schematic",
		place_on = {"vlc_mud:mud"},
		sidelen = 80,
		fill_ratio = 0.023,
		...
		y_min = -1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_mangrove_tree_4.mts",
		flags = "place_center_x, place_center_z, force_placement",
		rotation = "random",
	})
	minetest.register_decoration({
		...
		y_min = -1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_mangrove_tree_5.mts",
		flags = "place_center_x, place_center_z, force_placement",
		rotation = "random",
	})
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_mangrove_bee_nest.mts",
		flags = "place_center_x, place_center_z, force_placement",
		rotation = "random",
		spawn_by = "group:flower",
	})
	minetest.register_decoration({
		...
		y_min = 0,
		y_max = 0,
		decoration = "vlc_mangrove:water_logged_roots",
		flags = "place_center_x, place_center_z, force_placement",
	})

	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_mangrove:mangrove_roots"},
	...
	minetest.register_decoration({
		...
		biomes = {"MangroveSwamp","MangroveSwamp_shore"},
		place_offset_y = -1,
		decoration = "vlc_mangrove:mangrove_mud_roots",
		flags = "place_center_x, place_center_z, force_placement",
	})
	minetest.register_decoration({
		deco_type = "simple",
		...
		fill_ratio = 0.008,
		biomes = {"MangroveSwamp","MangroveSwamp_shore"},
		decoration = "vlc_core:deadbush",
		flags = "place_center_x, place_center_z",
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_core:water_source"},
		sidelen = 80,
		fill_ratio = 0.035,
		biomes = {"MangroveSwamp","MangroveSwamp_shore"},
		decoration = "vlc_flowers:waterlily",
	...
	for i=1, 4 do
		minetest.register_decoration({
			...
			y_min = 4,
			y_max = vlc_vars.mg_overworld_max,
			schematic = mod_vlc_schematics.."/schems/vlc_core_jungle_tree_huge_"..i..".mts",
			flags = "place_center_x, place_center_z",
			rotation = "random",
		})
		minetest.register_decoration({
	...
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_jungle_tree.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_jungle_tree_2.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_jungle_tree_3.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_jungle_tree_4.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	minetest.register_decoration({
	...
	local function quick_spruce(seed, offset, sprucename, biomes, y)
		...
		minetest.register_decoration({
			deco_type = "schematic",
			place_on = {"group:grass_block", "vlc_core:dirt", "vlc_core:podzol"},
			sidelen = 16,
			noise_params = {
				offset = offset,
				scale = 0.0006,
			...
			y_min = y,
			y_max = vlc_vars.mg_overworld_max,
			schematic = mod_vlc_schematics.."/schems/"..sprucename,
			flags = "place_center_x, place_center_z",
		})
	end

	-- Huge spruce
	quick_spruce(3000, 0.0030, "vlc_core_spruce_huge_1.mts", {"MegaSpruceTaiga"})
	quick_spruce(4000, 0.0036, "vlc_core_spruce_huge_2.mts", {"MegaSpruceTaiga"})
	quick_spruce(6000, 0.0036, "vlc_core_spruce_huge_3.mts", {"MegaSpruceTaiga"})
	quick_spruce(6600, 0.0036, "vlc_core_spruce_huge_4.mts", {"MegaSpruceTaiga"})

	quick_spruce(3000, 0.0008, "vlc_core_spruce_huge_up_1.mts", {"MegaTaiga"})
	quick_spruce(4000, 0.0008, "vlc_core_spruce_huge_up_2.mts", {"MegaTaiga"})
	quick_spruce(6000, 0.0008, "vlc_core_spruce_huge_up_3.mts", {"MegaTaiga"})


	-- Common spruce
	quick_spruce(11000, 0.00150, "vlc_core_spruce_5.mts", {"Taiga", "ColdTaiga"})

	quick_spruce(2500, 0.00325, "vlc_core_spruce_1.mts", {"MegaSpruceTaiga", "MegaTaiga", "Taiga", "ColdTaiga"})
	quick_spruce(7000, 0.00425, "vlc_core_spruce_3.mts", {"MegaSpruceTaiga", "MegaTaiga", "Taiga", "ColdTaiga"})
	quick_spruce(9000, 0.00325, "vlc_core_spruce_4.mts", {"MegaTaiga", "Taiga", "ColdTaiga"})

	quick_spruce(9500, 0.00500, "vlc_core_spruce_tall.mts", {"MegaTaiga"})

	quick_spruce(5000, 0.00250, "vlc_core_spruce_2.mts", {"MegaSpruceTaiga", "MegaTaiga"})

	quick_spruce(11000, 0.000025, "vlc_core_spruce_5.mts", {"ExtremeHills", "ExtremeHillsM"})
	quick_spruce(2500, 0.00005, "vlc_core_spruce_1.mts", {"ExtremeHills", "ExtremeHillsM"})
	quick_spruce(7000, 0.00005, "vlc_core_spruce_3.mts", {"ExtremeHills", "ExtremeHillsM"})
	quick_spruce(9000, 0.00005, "vlc_core_spruce_4.mts", {"ExtremeHills", "ExtremeHillsM"})

	quick_spruce(11000, 0.001, "vlc_core_spruce_5.mts", {"ExtremeHills+", "ExtremeHills+_snowtop"}, 50)
	quick_spruce(2500, 0.002, "vlc_core_spruce_1.mts", {"ExtremeHills+", "ExtremeHills+_snowtop"}, 50)
	quick_spruce(7000, 0.003, "vlc_core_spruce_3.mts", {"ExtremeHills+", "ExtremeHills+_snowtop"}, 50)
	quick_spruce(9000, 0.002, "vlc_core_spruce_4.mts", {"ExtremeHills+", "ExtremeHills+_snowtop"}, 50)


	-- Small lollipop spruce
	minetest.register_decoration({
		deco_type = "schematic",
		place_on = {"group:grass_block", "vlc_core:podzol"},
		sidelen = 16,
		noise_params = {
			offset = 0.004,
			scale = 0.0022,
		...
		y_min = 2,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_spruce_lollipop.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	minetest.register_decoration({
		...
		y_min = 3,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_spruce_matchstick.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_spruce_5.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	for a=1, 7 do
		minetest.register_decoration({
			deco_type = "schematic",
			place_on = {"vlc_core:dirt_with_grass", "vlc_core:dirt", "vlc_core:coarse_dirt"},
			sidelen = 16,
			fill_ratio = 0.0002,
			biomes = {"Savanna", "SavannaM"},
			y_min = 1,
			y_max = vlc_vars.mg_overworld_max,
			schematic = mod_vlc_schematics.."/schems/vlc_core_acacia_"..a..".mts",
			flags = "place_center_x, place_center_z",
			rotation = "random",
		})
	end
	...
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_birch.mts",
		flags = "place_center_x, place_center_z",
	})
	minetest.register_decoration({
		deco_type = "schematic",
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_birch_tall.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_birch_bee_nest.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
		spawn_by = "group:flower",
	})
	...
	minetest.register_decoration({
		...
		y_min = 4,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_dark_oak.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	...
	for i=1,3 do
		minetest.register_decoration({
			deco_type = "schematic",
			place_on = {"vlc_core:dirt_with_grass"},
			sidelen = 80,
			noise_params = {
				offset = 0.007,
				scale = 0.08,
			...
			y_min = 1,
			y_max = vlc_vars.mg_overworld_max,
			schematic = mod_vlc_schematics.."/schems/vlc_cherry_blossom_tree_"..i..".mts",
			flags = "place_center_x, place_center_z",
			rotation = "random",
		})
		minetest.register_decoration({
			...
			y_min = 1,
			y_max = vlc_vars.mg_overworld_max,
			schematic = mod_vlc_schematics.."/schems/vlc_cherry_blossom_tree_beehive_"..i..".mts",
			flags = "place_center_x, place_center_z",
			rotation = "random",
		})
	end
	...
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_mushrooms_huge_brown.mts",
		flags = "place_center_x, place_center_z",
		rotation = "0",
	})
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_mushrooms_giant_brown.mts",
		flags = "place_center_x, place_center_z",
		rotation = "0",
	})
	...
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_mushrooms_huge_red.mts",
		flags = "place_center_x, place_center_z",
		rotation = "0",
	})
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_mushrooms_giant_red.mts",
		flags = "place_center_x, place_center_z",
		rotation = "0",
	})
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_core:dirt_with_grass_snow"},
		sidelen = 80,
		fill_ratio = 10,
		flags = "all_floors",
		y_min = vlc_vars.mg_overworld_min,
		y_max = vlc_vars.mg_overworld_max,
		decoration = "vlc_core:snow",
	})
	...
	minetest.register_decoration({
		...
		y_min = vlc_vars.mg_overworld_min,
		y_max = vlc_vars.mg_overworld_max,
		decoration = "vlc_mushrooms:mushroom_red",
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = table.merge(stonelike, {"vlc_deepslate:deepslate"}),
		...
		y_min = vlc_vars.mg_overworld_min,
		y_max = vlc_vars.mg_overworld_max,
		decoration = "vlc_mushrooms:mushroom_brown",
	})

	-- Mossy cobblestone boulder (3×3)
	minetest.register_decoration({
		deco_type = "schematic",
		place_on = {"vlc_core:podzol", "vlc_core:dirt", "vlc_core:coarse_dirt"},
		sidelen = 80,
		noise_params = {
			offset = 0.00015,
			scale = 0.001,
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_structures_boulder.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	...
	minetest.register_decoration({
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_structures_boulder_small.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_core:dirt", "vlc_core:coarse_dirt", "group:grass_block_no_snow", "group:sand", "vlc_core:podzol", "vlc_core:reeds"},
		sidelen = 16,
		noise_params = {
			offset = -0.3,
			scale = 0.7,
		...
		y_min = 1,
		y_max = vlc_vars.mg_overworld_max,
		decoration = "vlc_core:reeds",
		height = 1,
		height_max = 3,
		spawn_by = { "vlc_core:water_source", "group:frosted_ice" },
		num_spawn_by = 1,
	})
	minetest.register_decoration({
		deco_type = "simple",
	...
	-- Doubletall grass
	function vlc_biomes.register_doubletall_grass(offset, scale, biomes)
		...
		for b=1, #biomes do
			...
			minetest.register_decoration({
				...
				schematic = {
					...
					data = {
						{ name = "air", prob = 0 },
						{ name = "vlc_flowers:double_grass", param1=255, param2=param2 },
						{ name = "vlc_flowers:double_grass_top", param1=255, param2=param2 },
					},
				},
				place_on = {"group:grass_block_no_snow"},
				sidelen = 16,
	...
	local register_doubletall_grass = vlc_biomes.register_doubletall_grass
	...
	-- Large ferns
	function vlc_biomes.register_double_fern(offset, scale, biomes)
		for b=1, #biomes do
			local param2 = minetest.registered_biomes[biomes[b]]._vlc_palette_index
			minetest.register_decoration({
				deco_type = "schematic",
				schematic = {
					...
					data = {
						{ name = "air", prob = 0 },
						{ name = "vlc_flowers:double_fern", param1=255, param2=param2 },
						{ name = "vlc_flowers:double_fern_top", param1=255, param2=param2 },
					},
				},
				place_on = {"group:grass_block_no_snow", "vlc_core:podzol"},
				sidelen = 16,
				noise_params = {
					offset = offset,
					scale = scale,
	...
	local register_double_fern = vlc_biomes.register_double_fern
	...
	-- Large flowers
	function vlc_biomes.register_large_flower(name, biomes, seed, offset, flower_forest_offset)
		local maxi
		...
		for i=1, maxi do
			...
			minetest.register_decoration({
				...
				schematic = {
					...
					data = {
						{name = "air", prob = 0},
						{name = "vlc_flowers:" .. name, param1 = 255, },
						{name = "vlc_flowers:" .. name .. "_top", param1 = 255, },
					},
				},
				place_on = {"group:grass_block_no_snow", "vlc_core:dirt"},
	...
	local register_large_flower = vlc_biomes.register_large_flower
	...
	minetest.register_decoration({
		...
		y_min = 3,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_jungle_bush_oak_leaves.mts",
		flags = "place_center_x, place_center_z",
	})
	minetest.register_decoration({
		deco_type = "schematic",
		...
		y_min = 3,
		y_max = vlc_vars.mg_overworld_max,
		schematic = mod_vlc_schematics.."/schems/vlc_core_jungle_bush_oak_leaves_2.mts",
		flags = "place_center_x, place_center_z",
	})
	minetest.register_decoration({
		deco_type = "schematic",
	...
	local lily_schem = {
		{ name = "vlc_core:water_source" },
		{ name = "vlc_flowers:waterlily" },
	}
	...
	minetest.register_decoration({
		deco_type = "simple",
		decoration = "vlc_farming:pumpkin",
		param2 = 0,
		param2_max = 3,
		place_on = {"group:grass_block_no_snow"},
		sidelen = 16,
	...
	minetest.register_decoration({
		...
		y_min = vlc_vars.mg_overworld_min,
		y_max = vlc_vars.mg_overworld_max,
		decoration = "vlc_cherry_blossom:pink_petals",
	})
...
"ExtremeHillsM_deep_ocean","ExtremeHills+_deep_ocean","MegaTaiga_deep_ocean","MegaSpruceTaiga_deep_ocean","Plains_deep_ocean","SunflowerPlains_deep_ocean","Forest_deep_ocean","FlowerForest_deep_ocean","BirchForest_deep_ocean","BirchForestM_deep_ocean","RoofedForest_deep_ocean","Swampland_deep_ocean","Jungle_deep_ocean","JungleM_deep_ocean","JungleEdge_deep_ocean","JungleEdgeM_deep_ocean","MushroomIsland_deep_ocean"
	...
	minetest.register_decoration({
		...
		schematic = {
			size = { x=1, y=2, z=1 },
			data = {
				{ name = "vlc_core:dirt_with_grass", force_place=true, },
				{ name = "vlc_flowers:tallgrass", param2 = minetest.registered_biomes["IcePlains"]._vlc_palette_index },
			},
		},
	})
	minetest.register_decoration({
		...
		schematic = {
			...
			data = {
				{ name = "vlc_core:dirt_with_grass", force_place=true, },
				{ name = "vlc_flowers:tallgrass", param2 = minetest.registered_biomes["ExtremeHills+_snowtop"]._vlc_palette_index },
			},
		},
	})
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"group:sand", "vlc_core:podzol", "vlc_core:dirt", "vlc_core:dirt_with_grass", "vlc_core:coarse_dirt", "group:hardened_clay"},
		sidelen = 16,
		noise_params = {
			offset = 0.0,
			scale = 0.035,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"group:sand", "vlc_core:dirt", "vlc_core:dirt_with_grass", "vlc_core:coarse_dirt"},
		sidelen = 16,
		noise_params = {
			offset = 0.1,
			scale = 0.035,
	...
	-- Small Mushrooms
	local mushrooms = {"vlc_mushrooms:mushroom_red", "vlc_mushrooms:mushroom_brown"}
	...
	for m=1, #mushrooms do
		...
		minetest.register_decoration({
			deco_type = "simple",
			place_on = {"group:grass_block_no_snow", "vlc_core:dirt", "vlc_core:podzol", "vlc_core:mycelium", "vlc_core:stone", "vlc_core:andesite", "vlc_core:diorite", "vlc_core:granite"},
			sidelen = 16,
			noise_params = {
				offset = 0,
				scale = 0.003,
			...
			y_max = vlc_vars.mg_overworld_max,
			decoration = mushrooms[m],
			spawn_by = { "vlc_trees:tree_oak", "vlc_trees:tree_spruce", "vlc_trees:tree_dark_oak", "vlc_trees:tree_birch" },
			num_spawn_by = 1,
		})
	...
	function vlc_biomes.register_flower(name, biomes, seed, is_in_flower_forest)
	...
	local register_flower = vlc_biomes.register_flower
...
local function register_dimension_decorations()
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_nether:netherrack","vlc_nether:magma"},
		sidelen = 16,
		fill_ratio = 0.04,
		biomes = {"Nether"},
		y_min = vlc_vars.mg_lava_nether_max + 1,
		y_max = vlc_vars.mg_nether_max  - 1,
		flags = "all_floors",
		decoration = "vlc_fire:eternal_fire",
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_nether:netherrack"},
		sidelen = 16,
		fill_ratio = 0.013,
		biomes = {"Nether"},
		y_min = vlc_vars.mg_lava_nether_max + 1,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_crimson:warped_nylium"},
		sidelen = 16,
		fill_ratio = 0.02,
		biomes = {"WarpedForest"},
		y_min = vlc_vars.mg_lava_nether_max + 1,
		y_max = vlc_vars.mg_nether_max  - 10,
		flags = "all_floors",
		decoration = "vlc_crimson:warped_fungus",
	})
	minetest.register_decoration({
		deco_type = "schematic",
		name = "vlc_biomes:warped_tree1",
		place_on = {"vlc_crimson:warped_nylium"},
		sidelen = 16,
		fill_ratio = 0.007,
		biomes = {"WarpedForest"},
		...
		schematic = mod_vlc_schematics.."/schems/warped_fungus_1.mts",
		size = {x = 5, y = 11, z = 5},
		rotation = "random",
	})
	minetest.register_decoration({
		deco_type = "schematic",
		name = "vlc_biomes:warped_tree2",
		place_on = {"vlc_crimson:warped_nylium"},
		sidelen = 16,
		fill_ratio = 0.005,
		biomes = {"WarpedForest"},
		...
		y_max = vlc_vars.mg_nether_max - 10,
		flags = "all_floors, place_center_x, place_center_z",
		schematic = mod_vlc_schematics.."/schems/warped_fungus_2.mts",
		size = {x = 5, y = 6, z = 5},
		rotation = "random",
	})
	minetest.register_decoration({
		deco_type = "schematic",
		name = "vlc_biomes:warped_tree3",
		place_on = {"vlc_crimson:warped_nylium"},
		sidelen = 16,
		fill_ratio = 0.003,
		biomes = {"WarpedForest"},
		y_min = vlc_vars.mg_lava_nether_max + 1,
		y_max = vlc_vars.mg_nether_max - 14,
		flags = "all_floors, place_center_x, place_center_z",
		schematic = mod_vlc_schematics.."/schems/warped_fungus_3.mts",
		size = {x = 5, y = 12, z = 5},
		rotation = "random",
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_crimson:warped_nylium","vlc_crimson:twisting_vines"},
		sidelen = 16,
		fill_ratio = 0.032,
		biomes = {"WarpedForest"},
		y_min = vlc_vars.mg_lava_nether_max + 1,
		...
		height = 2,
		height_max = 8,
		decoration = "vlc_crimson:twisting_vines",
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_crimson:warped_nylium"},
		...
		flags = "all_floors",
		max_height = 5,
		decoration = "vlc_crimson:warped_roots",
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_crimson:crimson_nylium"},
		sidelen = 16,
		fill_ratio = 0.052,
		biomes = {"WarpedForest"},
		y_min = vlc_vars.mg_lava_nether_max + 1,
		flags = "all_floors",
		decoration = "vlc_crimson:nether_sprouts",
	})
	-- CRIMSON FOREST
	minetest.register_decoration({
		deco_type = "simple",
		...
		y_max = vlc_vars.mg_nether_max  - 10,
		flags = "all_floors",
		decoration = "vlc_crimson:crimson_fungus",
	})
	minetest.register_decoration({
		deco_type = "schematic",
		name = "vlc_biomes:crimson_tree",
		place_on = {"vlc_crimson:crimson_nylium"},
		sidelen = 16,
		fill_ratio = 0.008,
		biomes = {"CrimsonForest"},
		...
		y_max = vlc_vars.mg_nether_max - 10,
		flags = "all_floors, place_center_x, place_center_z",
		schematic = mod_vlc_schematics.."/schems/crimson_fungus_1.mts",
		size = {x = 5, y = 8, z = 5},
		rotation = "random",
	})
	minetest.register_decoration({
		deco_type = "schematic",
		name = "vlc_biomes:crimson_tree2",
		place_on = {"vlc_crimson:crimson_nylium"},
		sidelen = 16,
		fill_ratio = 0.006,
		biomes = {"CrimsonForest"},
		...
		y_max = vlc_vars.mg_nether_max - 15,
		flags = "all_floors, place_center_x, place_center_z",
		schematic = mod_vlc_schematics.."/schems/crimson_fungus_2.mts",
		size = {x = 5, y = 12, z = 5},
		rotation = "random",
	})
	minetest.register_decoration({
		deco_type = "schematic",
		name = "vlc_biomes:crimson_tree3",
		place_on = {"vlc_crimson:crimson_nylium"},
		sidelen = 16,
		fill_ratio = 0.004,
		biomes = {"CrimsonForest"},
		...
		flags = "all_floors, place_center_x, place_center_z",
		schematic = mod_vlc_schematics.."/schems/crimson_fungus_3.mts",
		size = {x = 7, y = 13, z = 7},
		rotation = "random",
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_crimson:warped_nylium","vlc_crimson:weeping_vines","vlc_nether:netherrack"},
		sidelen = 16,
		fill_ratio = 0.063,
		biomes = {"CrimsonForest"},
		y_min = vlc_vars.mg_lava_nether_max + 1,
		...
		height = 2,
		height_max = 8,
		decoration = "vlc_crimson:weeping_vines",
	})
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_crimson:crimson_nylium"},
		...
		flags = "all_floors",
		max_height = 5,
		decoration = "vlc_crimson:crimson_roots",
	})

	--SOULSAND VALLEY
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"vlc_blackstone:soul_soil","vlc_nether:soul_sand"},
		sidelen = 16,
		fill_ratio = 0.062,
		biomes = {"SoulsandValley"},
		y_min = vlc_vars.mg_lava_nether_max + 1,
		flags = "all_floors",
		max_height = 5,
		decoration = "vlc_blackstone:soul_fire",
	})
	minetest.register_decoration({
		deco_type = "schematic",
		place_on = {"vlc_blackstone:soul_soil","vlc_nether:soulsand"},
		sidelen = 16,
		fill_ratio = 0.000212,
		biomes = {"SoulsandValley"},
		y_min = vlc_vars.mg_lava_nether_max + 1,
		flags = "all_floors, place_center_x, place_center_z",
		schematic = mod_vlc_schematics.."/schems/vlc_blackstone_nether_fossil_1.mts",
		size = {x = 5, y = 8, z = 5},
		rotation = "random",
	})
	minetest.register_decoration({
		...
		y_min = vlc_vars.mg_lava_nether_max + 1,
		flags = "all_floors, place_center_x, place_center_z",
		schematic = mod_vlc_schematics.."/schems/vlc_blackstone_nether_fossil_2.mts",
		size = {x = 5, y = 8, z = 5},
		rotation = "random",
	})
	minetest.register_decoration({
		...
		y_min = vlc_vars.mg_lava_nether_max + 1,
		flags = "all_floors, place_center_x, place_center_z",
		schematic = mod_vlc_schematics.."/schems/vlc_blackstone_nether_fossil_3.mts",
		size = {x = 5, y = 8, z = 5},
		rotation = "random",
	})
	minetest.register_decoration({
		...
		y_min = vlc_vars.mg_lava_nether_max + 1,
		flags = "all_floors, place_center_x, place_center_z",
		schematic = mod_vlc_schematics.."/schems/vlc_blackstone_nether_fossil_4.mts",
		size = {x = 5, y = 8, z = 5},
		rotation = "random",
	})
	--BASALT DELTA
	minetest.register_decoration({
		deco_type = "simple",
		decoration = "vlc_blackstone:basalt",
		place_on = {"vlc_blackstone:basalt","vlc_nether:netherrack","vlc_blackstone:blackstone"},
		sidelen = 80,
		height_max = 55,
		noise_params={
			offset = -0.0085,
		...
		biomes = {"BasaltDelta"},
		y_min = vlc_vars.mg_lava_nether_max + 1,
		y_max = vlc_vars.mg_nether_deco_max - 50,
	...
	minetest.register_decoration({
		...
		biomes = {"BasaltDelta"},
		y_min = vlc_vars.mg_lava_nether_max + 1,
		y_max = vlc_vars.mg_nether_deco_max - 15,
		flags = "all_floors, all ceilings",
	})
	minetest.register_decoration({
		deco_type = "simple",
	...
	minetest.register_decoration({
		deco_type = "simple",
		decoration = "vlc_nether:nether_lava_source",
		place_on = {"vlc_blackstone:basalt","vlc_nether:netherrack","vlc_blackstone:blackstone"},
		...
		place_offset_y  = -1,
		y_min = vlc_vars.mg_lava_nether_max + 1,
		y_max = vlc_vars.mg_nether_max - 5,
		flags = "all_floors, force_placement",
	})
	...
	minetest.register_decoration({
		...
		decoration = "vlc_end:chorus_plant",
		height = 1,
		height_max = 8,
		biomes = { "End", "EndMidlands", "EndHighlands", "EndBarrens", "EndSmallIslands" },
	})
	minetest.register_decoration({
		name = "vlc_biomes:chorus_plant",
		deco_type = "simple",
		place_on = {"vlc_end:chorus_plant"},
		flags = "all_floors",
		sidelen = 16,
		fill_ratio = 10,
		--[[noise_params = {
		...
		y_min = vlc_vars.mg_end_min,
		y_max = vlc_vars.mg_end_max,
		decoration = "vlc_end:chorus_flower",
		height = 1,
		biomes = { "End", "EndMidlands", "EndHighlands", "EndBarrens", "EndSmallIslands" },
	})

	deco_id_chorus_plant = minetest.get_decoration_id("vlc_biomes:chorus_plant")
...
if mg_name ~= "singlenode" then
	...
	local deco_ids_fungus ={
		minetest.get_decoration_id("vlc_biomes:crimson_tree1"),
		minetest.get_decoration_id("vlc_biomes:crimson_tree2"),
		minetest.get_decoration_id("vlc_biomes:crimson_tree3"),
		minetest.get_decoration_id("vlc_biomes:warped_tree1"),
		minetest.get_decoration_id("vlc_biomes:warped_tree2"),
		minetest.get_decoration_id("vlc_biomes:warped_tree3")
	}
	local deco_ids_trees = {
		minetest.get_decoration_id("vlc_biomes:mangrove_tree_1"),
		minetest.get_decoration_id("vlc_biomes:mangrove_tree_2"),
		minetest.get_decoration_id("vlc_biomes:mangrove_tree_3"),
	}
	...
	local function mangrove_roots_gen(gennotify, pr)
		for _, f in pairs(deco_ids_trees) do
			for _, pos in ipairs(gennotify["decoration#" .. f] or {}) do
				local nn = minetest.find_nodes_in_area(vector.offset(pos, -8, -1, -8), vector.offset(pos, 8, 0, 8), {"vlc_mangrove:mangrove_roots"})
				for _, v in pairs(nn) do
					local l = pr:next(2, 16)
					local n = minetest.get_node(vector.offset(v, 0, -1, 0)).name
					if minetest.get_item_group(n, "water") > 0 then
						local wl = "vlc_mangrove:water_logged_roots"
						if n:find("river") then
							wl = "vlc_mangrove:river_water_logged_roots"
						end
						minetest.bulk_set_node(minetest.find_nodes_in_area(vector.offset(v, 0, 0, 0), vector.offset(v, 0, -l, 0), {"group:water"}), {name = wl})
					elseif n == "vlc_mud:mud" then
						minetest.bulk_set_node(minetest.find_nodes_in_area(vector.offset(v, 0, 0, 0), vector.offset(v, 0, -l, 0), {"vlc_mud:mud"}), {name = "vlc_mangrove:mangrove_mud_roots"})
					elseif n == "air" then
						minetest.bulk_set_node(minetest.find_nodes_in_area(vector.offset(v, 0, 0, 0), vector.offset(v, 0, -l, 0), {"air"}), {name = "vlc_mangrove:mangrove_roots"})
					end
				end
			end
		end
	...
	local function chorus_gen (gennotify, pr)
		for _, pos in ipairs(gennotify["decoration#" .. deco_id_chorus_plant] or {}) do
			...
			if x < -10 or x > 10 or z < -10 or z > 10 then
				...
				if node and node.name == "vlc_end:chorus_flower" then
					vlc_end.grow_chorus_plant(realpos, node, pr)
				end
			end
		end
	end
	...
	if deco_id_chorus_plant or deco_ids_fungus or deco_ids_trees then
		vlc_mapgen_core.register_generator("chorus_grow", nil, function(minp, maxp, blockseed)
			local gennotify = minetest.get_mapgen_object("gennotify")
			local pr = PseudoRandom(blockseed + 14)
			if not (maxp.y < vlc_vars.mg_overworld_min or minp.y > vlc_vars.mg_overworld_max) then
			...
			if not (maxp.y < vlc_vars.mg_end_min or minp.y > vlc_vars.mg_end_max) then
				chorus_gen(gennotify, pr)
			end

			if not (maxp.y < vlc_vars.mg_nether_min or minp.y > vlc_vars.mg_nether_max) then
