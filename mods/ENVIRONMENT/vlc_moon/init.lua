...
minetest.log("info", "[vlc_moon] Moon phase offset of this world: "..phase_offset)

vlc_moon = {}
vlc_moon.MOON_PHASES = MOON_PHASES

function vlc_moon.get_moon_phase()
...
local function get_moon_texture()
	local phase = vlc_moon.get_moon_phase()
	...
	return "vlc_moon_moon_phases.png^[sheet:"..SHEET_W.."x"..SHEET_H..":"..x..","..y
end
...
minetest.register_globalstep(function(dtime)
	...
	minetest.log("info", "[vlc_moon] New moon phase: "..phase)
