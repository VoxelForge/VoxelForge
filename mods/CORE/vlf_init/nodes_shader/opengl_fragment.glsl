...
const vec2[64] poissonDisk = vec2[64](
    ...
    vec2(-0.44201624, -0.39906216),
    vec2(0.24558609, -0.56890725),
    vec2(-0.394184101, -0.62938870),
    vec2(0.34495938, 0.49387760),
    vec2(-0.41588581, 0.65771432),
    vec2(-0.21544232, -0.57912464),
    vec2(-0.28277543, 0.37676845),
    vec2(0.87484398, 0.55648379),
    vec2(0.54323325, -0.57511554),
    vec2(0.63742981, -0.47373420),
    vec2(-0.16496911, -0.41893023),
    vec2(0.59197514, 0.29090188),
    vec2(-0.24188840, 0.89706507),
    vec2(-0.71409955, 0.81437590),
    vec2(0.49984126, 0.68641367),
    vec2(0.34383161, -0.34100790),
    vec2(-0.34201624, -0.45906216),
    vec2(0.74558609, -0.62890725),
    vec2(-0.394184101, -0.82938870),
    vec2(0.44495938, 0.39387760),
    vec2(-0.81588581, 0.55771432),
    vec2(-0.51544232, -0.47912464),
    vec2(-0.38277543, 0.67676845),
    vec2(0.67484398, 0.85648379),
    vec2(0.84323325, -0.57511554),
    vec2(0.93742981, -0.67373420),
    vec2(-0.26496911, -0.41893023),
    vec2(0.59197514, 0.49090188),
    vec2(-0.24188840, 0.89706507),
    vec2(-0.71409955, 0.91437590),
    vec2(0.49984126, 0.68641367),
    vec2(0.34383161, -0.34100790),
    vec2(-0.34201624, -0.45906216),
    vec2(0.74558609, -0.62890725),
