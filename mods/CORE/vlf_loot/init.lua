...
--[[
Repeat vlf_loot.get_loot multiple times for various loot_definitions.
...
function vlf_loot.get_multi_loot(multi_loot_definitions, pr)
	...
	for m=1, #multi_loot_definitions do
		local group = vlf_loot.get_loot(multi_loot_definitions[m], pr)
		for g=1, #group do
...
function vlf_loot.fill_inventory(inv, listname, items, pr)
