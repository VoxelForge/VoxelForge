...
local S = minetest.get_translator("mcl_potato_cutter")
...
minetest.register_on_mods_loaded(mcl_potato_cutter.refresh_recipes)
		...
		if fields then
			for k, _ in pairs(fields) do
				if tostring(k) then
					...
					if def and def._mcl_potato_cutter_recipes then
