...
vlc_furnaces.register_furnace("vlc_smoker:smoker", {
	...
	node_active = {
		...
		drop = "vlc_smoker:smoker",
	},
})

minetest.register_craft({
	output = "vlc_smoker:smoker",
	recipe = {
		{ "",           "group:tree",           "" },
		{ "group:tree", "vlc_furnaces:furnace", "group:tree" },
		{ "",           "group:tree",           "" },
	}
})
...
if minetest.get_modpath("doc") then
	doc.add_entry_alias("nodes", "vlc_smoker:smoker", "nodes", "vlc_smoker:smoker_active")
end
