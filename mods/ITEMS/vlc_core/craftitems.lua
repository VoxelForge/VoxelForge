...
minetest.register_craftitem("vlc_core:stick", {
	description = S("Stick"),
...
minetest.register_craftitem("vlc_core:paper", {
	description = S("Paper"),
...
minetest.register_craftitem("vlc_core:coal_lump", {
	description = S("Coal"),
...
minetest.register_craftitem("vlc_core:charcoal_lump", {
	...
	_doc_items_hidden = false,
	inventory_image = "vlc_core_charcoal.png",
	groups = { craftitem=1, coal=1 },
})

minetest.register_craftitem("vlc_core:iron_nugget", {
	...
	inventory_image = "vlc_core_iron_nugget.png",
	groups = { craftitem=1 },
})

minetest.register_craftitem("vlc_core:gold_nugget", {
	...
	inventory_image = "vlc_core_gold_nugget.png",
	groups = { craftitem=1 },
})

minetest.register_craftitem("vlc_core:diamond", {
...
minetest.register_craftitem("vlc_core:clay_lump", {
...
minetest.register_craftitem("vlc_core:iron_ingot", {
...
minetest.register_craftitem("vlc_core:gold_ingot", {
...
minetest.register_craftitem("vlc_core:flint", {
	description = S("Flint"),
...
minetest.register_craftitem("vlc_core:sugar", {
	description = S("Sugar"),
	_doc_items_longdesc = S("Sugar comes from sugar canes and is used to make sweet foods."),
	inventory_image = "vlc_core_sugar.png",
	groups = { craftitem = 1, brewitem=1 },
})

minetest.register_craftitem("vlc_core:bowl",{
	description = S("Bowl"),
	_doc_items_longdesc = S("Bowls are mainly used to hold tasty soups."),
	inventory_image = "vlc_core_bowl.png",
	groups = { craftitem = 1 },
})

minetest.register_craftitem("vlc_core:apple", {
	description = S("Apple"),
...
local function eat_gapple(itemstack, placer, pointed_thing)
	...
	if itemstack:get_name() == "vlc_core:apple_gold_enchanted" then
		vlc_potions.fire_resistance_func(placer, 1, 300)
		vlc_potions.leaping_func(placer, 1.15, 300)
		vlc_potions.swiftness_func(placer, 1.2, 300)
		vlc_potions.regeneration_func(placer, 0.15, 30)
	else
		vlc_potions.regeneration_func(placer, 2.5, 30)
	end
	return gapple_hunger_restore(itemstack, placer, pointed_thing)
end

minetest.register_craftitem("vlc_core:apple_gold", {
	-- TODO: Add special highlight color
	description = S("Golden Apple"),
	_doc_items_longdesc = S("Golden apples are precious food items which can be eaten."),
	wield_image = "vlc_core_apple_golden.png",
	inventory_image = "vlc_core_apple_golden.png",
	on_place = eat_gapple,
...
minetest.register_craftitem("vlc_core:apple_gold_enchanted", {
	description = S("Enchanted Golden Apple"),
	_doc_items_longdesc = S("Golden apples are precious food items which can be eaten."),
	wield_image = "vlc_core_apple_golden.png" .. vlc_enchanting.overlay,
	inventory_image = "vlc_core_apple_golden.png" .. vlc_enchanting.overlay,
	on_place = eat_gapple,
	on_secondary_use = eat_gapple,
	groups = { food = 2, eatable = 4, can_eat_when_full = 1 },
	_vlc_saturation = 9.6,
