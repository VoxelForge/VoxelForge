...
minetest.register_node("vlc_core:bone_block", {
	description = S("Bone Block"),
	_doc_items_longdesc = S("Bone blocks are decorative blocks and a compact storage of bone meal."),
	tiles = {"vlc_core_bone_block_top.png", "vlc_core_bone_block_top.png", "vlc_core_bone_block_side.png"},
...
minetest.register_node("vlc_core:slimeblock", {
	...
	mvps_sticky = function(pos, node, piston_pos)
		...
		for n, v in ipairs(alldirs) do
			...
			if neighbor_node then
				...
				if name ~= "air" and name ~= "ignore" and name ~= "vlc_honey:honey_block" and not mesecon.mvps_unsticky[name] then
...
minetest.register_node("vlc_core:cobweb", {
	...
	visual_scale = 1.1,
	tiles = {"vlc_core_web.png"},
	inventory_image = "vlc_core_web.png",
	paramtype = "light",
	move_resistance = 14,
	walkable = false,
	...
	drop = "vlc_mobitems:string",
	_vlc_shears_drop = true,
	sounds = vlc_sounds.node_sound_leaves_defaults(),
	_vlc_blast_resistance = 4,
	_vlc_hardness = 4,
})


minetest.register_node("vlc_core:deadbush", {
...
vlc_flowerpots.register_potted_flower("vlc_core:deadbush", {
	name = "deadbush",
	desc = S("Dead Bush"),
...
minetest.register_craft({
	type = "fuel",
	recipe = "vlc_core:deadbush",
	burntime = 5,
})

minetest.register_node("vlc_core:barrier", {
	...
	drawtype = "airlike",
	paramtype = "light",
	inventory_image = "vlc_core_barrier.png",
	wield_image = "vlc_core_barrier.png",
	tiles = {"blank.png"},
	sunlight_propagates = true,
	is_ground_content = false,
	...
	drop = "",
	_vlc_blast_resistance = 36000008,
	_vlc_hardness = -1,
...
minetest.register_node("vlc_core:realm_barrier", {
	description = S("Realm Barrier"),
	_doc_items_create_entry = false,
	drawtype = "airlike",
	paramtype = "light",
	inventory_image = "vlc_core_barrier.png^[colorize:#FF00FF:127^[transformFX",
	wield_image = "vlc_core_barrier.png^[colorize:#FF00FF:127^[transformFX",
	tiles = {"blank.png"},
	...
	on_place = function(itemstack, placer, pointed_thing)
		if placer then
			minetest.chat_send_player(placer:get_player_name(),
				minetest.colorize(vlc_colors.RED, "You can't just place a realm barrier by hand!"))
		end
		return
	end,
})
...
local light_block_pattern = "^vlc_core:light_(%d+)$"


for i = 0, 14 do --minetest.LIGHT_MAX
	minetest.register_node("vlc_core:light_" .. i, {
		description = S("Light"),
		...
		buildable_to = true,
		node_placement_prediction = "",
		inventory_image = "vlc_core_light_" .. i .. ".png",
		wield_image = "vlc_core_light_" .. i .. ".png",
		sunlight_propagates = true,
		is_ground_content = false,
		...
		on_use = function(itemstack, user, pointed_thing)
			...
			itemstack:set_name("vlc_core:light_" .. ((i == 14) and 0 or i + 1))
			return itemstack
		end,
		on_place = vlc_util.bypass_buildable_to(function(node_name)
...
minetest.register_node("vlc_core:void", {
	...
	pointable = false,
	walkable = false,
	inventory_image = "vlc_core_void.png",
	wield_image = "vlc_core_void.png",
	sunlight_propagates = true,
	is_ground_content = false,
	...
	on_place = function(itemstack, placer, pointed_thing)
		if placer then
			minetest.chat_send_player(placer:get_player_name(),
				minetest.colorize(vlc_colors.RED, "You can't just place the void by hand!"))
		end
	end,
	drop = "",
