...
minetest.register_node("vlc_core:glass", {
	description = S("Glass"),
...
for color,colordef in pairs(vlc_dyes.colors) do
	...
	minetest.register_node("vlc_core:glass_"..color, {
		...
		drawtype = "glasslike_framed_optional",
		is_ground_content = false,
		tiles = {"vlc_core_glass_"..texcol..".png", "vlc_core_glass_"..texcol.."_detail.png"},
		paramtype = "light",
		paramtype2 = "glasslikeliquidlevel",
		sunlight_propagates = true,
	...
	minetest.register_craft({
		output = "vlc_core:glass_"..color.." 8",
		recipe = {
			{"vlc_core:glass","vlc_core:glass","vlc_core:glass"},
			{"vlc_core:glass","vlc_dyes:"..color,"vlc_core:glass"},
			{"vlc_core:glass","vlc_core:glass","vlc_core:glass"},
		}
	})

	if mod_doc and color ~= canonical_color then
		doc.add_entry_alias("nodes", "vlc_core:glass_"..canonical_color, "nodes", "vlc_core:glass_"..color)
	end
end

-- legacy: for some reason glass was the only place where grey was spelled with an a
minetest.register_alias("vlc_core:glass_gray","vlc_core:glass_grey")
