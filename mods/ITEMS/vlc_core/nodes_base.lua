...
minetest.register_node("vlc_core:stone", {
	description = S("Stone"),
	...
	after_dig_node = function(pos, oldnode, oldmetadata, digger)
		if awards and awards.unlock and digger and digger:is_player() then
			awards.unlock(digger:get_player_name(), "vlc:stoneAge")
		end
	end,
})

minetest.register_node("vlc_core:coal_ore", {
...
local function redstone_ore_activate(pos, node, puncher, pointed_thing)
	...
	minetest.swap_node(pos, {name=nodedef._vlc_ore_lit})
...
minetest.register_node("vlc_core:redstone_ore", {
	...
	tiles = {"vlc_core_redstone_ore.png"},
	...
	_vlc_ore_lit = "vlc_core:redstone_ore_lit",
})
...
minetest.register_node("vlc_core:redstone_ore_lit", {
	...
	on_timer = function(pos, elapsed)
		local nodedef = minetest.registered_nodes[minetest.get_node(pos).name]
		minetest.swap_node(pos, {name=nodedef._vlc_ore_unlit})
	end,
	_vlc_blast_resistance = 3,
	_vlc_hardness = 3,
	_vlc_silk_touch_drop = {"vlc_core:redstone_ore"},
	_vlc_fortune_drop = {
		discrete_uniform_distribution = true,
		items = {"mesecons:redstone"},
		min_count = 4,
	...
	_vlc_ore_unlit = "vlc_core:redstone_ore",
})

minetest.register_node("vlc_core:lapis_ore", {
	...
	tiles = {"vlc_core_lapis_ore.png"},
	groups = {pickaxey=3, building_block=1, material_stone=1, xp=6, blast_furnace_smeltable=1},
	drop = {
		max_items = 1,
		items = {
			{items = {"vlc_core:lapis 8"},rarity = 5},
			{items = {"vlc_core:lapis 7"},rarity = 5},
			{items = {"vlc_core:lapis 6"},rarity = 5},
			{items = {"vlc_core:lapis 5"},rarity = 5},
			{items = {"vlc_core:lapis 4"}},
		}
	},
	sounds = vlc_sounds.node_sound_stone_defaults(),
	_vlc_blast_resistance = 3,
...
minetest.register_node("vlc_core:emerald_ore", {
...
minetest.register_node("vlc_core:stonebrick", {
	...
	_vlc_blast_resistance = 6,
	_vlc_hardness = 1.5,
	_vlc_stonecutter_recipes = { "vlc_core:stone" },
})

minetest.register_node("vlc_core:stonebrickcarved", {
	description = S("Chiseled Stone Bricks"),
	_doc_items_longdesc = doc.sub.items.temp.build,
	tiles = {"vlc_core_stonebrick_carved.png"},
	groups = {pickaxey=1, stone=1, stonebrick=1, building_block=1, material_stone=1},
	sounds = vlc_sounds.node_sound_stone_defaults(),
	is_ground_content = false,
	_vlc_blast_resistance = 6,
	_vlc_hardness = 1.5,
	_vlc_stonecutter_recipes = { "vlc_core:stone", "vlc_core:stonebrick" },
})

minetest.register_node("vlc_core:stonebrickcracked", {
	description = S("Cracked Stone Bricks"),
	_doc_items_longdesc = doc.sub.items.temp.build,
	tiles = {"vlc_core_stonebrick_cracked.png"},
	groups = {pickaxey=1, stone=1, stonebrick=1, building_block=1, material_stone=1},
	sounds = vlc_sounds.node_sound_stone_defaults(),
	is_ground_content = false,
	_vlc_blast_resistance = 6,
...
minetest.register_node("vlc_core:stonebrickmossy", {
	description = S("Mossy Stone Bricks"),
	_doc_items_longdesc = doc.sub.items.temp.build,
	tiles = {"vlc_core_stonebrick_mossy.png"},
	groups = {pickaxey=1, stone=1, stonebrick=1, building_block=1, material_stone=1, stonecuttable = 1},
	sounds = vlc_sounds.node_sound_stone_defaults(),
	is_ground_content = false,
	_vlc_blast_resistance = 6,
...
minetest.register_node("vlc_core:stone_smooth", {
	description = S("Smooth Stone"),
	_doc_items_longdesc = doc.sub.items.temp.build,
	tiles = {"vlc_stairs_stone_slab_top.png"},
...
minetest.register_node("vlc_core:granite", {
	description = S("Granite"),
	_doc_items_longdesc = S("Granite is an igneous rock."),
	tiles = {"vlc_core_granite.png"},
	groups = {pickaxey=1, stone=1, building_block=1, material_stone=1, stonecuttable = 1, converts_to_moss = 1},
	sounds = vlc_sounds.node_sound_stone_defaults(),
	_vlc_blast_resistance = 6,
	_vlc_hardness = 1.5,
...
-- Grass Block
minetest.register_node("vlc_core:dirt_with_grass", {
	...
	_doc_items_hidden = false,
	paramtype2 = "color",
	tiles = {"vlc_core_grass_block_top.png", { name="default_dirt.png", color="white" }, { name="default_dirt.png^vlc_dirt_grass_shadow.png", color="white" }},
	overlay_tiles = {"vlc_core_grass_block_top.png", "blank.png", {name="vlc_core_grass_block_side_overlay.png", tileable_vertical=false}},
	palette = "vlc_core_palette_grass.png",
	palette_index = 0,
	color = "#8EB971",
	_on_shovel_place = vlc_core.make_dirtpath,
	groups = {
	...
	on_construct = function(pos)
		...
		if node.param2 == 0 then
			local new_node = vlc_core.get_grass_block_type(pos)
			if new_node.param2 ~= 0 or new_node.name ~= "vlc_core:dirt_with_grass" then
				minetest.set_node(pos, new_node)
			end
		end
		return vlc_core.on_snowable_construct(pos)
	end,
	_vlc_snowed = "vlc_core:dirt_with_grass_snow",
	_vlc_blast_resistance = 0.6,
	_vlc_hardness = 0.6,
	_vlc_silk_touch_drop = true,
	_on_bone_meal = vlc_core.bone_meal_grass,
})
vlc_core.register_snowed_node("vlc_core:dirt_with_grass_snow", "vlc_core:dirt_with_grass", nil, nil, true, S("Dirt with Snow"))

minetest.register_node("vlc_core:grass_path", {
	tiles = {"vlc_core_grass_path_top.png", "default_dirt.png", "vlc_core_grass_path_side.png"},
	...
	_vlc_blast_resistance = 0.65,
	_vlc_hardness = 0.6,
})

minetest.register_node("vlc_core:mycelium", {
	...
	tiles = {"vlc_core_mycelium_top.png", "default_dirt.png", {name="vlc_core_mycelium_side.png", tileable_vertical=false}},
	...
	on_construct = vlc_core.on_snowable_construct,
	_on_shovel_place = vlc_core.make_dirtpath,
	_vlc_snowed = "vlc_core:mycelium_snow",
	_vlc_blast_resistance = 0.6,
	_vlc_hardness = 0.6,
	_vlc_silk_touch_drop = true,
})
vlc_core.register_snowed_node("vlc_core:mycelium_snow", "vlc_core:mycelium", nil, nil, false, S("Mycelium with Snow"))

local PARTICLE_ABM_DISTANCE = 16

--if minetest.settings:get("vlc_node_particles") == "full" then
		...
		for _,player in pairs(minetest.get_connected_players()) do
			if vector.distance(player:get_pos(), pos) < PARTICLE_ABM_DISTANCE then
				minetest.add_particlespawner({
					...
					size = 1,
					texture = "vlc_core_mycelium_particle.png",
				})
			end
		end
	end,
...
minetest.register_node("vlc_core:podzol", {
	...
	tiles = {"vlc_core_dirt_podzol_top.png", "default_dirt.png", {name="vlc_core_dirt_podzol_side.png", tileable_vertical=false}},
groups = {handy=1, shovely=3, dirt=2, soil=1, soil_sapling=2, soil_sugarcane=1, soil_bamboo = 1, soil_fungus=1, enderman_takable=1, building_block=1, supports_mushrooms=1, converts_to_moss=1},
	...
	on_construct = vlc_core.on_snowable_construct,
	_on_shovel_place = vlc_core.make_dirtpath,
	_vlc_snowed = "vlc_core:podzol_snow",
	_vlc_blast_resistance = 0.8,
	_vlc_hardness = 0.8,
	_vlc_silk_touch_drop = true,
})
vlc_core.register_snowed_node("vlc_core:podzol_snow", "vlc_core:podzol", nil, nil, false, S("Podzol with Snow"))

minetest.register_node("vlc_core:dirt", {
	description = S("Dirt"),
...
minetest.register_node("vlc_core:coarse_dirt", {
	...
	tiles = {"vlc_core_coarse_dirt.png"},
...
minetest.register_node("vlc_core:gravel", {
	...
	drop = {
		max_items = 1,
		items = {
			{items = {"vlc_core:flint"},rarity = 10},
			{items = {"vlc_core:gravel"}}
		}
	},
	sounds = vlc_sounds.node_sound_gravel_defaults(),
	_vlc_blast_resistance = 0.6,
	_vlc_hardness = 0.6,
	_vlc_silk_touch_drop = true,
	_vlc_fortune_drop = {
...
-- sandstone --
minetest.register_node("vlc_core:sand", {
	description = S("Sand"),
...
minetest.register_node("vlc_core:sandstone", {
	description = S("Sandstone"),
	_doc_items_hidden = false,
	_doc_items_longdesc = S("Sandstone is compressed sand and is a rather soft kind of stone."),
	tiles = {"vlc_core_sandstone_top.png", "vlc_core_sandstone_bottom.png", "vlc_core_sandstone_normal.png"},
...
minetest.register_node("vlc_core:sandstonesmooth", {
	description = S("Cut Sandstone"),
	_doc_items_longdesc = S("Cut sandstone is a decorative building block."),
	tiles = {"vlc_core_sandstone_top.png", "vlc_core_sandstone_bottom.png", "vlc_core_sandstone_smooth.png"},
	is_ground_content = false,
...
minetest.register_node("vlc_core:sandstonecarved", {
	description = S("Chiseled Sandstone"),
	_doc_items_longdesc = S("Chiseled sandstone is a decorative building block."),
	tiles = {"vlc_core_sandstone_top.png", "vlc_core_sandstone_bottom.png", "vlc_core_sandstone_carved.png"},
	is_ground_content = false,
	groups = {pickaxey=1, sandstone=1, normal_sandstone=1, building_block=1, material_stone=1},
	sounds = vlc_sounds.node_sound_stone_defaults(),
	_vlc_blast_resistance = 0.8,
...
minetest.register_node("vlc_core:sandstonesmooth2", {
	...
	tiles = {"vlc_core_sandstone_top.png"},
	is_ground_content = false,
	groups = {pickaxey=1, sandstone=1, normal_sandstone=1, building_block=1, material_stone=1},
	sounds = vlc_sounds.node_sound_stone_defaults(),
	_vlc_blast_resistance = 6,
...
minetest.register_node("vlc_core:redsandstone", {
	description = S("Red Sandstone"),
	_doc_items_longdesc = S("Red sandstone is compressed red sand and is a rather soft kind of stone."),
	tiles = {"vlc_core_red_sandstone_top.png", "vlc_core_red_sandstone_bottom.png", "vlc_core_red_sandstone_normal.png"},
...
minetest.register_node("vlc_core:redsandstonesmooth", {
	description = S("Cut Red Sandstone"),
	_doc_items_longdesc = S("Cut red sandstone is a decorative building block."),
	tiles = {"vlc_core_red_sandstone_top.png", "vlc_core_red_sandstone_bottom.png", "vlc_core_red_sandstone_smooth.png"},
	is_ground_content = false,
...
minetest.register_node("vlc_core:redsandstonecarved", {
	description = S("Chiseled Red Sandstone"),
	_doc_items_longdesc = S("Chiseled red sandstone is a decorative building block."),
	tiles = {"vlc_core_red_sandstone_top.png", "vlc_core_red_sandstone_bottom.png", "vlc_core_red_sandstone_carved.png"},
	is_ground_content = false,
	groups = {pickaxey=1, sandstone=1, red_sandstone=1, building_block=1, material_stone=1},
	sounds = vlc_sounds.node_sound_stone_defaults(),
	_vlc_blast_resistance = 0.8,
...
minetest.register_node("vlc_core:clay", {
	description = S("Clay"),
...
minetest.register_node("vlc_core:brick_block", {
...
minetest.register_node("vlc_core:bedrock", {
...
minetest.register_node("vlc_core:cobble", {
...
minetest.register_node("vlc_core:mossycobble", {
...
minetest.register_node("vlc_core:coalblock", {
...
minetest.register_node("vlc_core:ironblock", {
...
minetest.register_node("vlc_core:goldblock", {
...
minetest.register_node("vlc_core:diamondblock", {
...
minetest.register_node("vlc_core:lapisblock", {
	...
	tiles = {"vlc_core_lapis_block.png"},
	is_ground_content = false,
...
minetest.register_node("vlc_core:emeraldblock", {
	...
	tiles = {"vlc_core_emerald_block.png"},
	is_ground_content = false,
	groups = {pickaxey=4, building_block=1},
	sounds = vlc_sounds.node_sound_stone_defaults(),
	_vlc_blast_resistance = 6,
...
minetest.register_node("vlc_core:obsidian", {
	...
	after_dig_node = function(pos, oldnode, oldmetadata, digger)
		if awards and awards.unlock and digger and digger:is_player() then
			awards.unlock(digger:get_player_name(), "vlc:obsidian")
		end
	end,
})

minetest.register_node("vlc_core:crying_obsidian", {
	...
	tiles = {"default_obsidian.png^vlc_core_crying_obsidian.png"},
	is_ground_content = false,
	light_source = 10,
	sounds = vlc_sounds.node_sound_stone_defaults(),
	groups = {pickaxey=5, building_block=1, material_stone=1},
...
minetest.register_node("vlc_core:ice", {
	description = S("Ice"),
	...
	drop = "",
	sounds = vlc_sounds.node_sound_ice_defaults(),
	node_dig_prediction = "vlc_core:water_source",
	after_dig_node = function(pos, oldnode)
		vlc_core.melt_ice(pos)
	end,
	_vlc_blast_resistance = 0.5,
	_vlc_hardness = 0.5,
	_vlc_silk_touch_drop = true,
...
for i=0,3 do
	...
	function ice.increase_age(pos, ice_near, first_melt)
		...
		if age < 3 then
			minetest.swap_node(pos, { name = "vlc_core:frosted_ice_"..(age+1) })
		else
			if dim ~= "nether" then
				minetest.set_node(pos, { name = "vlc_core:water_source" })
			else
				minetest.remove_node(pos)
			end
		end
	...
	minetest.register_node("vlc_core:frosted_ice_"..i, {
		description = S("Frosted Ice"),
		_doc_items_create_entry = use_doc,
		_doc_items_longdesc = longdesc,
		drawtype = ice_drawtype,
		tiles = {"vlc_core_frosted_ice_"..i..".png"},
		is_ground_content = false,
		paramtype = "light",
		use_texture_alpha = ice_texture_alpha,
	...
	if minetest.get_modpath("doc") and i > 0 then
		doc.add_entry_alias("nodes", "vlc_core:frosted_ice_0", "nodes", "vlc_core:frosted_ice_"..i)
	end
end
...
local function on_place(itemstack, placer, pointed_thing)
	...
	if g == 8 then
		...
		if minetest.get_node(p).name == "air" then
			minetest.set_node(p, {name="vlc_core:snow"})
	...
	elseif g > 0 then
		...
		fakestack:set_name("vlc_core:snow_"..(g+1))
		itemstack = minetest.item_place(fakestack, placer, pointed_thing)
		minetest.sound_play(vlc_sounds.node_sound_snow_defaults().place, {pos = pointed_thing.under}, true)
	...
	if minetest.get_item_group(bnode.name, "solid") == 1 then
		minetest.sound_play(vlc_sounds.node_sound_snow_defaults().place, {pos = below}, true)
...
for i=1,8 do
	...
	if i == 1 then
		...
		if minetest.get_modpath("doc") then
			doc.add_entry_alias("nodes", "vlc_core:snow", "nodes", id)
		end
		walkable = true
	end
	if i ~= 8 then
	...
	minetest.register_node(id, {
		...
		on_flood = function(pos, oldnode, newnode)
			...
			vlc_core.clear_snow_dirt(npos, node)
		end,
		node_box = node_box,
		groups = {shovely=2, attached_node=1, deco_block=1, dig_by_water=1, dig_by_piston=1, snow_cover=1, top_snow=i},
		sounds = vlc_sounds.node_sound_snow_defaults(),
		on_construct = vlc_core.on_snow_construct,
		on_place = on_place,
		after_destruct = vlc_core.after_snow_destruct,
		drop = "vlc_throwing:snowball "..(i+1),
		_vlc_blast_resistance = 0.1,
		_vlc_hardness = 0.1,
		_vlc_silk_touch_drop = {"vlc_core:snow " .. i},
	})
end

minetest.register_node("vlc_core:snowblock", {
	description = S("Snow"),
...
-- Add entry aliases for the Help
if minetest.get_modpath("doc") then
	doc.add_entry_alias("nodes", "vlc_core:redstone_ore", "nodes", "vlc_core:redstone_ore_lit")
	doc.add_entry_alias("nodes", "vlc_core:water_source", "nodes", "vlc_core:water_flowing")
	doc.add_entry_alias("nodes", "vlc_core:lava_source", "nodes", "vlc_core:lava_flowing")
end
