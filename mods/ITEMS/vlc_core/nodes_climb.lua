...
minetest.register_node("vlc_core:ladder", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		if (groups and (groups.glass or groups.leaves or groups.slab)) or
				node.name == "vlc_core:ladder" or node.name == "vlc_core:ice" or node.name == "vlc_nether:glowstone" or node.name == "vlc_ocean:sea_lantern" then
			return itemstack
		end
...
minetest.register_node("vlc_core:vine", {
	description = S("Vines"),
	...
	drawtype = "signlike",
	tiles = {"vlc_core_vine.png"},
	inventory_image = "vlc_core_vine.png",
	wield_image = "vlc_core_vine.png",
	paramtype = "light",
	sunlight_propagates = true,
	paramtype2 = "wallmounted",
	walkable = false,
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		if not vlc_core.supports_vines(node.name) then
			return itemstack
		end
