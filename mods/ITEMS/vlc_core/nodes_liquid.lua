...
minetest.register_node("vlc_core:water_flowing", {
	...
	drowning = 4,
	liquidtype = "flowing",
	liquid_alternative_flowing = "vlc_core:water_flowing",
	liquid_alternative_source = "vlc_core:water_source",
...
minetest.register_node("vlc_core:water_source", {
...
minetest.register_node("vlc_core:lava_flowing", {
	...
	is_ground_content = false,
	sounds = vlc_sounds.node_sound_lava_defaults(),
	walkable = false,
	pointable = false,
	diggable = false,
	buildable_to = true,
	...
	drowning = 0,
	liquidtype = "flowing",
	liquid_alternative_flowing = "vlc_core:lava_flowing",
	liquid_alternative_source = "vlc_core:lava_source",
...
minetest.register_node("vlc_core:lava_source", {
...
local function emit_lava_particle(pos)
	...
	minetest.add_particle({
		...
		texture = "vlc_particles_lava.png",
		glow = LIGHT_LAVA,
	})
end
