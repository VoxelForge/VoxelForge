...
vlf_vaults.register_vault("vault",{
	key = {
		...
		inventory_image = "vlf_trials_trial_key.png^(vlf_trials_trial_key_desat.png^[multiply:#FF896E)",
	},
	node_off = {
...
vlf_vaults.register_vault("ominous_vault",{
	key = {
		...
		inventory_image = "vlf_trials_trial_key_ominous.png^(vlf_trials_trial_key_desat.png^[multiply:#98FFD9)",
	},
	node_off = {
