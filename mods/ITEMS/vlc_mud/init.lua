...
minetest.register_node("vlc_mud:mud", {
	description = S("Mud"),
...
vlc_stairs.register_stair_and_slab("mud_brick", {
	baseitem = "vlc_mud:mud_bricks",
	description_stair = S("Mud Brick Stair"),
	description_slab = S("Mud Brick Slab"),
	overrides = {_vlc_stonecutter_recipes = {"vlc_mud:mud_bricks"}},{_vlc_stonecutter_recipes = {"vlc_mud:mud_bricks"}}
})

-- packed mud
minetest.register_craft({
	type = "shapeless",
	output = "vlc_mud:packed_mud",
	recipe = {
		"vlc_mud:mud",
...
minetest.register_craft({
	type = "shaped",
	output = "vlc_mud:mud_bricks 4",
	recipe = {
		{"vlc_mud:packed_mud", "vlc_mud:packed_mud"},
		{"vlc_mud:packed_mud", "vlc_mud:packed_mud"}
	}
})
