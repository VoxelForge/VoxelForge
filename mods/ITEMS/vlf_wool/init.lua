...
minetest.register_alias("vlf_wool:dark_blue", "wool:blue")
minetest.register_alias("vlf_wool:gold", "wool:yellow")
...
local messy_textures = { --translator table for the bed texture filenames names not adhering to the common color names of vlf_dyes
	["light_blue"] = "vlf_wool_light_blue",
	["grey"] = "wool_dark_grey",
	["silver"] = "wool_grey",
...
for color,colordef in pairs(vlf_dyes.colors) do
	...
	if mod_doc and not is_canonical then
		doc.add_entry_alias("nodes", "vlf_wool:"..canonical_color, "nodes", "vlf_wool:"..color)
		doc.add_entry_alias("nodes", "vlf_wool:"..canonical_color.."_carpet", "nodes", "vlf_wool:"..color.."_carpet")
	end

	minetest.register_craft({
		type = "shapeless",
		output = "vlf_wool:"..color,
		recipe = { "group:wool", "vlf_dyes:"..color }
	})

	minetest.register_craft({
		output = "vlf_wool:"..color.."_carpet 3",
		recipe = {{"vlf_wool:"..color, "vlf_wool:"..color}},
	})
end

minetest.register_craft({
	output = "vlf_wool:white",
	recipe = {
