...
local function grow(pos, node)
	...
	if ba_node.name ~= "vlf_amethyst:budding_amethyst_block" then return end
...
minetest.register_abm({
	...
	neighbors = {"vlf_amethyst:budding_amethyst_block"},
	interval = interval,
	chance = chance,
	action = grow,
})
...
minetest.register_abm({
	...
	nodenames = {"vlf_amethyst:budding_amethyst_block"},
	...
	action = function(pos)
		...
		local new_node = {name = "vlf_amethyst:small_amethyst_bud", param2 = param2}
