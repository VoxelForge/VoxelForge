...
local function grow(pos, node)
	...
	if ba_node.name ~= "voxelforge:budding_amethyst" then return end
...
minetest.register_abm({
	...
	neighbors = {"voxelforge:budding_amethyst"},
	interval = interval,
	chance = chance,
	action = grow,
})
...
minetest.register_abm({
	...
	nodenames = {"voxelforge:budding_amethyst"},
	...
	action = function(pos)
		...
		local new_node = {name = "voxelforge:small_amethyst_bud", param2 = param2}
