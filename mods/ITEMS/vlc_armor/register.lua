...
vlc_armor.register_set({
	...
	craft_material = "vlc_core:gold_ingot",
	cook_material = "vlc_core:gold_nugget",
	sound_equip = "vlc_armor_equip_iron",
	sound_unequip = "vlc_armor_unequip_iron",
	groups = {
		golden = 1,
	},
})
...
vlc_armor.register_set({
	...
	repair_material = "vlc_core:iron_ingot",
	cook_material = "vlc_core:iron_nugget",
	sound_equip = "vlc_armor_equip_iron",
	sound_unequip = "vlc_armor_unequip_iron",
})
...
vlc_armor.register_set({
	...
	craft_material = "vlc_core:iron_ingot",
	cook_material = "vlc_core:iron_nugget",
	sound_equip = "vlc_armor_equip_iron",
	sound_unequip = "vlc_armor_unequip_iron",
})
...
vlc_armor.register_set({
	...
	toughness = 2,
	craft_material = "vlc_core:diamond",
	sound_equip = "vlc_armor_equip_diamond",
	sound_unequip = "vlc_armor_unequip_diamond",
	_vlc_upgradable = true,
	_vlc_upgrade_item_material = "_netherite",
})
...
vlc_armor.register_set({
	...
	toughness = 2,
	craft_material = "vlc_nether:netherite_ingot",
	sound_equip = "vlc_armor_equip_diamond",
	sound_unequip = "vlc_armor_unequip_diamond",
})

vlc_armor.register_protection_enchantment({
...
--[[vlc_enchanting.enchantments.aqua_affinity = {
...
vlc_enchanting.enchantments.curse_of_binding = {
...
vlc_enchanting.enchantments.thorns = {
	name = S("Thorns"),
	max_level = 3,
...
minetest.register_tool("vlc_armor:elytra", {
	description = S("Elytra"),
	_doc_items_longdesc = vlc_armor.longdesc,
	_doc_items_usagehelp = vlc_armor.usage,
	inventory_image = "vlc_armor_inv_elytra.png",
	groups = {armor = 1, armor_torso = 1, non_combat_torso = 1, vlc_armor_uses = 10, elytra = 1, enchantability = 9},
	sounds = {
		_vlc_armor_equip = "vlc_armor_equip_leather",
		_vlc_armor_unequip = "vlc_armor_unequip_leather",
	},
	on_place = vlc_armor.equip_on_use,
	on_secondary_use = vlc_armor.equip_on_use,
	_vlc_armor_element = "torso",
	_vlc_armor_texture = "vlc_armor_elytra.png"
})
