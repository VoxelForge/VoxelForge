...
minetest.register_node("vlf_core:stone", {
	description = S("Stone"),
...
local function redstone_ore_activate(pos, node, puncher, pointed_thing)
	...
	minetest.swap_node(pos, {name=nodedef._vlf_ore_lit})
...
minetest.register_node("vlf_core:stonebrickcarved", {
	...
	_doc_items_longdesc = doc.sub.items.temp.build,
	tiles = {"vlf_core_stonebrick_carved.png"},
	groups = {pickaxey=1, stone=1, stonebrick=1, building_block=1, material_stone=1},
	sounds = vlf_sounds.node_sound_stone_defaults(),
	is_ground_content = false,
	_vlf_blast_resistance = 6,
	_vlf_hardness = 1.5,
	_vlf_stonecutter_recipes = { "vlf_core:stone", "vlf_core:stonebrick" },
})

minetest.register_node("vlf_core:stonebrickcracked", {
	description = S("Cracked Stone Bricks"),
	_doc_items_longdesc = doc.sub.items.temp.build,
	tiles = {"vlf_core_stonebrick_cracked.png"},
	groups = {pickaxey=1, stone=1, stonebrick=1, building_block=1, material_stone=1},
	sounds = vlf_sounds.node_sound_stone_defaults(),
	is_ground_content = false,
	_vlf_blast_resistance = 6,
...
minetest.register_node("vlf_core:stonebrickmossy", {
	description = S("Mossy Stone Bricks"),
	_doc_items_longdesc = doc.sub.items.temp.build,
	tiles = {"vlf_core_stonebrick_mossy.png"},
	groups = {pickaxey=1, stone=1, stonebrick=1, building_block=1, material_stone=1, stonecuttable = 1},
	sounds = vlf_sounds.node_sound_stone_defaults(),
	is_ground_content = false,
	_vlf_blast_resistance = 6,
...
minetest.register_node("vlf_core:stone_smooth", {
	description = S("Smooth Stone"),
	_doc_items_longdesc = doc.sub.items.temp.build,
	tiles = {"vlf_stairs_stone_slab_top.png"},
...
minetest.register_node("vlf_core:granite", {
	description = S("Granite"),
	_doc_items_longdesc = S("Granite is an igneous rock."),
	tiles = {"vlf_core_granite.png"},
	groups = {pickaxey=1, stone=1, building_block=1, material_stone=1, stonecuttable = 1, converts_to_moss = 1},
	sounds = vlf_sounds.node_sound_stone_defaults(),
	_vlf_blast_resistance = 6,
	_vlf_hardness = 1.5,
...
-- Grass Block
minetest.register_node("vlf_core:dirt_with_grass", {
	...
	_doc_items_hidden = false,
	paramtype2 = "color",
	tiles = {"vlf_core_grass_block_top.png", { name="default_dirt.png", color="white" }, { name="default_dirt.png^vlf_dirt_grass_shadow.png", color="white" }},
	overlay_tiles = {"vlf_core_grass_block_top.png", "blank.png", {name="vlf_core_grass_block_side_overlay.png", tileable_vertical=false}},
	palette = "vlf_core_palette_grass.png",
	palette_index = 0,
	color = "#8EB971",
	_on_shovel_place = vlf_core.make_dirtpath,
	groups = {
	...
	on_construct = function(pos)
		...
		if node.param2 == 0 then
			local new_node = vlf_core.get_grass_block_type(pos)
			if new_node.param2 ~= 0 or new_node.name ~= "vlf_core:dirt_with_grass" then
				minetest.set_node(pos, new_node)
			end
		end
		return vlf_core.on_snowable_construct(pos)
	end,
	_vlf_snowed = "vlf_core:dirt_with_grass_snow",
	_vlf_blast_resistance = 0.6,
	_vlf_hardness = 0.6,
	_vlf_silk_touch_drop = true,
	_on_bone_meal = vlf_core.bone_meal_grass,
})
vlf_core.register_snowed_node("vlf_core:dirt_with_grass_snow", "vlf_core:dirt_with_grass", nil, nil, true, S("Dirt with Snow"))

minetest.register_node("vlf_core:grass_path", {
	tiles = {"vlf_core_grass_path_top.png", "default_dirt.png", "vlf_core_grass_path_side.png"},
	...
	_vlf_blast_resistance = 0.65,
	_vlf_hardness = 0.6,
})

minetest.register_node("vlf_core:mycelium", {
	...
	tiles = {"vlf_core_mycelium_top.png", "default_dirt.png", {name="vlf_core_mycelium_side.png", tileable_vertical=false}},
	...
	on_construct = vlf_core.on_snowable_construct,
	_on_shovel_place = vlf_core.make_dirtpath,
	_vlf_snowed = "vlf_core:mycelium_snow",
	_vlf_blast_resistance = 0.6,
	_vlf_hardness = 0.6,
	_vlf_silk_touch_drop = true,
})
vlf_core.register_snowed_node("vlf_core:mycelium_snow", "vlf_core:mycelium", nil, nil, false, S("Mycelium with Snow"))

local PARTICLE_ABM_DISTANCE = 16

--if minetest.settings:get("vlf_node_particles") == "full" then
...
minetest.register_node("vlf_core:podzol", {
	...
	tiles = {"vlf_core_dirt_podzol_top.png", "default_dirt.png", {name="vlf_core_dirt_podzol_side.png", tileable_vertical=false}},
groups = {handy=1, shovely=3, dirt=2, soil=1, soil_sapling=2, soil_sugarcane=1, soil_bamboo = 1, soil_fungus=1, enderman_takable=1, building_block=1, supports_mushrooms=1, converts_to_moss=1},
	...
	on_construct = vlf_core.on_snowable_construct,
	_on_shovel_place = vlf_core.make_dirtpath,
	_vlf_snowed = "vlf_core:podzol_snow",
	_vlf_blast_resistance = 0.8,
	_vlf_hardness = 0.8,
	_vlf_silk_touch_drop = true,
})
vlf_core.register_snowed_node("vlf_core:podzol_snow", "vlf_core:podzol", nil, nil, false, S("Podzol with Snow"))

minetest.register_node("vlf_core:dirt", {
	description = S("Dirt"),
...
minetest.register_node("vlf_core:coarse_dirt", {
	...
	tiles = {"vlf_core_coarse_dirt.png"},
...
minetest.register_node("vlf_core:gravel", {
	...
	drop = {
		max_items = 1,
		items = {
			{items = {"vlf_core:flint"},rarity = 10},
			{items = {"vlf_core:gravel"}}
		}
	},
	sounds = vlf_sounds.node_sound_gravel_defaults(),
	_vlf_blast_resistance = 0.6,
	_vlf_hardness = 0.6,
	_vlf_silk_touch_drop = true,
	_vlf_fortune_drop = {
...
-- sandstone --
minetest.register_node("vlf_core:sand", {
	description = S("Sand"),
...
minetest.register_node("vlf_core:sandstone", {
	...
	tiles = {"vlf_core_sandstone_top.png", "vlf_core_sandstone_bottom.png", "vlf_core_sandstone_normal.png"},
...
minetest.register_node("vlf_core:sandstonesmooth", {
	...
	tiles = {"vlf_core_sandstone_top.png", "vlf_core_sandstone_bottom.png", "vlf_core_sandstone_smooth.png"},
	is_ground_content = false,
...
minetest.register_node("vlf_core:sandstonecarved", {
	description = S("Chiseled Sandstone"),
	_doc_items_longdesc = S("Chiseled sandstone is a decorative building block."),
	tiles = {"vlf_core_sandstone_top.png", "vlf_core_sandstone_bottom.png", "vlf_core_sandstone_carved.png"},
	is_ground_content = false,
	groups = {pickaxey=1, sandstone=1, normal_sandstone=1, building_block=1, material_stone=1},
	sounds = vlf_sounds.node_sound_stone_defaults(),
	_vlf_blast_resistance = 0.8,
...
minetest.register_node("vlf_core:sandstonesmooth2", {
	...
	tiles = {"vlf_core_sandstone_top.png"},
	is_ground_content = false,
	groups = {pickaxey=1, sandstone=1, normal_sandstone=1, building_block=1, material_stone=1},
	sounds = vlf_sounds.node_sound_stone_defaults(),
	_vlf_blast_resistance = 6,
...
minetest.register_node("vlf_core:redsandstone", {
	...
	tiles = {"vlf_core_red_sandstone_top.png", "vlf_core_red_sandstone_bottom.png", "vlf_core_red_sandstone_normal.png"},
...
minetest.register_node("vlf_core:redsandstonesmooth", {
	...
	tiles = {"vlf_core_red_sandstone_top.png", "vlf_core_red_sandstone_bottom.png", "vlf_core_red_sandstone_smooth.png"},
	is_ground_content = false,
...
minetest.register_node("vlf_core:redsandstonecarved", {
	description = S("Chiseled Red Sandstone"),
	_doc_items_longdesc = S("Chiseled red sandstone is a decorative building block."),
	tiles = {"vlf_core_red_sandstone_top.png", "vlf_core_red_sandstone_bottom.png", "vlf_core_red_sandstone_carved.png"},
	is_ground_content = false,
	groups = {pickaxey=1, sandstone=1, red_sandstone=1, building_block=1, material_stone=1},
	sounds = vlf_sounds.node_sound_stone_defaults(),
	_vlf_blast_resistance = 0.8,
...
minetest.register_node("vlf_core:clay", {
	description = S("Clay"),
...
minetest.register_node("vlf_core:bedrock", {
...
minetest.register_node("vlf_core:cobble", {
...
minetest.register_node("vlf_core:coalblock", {
...
minetest.register_node("vlf_core:goldblock", {
...
minetest.register_node("vlf_core:diamondblock", {
...
minetest.register_node("vlf_core:emeraldblock", {
	...
	tiles = {"vlf_core_emerald_block.png"},
	is_ground_content = false,
	groups = {pickaxey=4, building_block=1},
	sounds = vlf_sounds.node_sound_stone_defaults(),
	_vlf_blast_resistance = 6,
...
minetest.register_node("vlf_core:obsidian", {
...
minetest.register_node("vlf_core:crying_obsidian", {
	...
	tiles = {"default_obsidian.png^vlf_core_crying_obsidian.png"},
	is_ground_content = false,
	light_source = 10,
	sounds = vlf_sounds.node_sound_stone_defaults(),
	groups = {pickaxey=5, building_block=1, material_stone=1},
...
minetest.register_node("vlf_core:ice", {
	description = S("Ice"),
...
for i=0,3 do
	...
	function ice.increase_age(pos, ice_near, first_melt)
		...
		if age < 3 then
			minetest.swap_node(pos, { name = "vlf_core:frosted_ice_"..(age+1) })
		else
			if dim ~= "nether" then
	...
	minetest.register_node("vlf_core:frosted_ice_"..i, {
		description = S("Frosted Ice"),
		_doc_items_create_entry = use_doc,
		_doc_items_longdesc = longdesc,
		drawtype = ice_drawtype,
		tiles = {"vlf_core_frosted_ice_"..i..".png"},
		is_ground_content = false,
		paramtype = "light",
		use_texture_alpha = ice_texture_alpha,
	...
	if minetest.get_modpath("doc") and i > 0 then
		doc.add_entry_alias("nodes", "vlf_core:frosted_ice_0", "nodes", "vlf_core:frosted_ice_"..i)
	end
end
...
local function on_place(itemstack, placer, pointed_thing)
	...
	if g == 8 then
		...
		if minetest.get_node(p).name == "air" then
			minetest.set_node(p, {name="vlf_core:snow"})
	...
	elseif g > 0 then
		...
		fakestack:set_name("vlf_core:snow_"..(g+1))
		itemstack = minetest.item_place(fakestack, placer, pointed_thing)
		minetest.sound_play(vlf_sounds.node_sound_snow_defaults().place, {pos = pointed_thing.under}, true)
	...
	if minetest.get_item_group(bnode.name, "solid") == 1 then
		minetest.sound_play(vlf_sounds.node_sound_snow_defaults().place, {pos = below}, true)
...
for i=1,8 do
	...
	if i == 1 then
		...
		if minetest.get_modpath("doc") then
			doc.add_entry_alias("nodes", "vlf_core:snow", "nodes", id)
		end
		walkable = true
	end
	if i ~= 8 then
	...
	minetest.register_node(id, {
		...
		drop = "vlf_throwing:snowball "..(i+1),
		_vlf_blast_resistance = 0.1,
		_vlf_hardness = 0.1,
		_vlf_silk_touch_drop = {"vlf_core:snow " .. i},
	})
end

minetest.register_node("vlf_core:snowblock", {
	description = S("Snow"),
