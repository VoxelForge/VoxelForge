...
minetest.register_node("vlf_core:bone_block", {
	...
	tiles = {"vlf_core_bone_block_top.png", "vlf_core_bone_block_top.png", "vlf_core_bone_block_side.png"},
...
minetest.register_node("vlf_core:slimeblock", {
...
minetest.register_node("vlf_core:cobweb", {
	...
	visual_scale = 1.1,
	tiles = {"vlf_core_web.png"},
	inventory_image = "vlf_core_web.png",
	paramtype = "light",
	move_resistance = 14,
	walkable = false,
	...
	_vlf_blast_resistance = 4,
	_vlf_hardness = 4,
})


minetest.register_node("vlf_core:deadbush", {
...
minetest.register_node("vlf_core:realm_barrier", {
	description = S("Realm Barrier"),
	_doc_items_create_entry = false,
	drawtype = "airlike",
	paramtype = "light",
	inventory_image = "vlf_core_barrier.png^[colorize:#FF00FF:127^[transformFX",
	wield_image = "vlf_core_barrier.png^[colorize:#FF00FF:127^[transformFX",
	tiles = {"blank.png"},
...
local light_block_pattern = "^vlf_core:light_(%d+)$"


for i = 0, 14 do --minetest.LIGHT_MAX
	minetest.register_node("vlf_core:light_" .. i, {
		description = S("Light"),
		...
		buildable_to = true,
		node_placement_prediction = "",
		inventory_image = "vlf_core_light_" .. i .. ".png",
		wield_image = "vlf_core_light_" .. i .. ".png",
		sunlight_propagates = true,
		is_ground_content = false,
		...
		on_use = function(itemstack, user, pointed_thing)
			...
			itemstack:set_name("vlf_core:light_" .. ((i == 14) and 0 or i + 1))
			return itemstack
		end,
...
minetest.register_node("vlf_core:void", {
	...
	pointable = false,
	walkable = false,
	inventory_image = "vlf_core_void.png",
