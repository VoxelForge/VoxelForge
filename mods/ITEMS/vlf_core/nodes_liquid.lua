...
minetest.register_node("vlf_core:water_flowing", {
	...
	liquid_range = 7,
	waving = 3,
	post_entity_effect_color = {a=60, r=0x03, g=0x3C, b=0x5C},
...
minetest.register_node("vlf_core:lava_flowing", {
	...
	is_ground_content = false,
	sounds = vlf_sounds.node_sound_lava_defaults(),
	walkable = false,
	pointable = false,
	diggable = false,
	buildable_to = true,
	...
	drowning = 0,
	liquidtype = "flowing",
	liquid_alternative_flowing = "vlf_core:lava_flowing",
	liquid_alternative_source = "vlf_core:lava_source",
	liquid_viscosity = LAVA_VISC,
	liquid_renewable = false,
	liquid_range = 3,
	damage_per_second = 4*2,
	post_entity_effect_color = {a=245, r=208, g=73, b=10},
...
minetest.register_node("vlf_core:lava_source", {
...
local function emit_lava_particle(pos)
	...
	minetest.add_particle({
		...
		texture = "vlf_particles_lava.png",
		glow = LIGHT_LAVA,
	})
end
