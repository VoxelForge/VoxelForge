...
minetest.register_node("vlf_core:cactus", {
	description = S("Cactus"),
	_tt_help = S("Grows on sand").."\n"..minetest.colorize(vlf_colors.YELLOW, S("Contact damage: @1 per half second", 1)),
...
minetest.register_node("vlf_core:reeds", {
	...
	drawtype = "plantlike",
	paramtype2 = "color",
	tiles = {"vlf_core_papyrus.png"},
	palette = "vlf_core_palette_grass.png",
	palette_index = 0,
	inventory_image = "vlf_core_reeds.png",
	wield_image = "vlf_core_reeds.png",
	paramtype = "light",
	walkable = false,
	node_box = {
		type = "fixed",
	...
	on_construct = function(pos)
		...
		if node.param2 == 0 then
			node.param2 = vlf_core.get_grass_palette_index(pos)
			if node.param2 ~= 0 then
