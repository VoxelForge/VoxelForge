...
minetest.register_craftitem("vlf_core:stick", {
	description = S("Stick"),
...
minetest.register_craftitem("vlf_core:coal_lump", {
	description = S("Coal"),
...
minetest.register_craftitem("vlf_core:iron_nugget", {
	...
	inventory_image = "vlf_core_iron_nugget.png",
	groups = { craftitem=1 },
})

minetest.register_craftitem("vlf_core:gold_nugget", {
	...
	inventory_image = "vlf_core_gold_nugget.png",
	groups = { craftitem=1 },
})

minetest.register_craftitem("vlf_core:diamond", {
...
minetest.register_craftitem("vlf_core:clay_lump", {
...
minetest.register_craftitem("vlf_core:gold_ingot", {
...
minetest.register_craftitem("vlf_core:flint", {
	description = S("Flint"),
...
minetest.register_craftitem("vlf_core:sugar", {
	description = S("Sugar"),
	_doc_items_longdesc = S("Sugar comes from sugar canes and is used to make sweet foods."),
	inventory_image = "vlf_core_sugar.png",
	groups = { craftitem = 1, brewitem=1 },
})

minetest.register_craftitem("vlf_core:bowl",{
	description = S("Bowl"),
...
local function eat_gapple(itemstack, placer, pointed_thing)
	...
	if itemstack:get_name() == "vlf_core:apple_gold_enchanted" then
		...
		vlf_entity_effects.give_entity_effect("fire_resistance", placer, 1, 300)
		vlf_entity_effects.give_entity_effect_by_level("resistance", placer, 1, 300)
	end
	vlf_entity_effects.give_entity_effect_by_level("absorption", placer, absorption, 120)
	vlf_entity_effects.give_entity_effect_by_level("regeneration", placer, 2, regen_duration)
	return gapple_hunger_restore(itemstack, placer, pointed_thing)
end

minetest.register_craftitem("vlf_core:apple_gold", {
	-- TODO: Add special highlight color
	description = S("Golden Apple"),
	_doc_items_longdesc = S("Golden apples are precious food items which can be eaten."),
	wield_image = "vlf_core_apple_golden.png",
	inventory_image = "vlf_core_apple_golden.png",
	on_place = eat_gapple,
...
minetest.register_craftitem("vlf_core:apple_gold_enchanted", {
	description = S("Enchanted Golden Apple"),
	_doc_items_longdesc = S("Golden apples are precious food items which can be eaten."),
	wield_image = "vlf_core_apple_golden.png" .. vlf_enchanting.overlay,
	inventory_image = "vlf_core_apple_golden.png" .. vlf_enchanting.overlay,
	on_place = eat_gapple,
	on_secondary_use = eat_gapple,
	groups = { food = 2, eatable = 4, can_eat_when_full = 1 },
	_vlf_saturation = 9.6,
