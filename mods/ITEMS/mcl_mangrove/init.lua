...
mcl_trees.register_wood("mangrove",{
	...
	sapling=false,
	tree_schems = {
		{ file = modpath.."/schematics/mcl_mangrove_tree_1.mts", width = 10, height = 6 },
		{ file = modpath.."/schematics/mcl_mangrove_tree_2.mts", width = 7, height = 7 },
		{ file = modpath.."/schematics/mcl_mangrove_tree_3.mts", width = 10, height = 10 },
		{ file = modpath.."/schematics/mcl_mangrove_tree_4.mts", width = 10, height = 18 },
		{ file = modpath.."/schematics/mcl_mangrove_tree_5.mts", width = 10, height = 14 },
		{ file = modpath.."/schematics/mcl_mangrove_bee_nest.mts", width = 10, height = 14 },
	},
