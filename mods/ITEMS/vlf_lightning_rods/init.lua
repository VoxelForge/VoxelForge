local S = minetest.get_translator("vlf_lightning_rods")
...
local rod_def = {
	...
	tiles = { "vlf_lightning_rods_rod.png" },
	drawtype = "mesh",
	mesh = "vlf_lightning_rods_rod.obj",
...
minetest.register_node("vlf_lightning_rods:rod", rod_def)

local rod_def_a = table.copy(rod_def)

rod_def_a.tiles = { "vlf_lightning_rods_rod.png^[brighten" }
