...
vlc_jukebox = {}
vlc_jukebox.registered_records = {}
...
function vlc_jukebox.get_random_creeper_loot()
	local t = table.copy(vlc_jukebox.registered_records)
	table.shuffle(t)
...
function vlc_jukebox.register_record_definition(def)
	local itemstring = "vlc_jukebox:record_"..def.id
	vlc_jukebox.registered_records[itemstring] = def
	...
	minetest.register_craftitem(":"..itemstring, {
		description =
			C(vlc_colors.AQUA, S("Music Disc")) .. "\n" ..
			C(vlc_colors.GRAY, S("@1—@2", def.author, def.title)),
...
function vlc_jukebox.register_record(title, author, identifier, image, sound, nocreeper)
	if type(title) == "table" then
		return vlc_jukebox.register_record_definition(title)
	end
	return vlc_jukebox.register_record_definition({
		title = title,
		author = author,
		id = identifier,
		texture = image,
...
local function now_playing(player, name)
	...
	local text = S("Now playing: @1—@2", vlc_jukebox.registered_records[name].author, vlc_jukebox.registered_records[name].title)
...
minetest.register_craft({
	output = "vlc_jukebox:jukebox",
	recipe = {
		{"group:wood", "group:wood", "group:wood"},
		{"group:wood", "vlc_core:diamond", "group:wood"},
		{"group:wood", "group:wood", "group:wood"},
	}
})
...
local function play_record(pos, itemstack, player)
	...
	if vlc_jukebox.registered_records[name] then
		if active_tracks[ph] then
			minetest.sound_stop(active_tracks[ph])
			active_tracks[ph] = nil
		end
		active_tracks[ph] = minetest.sound_play(vlc_jukebox.registered_records[name].sound, {
			gain = 1,
			pos = pos,
...
-- Jukebox
minetest.register_node("vlc_jukebox:jukebox", {
	...
	tiles = {"vlc_jukebox_top.png", "vlc_jukebox_side.png", "vlc_jukebox_side.png"},
...
minetest.register_craft({
	type = "fuel",
	recipe = "vlc_jukebox:jukebox",
	burntime = 15,
})

vlc_jukebox.register_record({
	title = "The Evil Sister (Jordach's Mix)",
	author = "SoundHelix",
	id = "13",
	texture = "vlc_jukebox_record_13.png",
	sound = "vlc_jukebox_track_1",
...
vlc_jukebox.register_record({
	...
	author = "SoundHelix",
	id = "wait",
	texture = "vlc_jukebox_record_wait.png",
	sound = "vlc_jukebox_track_2"
})
vlc_jukebox.register_record({
	title = "Eastern Feeling",
	author = "Jordach",
	id = "blocks",
	texture = "vlc_jukebox_record_blocks.png",
	sound = "vlc_jukebox_track_3"
})
vlc_jukebox.register_record({
	title = "Minetest",
	author = "Jordach",
	id = "far",
	texture = "vlc_jukebox_record_far.png",
	sound = "vlc_jukebox_track_4",
})
vlc_jukebox.register_record({
	title =  "Soaring over the sea",
	author =  "mactonite",
	id = "chirp",
	texture = "vlc_jukebox_record_chirp.png",
	sound = "vlc_jukebox_track_5",
...
vlc_jukebox.register_record({
	...
	author = "Tom Peter",
	id = "strad",
	texture = "vlc_jukebox_record_strad.png",
	sound = "vlc_jukebox_track_6",
...
vlc_jukebox.register_record({
	...
	id = "mellohi",
	texture = "vlc_jukebox_record_mellohi.png",
	sound = "vlc_jukebox_track_7"
})
vlc_jukebox.register_record({
	title = "The Clueless Frog (Jordach's Mix)",
	author = "SoundHelix",
	id = "mall",
	texture = "vlc_jukebox_record_mall.png",
	sound = "vlc_jukebox_track_8",
	exclude_from_creeperdrop = true,
})

--add backward compatibility
minetest.register_alias("vlc_jukebox:record_1", "vlc_jukebox:record_13")
minetest.register_alias("vlc_jukebox:record_2", "vlc_jukebox:record_wait")
minetest.register_alias("vlc_jukebox:record_3", "vlc_jukebox:record_blocks")
minetest.register_alias("vlc_jukebox:record_4", "vlc_jukebox:record_far")
minetest.register_alias("vlc_jukebox:record_5", "vlc_jukebox:record_chirp")
minetest.register_alias("vlc_jukebox:record_6", "vlc_jukebox:record_strad")
minetest.register_alias("vlc_jukebox:record_7", "vlc_jukebox:record_mellohi")
minetest.register_alias("vlc_jukebox:record_8", "vlc_jukebox:record_mall")
