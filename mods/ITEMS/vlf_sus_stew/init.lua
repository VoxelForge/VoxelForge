...
vlf_sus_stew.register_stew("fire_resistance","vlf_flowers:allium",potion_effect)
--vlf_sus_stew.register_stew("blindness","vlf_flowers:azure_bluet",potion_effect) -- effect not implemented
vlf_sus_stew.register_stew("hunger","vlf_flowers:blue_orchid",hunger_effect)
vlf_sus_stew.register_stew("leaping","vlf_flowers:cornflower",potion_effect)
vlf_sus_stew.register_stew("hunger","vlf_flowers:dandelion",hunger_effect)
vlf_sus_stew.register_stew("poison","vlf_flowers:lily_of_the_valley",potion_effect)
vlf_sus_stew.register_stew("regeneration","vlf_flowers:oxeye_daisy",potion_effect)
vlf_sus_stew.register_stew("night_vision","vlf_flowers:poppy",potion_effect)
--vlf_sus_stew.register_stew("weakness","vlf_flowers:tulip_orange",potion_effect) -- effect not implemented
--vlf_sus_stew.register_stew("weakness","vlf_flowers:tulip_pink",potion_effect) -- effect not implemented
--vlf_sus_stew.register_stew("weakness","vlf_flowers:tulip_red",potion_effect) -- effect not implemented
--vlf_sus_stew.register_stew("weakness","vlf_flowers:tulip_white",potion_effect) -- effect not implemented
vlf_sus_stew.register_stew("harming","vlf_flowers:wither_rose",potion_effect) -- in place of real wither effect
