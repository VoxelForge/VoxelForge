...
local source = table.copy(minetest.registered_nodes["vlc_core:water_source"])
source.description = S("River Water Source")
source.liquid_range = 2
source.waving = 3
source.liquid_alternative_flowing = "vlcx_core:river_water_flowing"
source.liquid_alternative_source = "vlcx_core:river_water_source"
...
local flowing = table.copy(minetest.registered_nodes["vlc_core:water_flowing"])
flowing.description = S("Flowing River Water")
flowing.liquid_range = 2
flowing.waving = 3
flowing.liquid_alternative_flowing = "vlcx_core:river_water_flowing"
flowing.liquid_alternative_source = "vlcx_core:river_water_source"
...
minetest.register_node("vlcx_core:river_water_source", source)
minetest.register_node("vlcx_core:river_water_flowing", flowing)

if minetest.get_modpath("doc") then
	doc.add_entry_alias("nodes", "vlcx_core:river_water_source", "nodes", "vlcx_core:river_water_flowing")
end
