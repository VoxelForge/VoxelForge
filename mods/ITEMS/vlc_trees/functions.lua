...
function vlc_trees.strip_tree(itemstack, placer, pointed_thing)
...
function vlc_trees.rotate_climbable(pos, node, user, mode)
...
function vlc_trees.check_2by2_saps(pos, node)
	local n = node.name
