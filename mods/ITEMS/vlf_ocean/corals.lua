...
for c=1, #corals do
	...
	-- Coral
	minetest.register_node("vlf_ocean:"..id.."_coral", {
		...
		place_param2 = 1,
		tiles = { "vlf_ocean_"..id.."_coral_block.png" },
		special_tiles = { { name = "vlf_ocean_"..id.."_coral.png" } },
		inventory_image = "vlf_ocean_"..id.."_coral.png",
		selection_box = {
			type = "fixed",
			fixed = {
		...
		drop = "vlf_ocean:dead_"..id.."_coral",
		node_placement_prediction = "",
		node_dig_prediction = "vlf_ocean:"..id.."_coral_block",
		on_place = coral_on_place,
		after_dig_node = function(pos)
			local node = minetest.get_node(pos)
			if minetest.get_item_group(node.name, "coral") == 0 then
				minetest.set_node(pos, {name="vlf_ocean:"..id.."_coral_block"})
			end
		end,
		_vlf_hardness = 0,
	...
	minetest.register_node("vlf_ocean:dead_"..id.."_coral", {
		...
		place_param2 = 1,
		tiles = { "vlf_ocean_dead_"..id.."_coral_block.png" },
		special_tiles = { { name = "vlf_ocean_dead_"..id.."_coral.png" } },
		inventory_image = "vlf_ocean_dead_"..id.."_coral.png",
		...
		sounds = sounds_coral_plant,
		node_placement_prediction = "",
		node_dig_prediction = "vlf_ocean:dead_"..id.."_coral_block",
		on_place = coral_on_place,
		after_dig_node = function(pos)
			local node = minetest.get_node(pos)
			if minetest.get_item_group(node.name, "coral") == 0 then
				minetest.set_node(pos, {name="vlf_ocean:dead_"..id.."_coral_block"})
			end
		end,
		_vlf_hardness = 0,
		_vlf_blast_resistance = 0,
	...
	-- Coral Fan
	minetest.register_node("vlf_ocean:"..id.."_coral_fan", {
		...
		place_param2 = 4,
		tiles = { "vlf_ocean_"..id.."_coral_block.png" },
		special_tiles = { { name = "vlf_ocean_"..id.."_coral_fan.png" } },
		inventory_image = "vlf_ocean_"..id.."_coral_fan.png",
		...
		sounds = sounds_coral_plant,
		drop = "vlf_ocean:dead_"..id.."_coral_fan",
		node_placement_prediction = "",
		node_dig_prediction = "vlf_ocean:"..id.."_coral_block",
		on_place = coral_on_place,
		after_dig_node = function(pos)
	...
	minetest.register_node("vlf_ocean:dead_"..id.."_coral_fan", {
		...
		place_param2 = 4,
		tiles = { "vlf_ocean_dead_"..id.."_coral_block.png" },
		special_tiles = { { name = "vlf_ocean_dead_"..id.."_coral_fan.png" } },
		inventory_image = "vlf_ocean_dead_"..id.."_coral_fan.png",
	...
	if mod_doc then
		doc.add_entry_alias("nodes", "vlf_ocean:"..id.."_coral", "nodes", "vlf_ocean:"..id.."_coral")
		doc.add_entry_alias("nodes", "vlf_ocean:"..id.."_coral_fan", "nodes", "vlf_ocean:"..id.."_coral_fan")
		doc.add_entry_alias("nodes", "vlf_ocean:"..id.."_coral_block", "nodes", "vlf_ocean:"..id.."_coral_block")
		doc.add_entry_alias("nodes", "vlf_ocean:"..id.."_coral", "nodes", "vlf_ocean:dead_"..id.."_coral")
		doc.add_entry_alias("nodes", "vlf_ocean:"..id.."_coral_fan", "nodes", "vlf_ocean:dead_"..id.."_coral_fan")
		doc.add_entry_alias("nodes", "vlf_ocean:"..id.."_coral_block", "nodes", "vlf_ocean:dead_"..id.."_coral_block")
	end
end
...
minetest.register_abm({
	...
	action = function(pos, node, active_object_count, active_object_count_wider)
		...
		if coral_state == 1 then
			...
			if minetest.get_node({x=pos.x, y=pos.y+1, z=pos.z}).name ~= "vlf_core:water_source" then
	...
	action = function(pos, node, active_object_count, active_object_count_wider)
		...
		if coral_state == 1 then
			...
			for p=1, #posses do
				...
				if checknode.name == "vlf_core:water_source" then
