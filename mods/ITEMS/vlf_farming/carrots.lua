...
local function on_bone_meal(itemstack,placer,pointed_thing,pos,node)
	return vlf_farming.on_bone_meal(itemstack,placer,pointed_thing,pos,node,"plant_carrot")
end
...
for i=1, 7 do
	...
	minetest.register_node("vlf_farming:carrot_"..i, {
...
minetest.register_node("vlf_farming:carrot", {
	...
	drop = {
		max_items = 1,
		items = {
			{ items = {"vlf_farming:carrot_item 4"}, rarity = 5 },
			{ items = {"vlf_farming:carrot_item 3"}, rarity = 2 },
			{ items = {"vlf_farming:carrot_item 2"}, rarity = 2 },
			{ items = {"vlf_farming:carrot_item 1"} },
		}
	},
	selection_box = {
		type = "fixed",
...
minetest.register_craftitem("vlf_farming:carrot_item_gold", {
	...
	_vlf_saturation = 14.4,
})

minetest.register_craft({
	output = "vlf_farming:carrot_item_gold",
	recipe = {
		{"vlf_core:gold_nugget", "vlf_core:gold_nugget", "vlf_core:gold_nugget"},
		{"vlf_core:gold_nugget", "vlf_farming:carrot_item", "vlf_core:gold_nugget"},
		{"vlf_core:gold_nugget", "vlf_core:gold_nugget", "vlf_core:gold_nugget"},
	}
})

vlf_farming:add_plant("plant_carrot", "vlf_farming:carrot", {"vlf_farming:carrot_1", "vlf_farming:carrot_2", "vlf_farming:carrot_3", "vlf_farming:carrot_4", "vlf_farming:carrot_5", "vlf_farming:carrot_6", "vlf_farming:carrot_7"}, 25, 20)

if minetest.get_modpath("doc") then
	for i=2,7 do
		doc.add_entry_alias("nodes", "vlf_farming:carrot_1", "nodes", "vlf_farming:carrot_"..i)
	end
end
