...
local planton = {"vlf_core:dirt_with_grass", "vlf_core:dirt", "vlf_core:podzol", "vlf_core:coarse_dirt", "vlf_farming:soil", "vlf_farming:soil_wet", "vlf_lush_caves:moss"}

for i=0, 3 do
	local texture = "vlf_farming_sweet_berry_bush_" .. i .. ".png"
	local node_name = "vlf_farming:sweet_berry_bush_" .. i
	...
	minetest.register_alias("vlf_sweet_berry:sweet_berry_bush_" .. i, node_name)
end

minetest.register_craftitem("vlf_farming:sweet_berry", {
	description = S("Sweet Berry"),
	inventory_image = "vlf_farming_sweet_berry.png",
	_vlf_saturation = 0.4,
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		if pointed_thing.type == "node" and
			...
			minetest.set_node(pointed_thing.above, {name="vlf_farming:sweet_berry_bush_0"})
...
minetest.register_alias("vlf_sweet_berry:sweet_berry", "vlf_farming:sweet_berry")
...
vlf_farming:add_plant("plant_sweet_berry_bush", "vlf_farming:sweet_berry_bush_3", {"vlf_farming:sweet_berry_bush_0", "vlf_farming:sweet_berry_bush_1", "vlf_farming:sweet_berry_bush_2"}, 68, 3)
...
local function berry_damage_check(obj)
	...
	vlf_util.deal_damage(obj, 0.5, {type = "sweet_berry"})
end
