...
local function add_scope(player)
	...
	if wielditem:get_name() == "vlc_spyglass:spyglass" then
		spyglass_scope[player] = player:hud_add({
			[hud_elem_type_field] = "image",
			position = {x = 0.5, y = 0.5},
			scale = {x = -100, y = -100},
			text = "vlc_spyglass_scope.png",
		})
