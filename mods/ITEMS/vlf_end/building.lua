...
minetest.register_node("vlf_end:end_stone", {
	description = S("End Stone"),
	_doc_items_longdesc = doc.sub.items.temp.build,
	tiles = {"vlf_end_end_stone.png"},
...
minetest.register_node("vlf_end:end_bricks", {
	description = S("End Stone Bricks"),
	_doc_items_longdesc = doc.sub.items.temp.build,
	tiles = {"vlf_end_end_bricks.png"},
	is_ground_content = false,
	groups = {pickaxey=1, building_block=1, material_stone=1, stonecuttable = 1},
	sounds = vlf_sounds.node_sound_stone_defaults(),
	_vlf_blast_resistance = 9,
	_vlf_hardness = 3,
	_vlf_stonecutter_recipes = {"vlf_end:end_stone"},
})

minetest.register_node("vlf_end:purpur_block", {
	description = S("Purpur Block"),
	_doc_items_longdesc = doc.sub.items.temp.build,
	tiles = {"vlf_end_purpur_block.png"},
	is_ground_content = false,
...
minetest.register_node("vlf_end:purpur_pillar", {
	description = S("Purpur Pillar"),
	_doc_items_longdesc = doc.sub.items.temp.build,
	paramtype2 = "facedir",
	is_ground_content = false,
	on_place = vlf_util.rotate_axis,
	tiles = {"vlf_end_purpur_pillar_top.png", "vlf_end_purpur_pillar_top.png", "vlf_end_purpur_pillar.png"},
...
minetest.register_node("vlf_end:end_rod", {
	description = S("End Rod"),
	_doc_items_longdesc = S("End rods are decorative light sources."),
	tiles = {
		"vlf_end_end_rod_top.png",
		"vlf_end_end_rod_bottom.png",
		"vlf_end_end_rod_side.png",
		"vlf_end_end_rod_side.png",
		"vlf_end_end_rod_side.png",
		"vlf_end_end_rod_side.png",
	},
...
vlf_stairs.register_stair_and_slab("end_bricks", {
	baseitem = "vlf_end:end_bricks",
	description_stair = S("End Stone Brick Stairs"),
	description_slab = S("End Stone Brick Slab"),
	overrides = {_vlf_stonecutter_recipes = {"vlf_end:end_bricks","vlf_end:end_stone"}},{_vlf_stonecutter_recipes = {"vlf_end:end_bricks","vlf_end:end_stone"}}
})

vlf_stairs.register_stair_and_slab("purpur_block", {
	baseitem = "vlf_end:purpur_block",
	description_stair = S("Purpur Stairs"),
	description_slab = S("Purpur Slab"),
	recipeitem = "group:purpur_block",
	overrides = {_vlf_stonecutter_recipes = {"vlf_end:purpur_block"}}
})

-- Crafting recipes
minetest.register_craft({
	output = "vlf_end:end_bricks 4",
	recipe = {
		{"vlf_end:end_stone", "vlf_end:end_stone"},
		{"vlf_end:end_stone", "vlf_end:end_stone"},
	}
})

minetest.register_craft({
	output = "vlf_end:purpur_block 4",
	recipe = {
		{"vlf_end:chorus_fruit_popped", "vlf_end:chorus_fruit_popped",},
		{"vlf_end:chorus_fruit_popped", "vlf_end:chorus_fruit_popped",},
	}
})

minetest.register_craft({
	output = "vlf_end:end_rod 4",
	recipe = {
		{"vlf_mobitems:blaze_rod"},
		{"vlf_end:chorus_fruit_popped"},
	},
})
