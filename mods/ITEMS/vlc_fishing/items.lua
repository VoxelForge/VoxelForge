...
minetest.register_craftitem("vlc_fishing:fish_raw", {
	...
	inventory_image = "vlc_fishing_fish_raw.png",
...
minetest.register_craftitem("vlc_fishing:fish_cooked", {
	description = S("Cooked Fish"),
	_doc_items_longdesc = S("Mmh, fish! This is a healthy food item."),
	inventory_image = "vlc_fishing_fish_cooked.png",
...
minetest.register_craftitem("vlc_fishing:salmon_raw", {
	...
	inventory_image = "vlc_fishing_salmon_raw.png",
	on_place = minetest.item_eat(2),
	on_secondary_use = minetest.item_eat(2),
	groups = { food=2, eatable = 2, smoker_cookable = 1, campfire_cookable = 1 },
	_vlc_saturation = 0.4,
...
minetest.register_craftitem("vlc_fishing:salmon_cooked", {
	description = S("Cooked Salmon"),
	_doc_items_longdesc = S("This is a healthy food item which can be eaten."),
	inventory_image = "vlc_fishing_salmon_cooked.png",
...
minetest.register_craftitem("vlc_fishing:clownfish_raw", {
	...
	inventory_image = "vlc_fishing_clownfish_raw.png",
...
local function eat_pufferfish(itemstack, placer, pointed_thing)
	vlc_potions.poison_func(placer, 1/3, 60)
	return minetest.item_eat(1)(itemstack, placer, pointed_thing)
end
minetest.register_craftitem("vlc_fishing:pufferfish_raw", {
	description = S("Pufferfish"),
	_tt_help = minetest.colorize(vlc_colors.YELLOW, S("Very poisonous")),
	...
	inventory_image = "vlc_fishing_pufferfish_raw.png",
...
minetest.register_craft({
	type = "cooking",
	output = "vlc_fishing:salmon_cooked",
	recipe = "vlc_fishing:salmon_raw",
	cooktime = 10,
})

minetest.register_craft({
	type = "cooking",
	output = "vlc_fishing:fish_cooked",
	recipe = "vlc_fishing:fish_raw",
	cooktime = 10,
})

minetest.register_craft({
	output = "vlc_fishing:fishing_rod",
	recipe = {
		{"","","vlc_core:stick"},
