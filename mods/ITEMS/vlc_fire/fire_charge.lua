...
-- Fire Charge
minetest.register_craftitem("vlc_fire:fire_charge", {
	...
	inventory_image = "vlc_fire_fire_charge.png",
...
minetest.register_craft({
	type = "shapeless",
	output = "vlc_fire:fire_charge 3",
	recipe = { "vlc_mobitems:blaze_powder", "group:coal", "vlc_mobitems:gunpowder" },
})
