local loot_table = {
		{
			items = {
				...
				{ itemstring = "vlf_trials:ominous_bottle_1", weight = 69, amount_min = 1, amount_max = 2 },
				{ itemstring = "vlf_shields:shield", weight = 300, amount_min = 1, amount_max = 1 },
				{ itemstring = "vlf_bows:bow", weight = 300 },
				...
				{ itemstring = "vlf_farming:carrot_item_gold", weight = 200, amount_min = 1, amount_max = 2 },
				{ itemstring = "vlf_books:book", weight = 1 },
				{ itemstring = "vlf_books:book", weight = 1 },
				{ itemstring = "vlf_bows:crossbow", weight = 200 },
				{ itemstring = "vlf_tools:axe_iron", weight = 200 },
				{ itemstring = "vlf_armor:chestplate_iron", weight = 200 },
				{ itemstring = "vlf_tools:axe_diamond", weight = 100 },
				{ itemstring = "vlf_armor:chestplate_diamond", weight = 100 },
				...
				{ itemstring = "TODO:vlf_armor:bolt", weight = 3 },
...
local function create_display_item(pos, def)
	return minetest.add_entity(pos, "vlf_trials:item_entity", minetest.serialize({loot = loot_table, name = def.name, pos = pos}))
end
