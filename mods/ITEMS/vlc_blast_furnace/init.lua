...
vlc_furnaces.register_furnace("vlc_blast_furnace:blast_furnace", {
	...
	node_active = {
		...
		drop = "vlc_blast_furnace:blast_furnace",
	},
})

minetest.register_craft({
	output = "vlc_blast_furnace:blast_furnace",
	recipe = {
		{ "vlc_core:iron_ingot",   "vlc_core:iron_ingot",   "vlc_core:iron_ingot" },
		{ "vlc_core:iron_ingot",   "vlc_furnaces:furnace",  "vlc_core:iron_ingot" },
		{ "vlc_core:stone_smooth", "vlc_core:stone_smooth", "vlc_core:stone_smooth" },
	}
})

-- Add entry alias for the Help
if minetest.get_modpath("doc") then
	doc.add_entry_alias("nodes", "vlc_blast_furnace:blast_furnace", "nodes", "vlc_blast_furnace:blast_furnace_active")
end
