...
mcl_core.add_stained_glass( S("Gray Stained Glass"), "mcl_dye:dark_grey", "unicolor_darkgrey", "gray")
mcl_core.add_stained_glass( S("Lime Stained Glass"), "mcl_dye:green", "basecolor_green", "lime")
mcl_core.add_stained_glass( S("Light Gray Stained Glass"), "mcl_dye:grey", "basecolor_grey", "silver")
