...
mcl_trees.register_wood("jungle",{
	...
	tree_schems = {
		...
		{ file = modpath.."/schematics/mcl_core_jungle_tree_2.mts", width = 6, height = 15 },
		{ file = modpath.."/schematics/mcl_core_jungle_tree_3.mts", width = 6, height = 15 },
		{ file = modpath.."/schematics/mcl_core_jungle_tree_4.mts", width = 6, height = 15 },
...
mcl_trees.register_wood("acacia",{
	...
	tree_schems ={
		...
		{ file = modpath.."/schematics/mcl_core_acacia_weirdo.mts", width = 6, height = 8 },
	},
