...
minetest.register_node("mcl_core:dirt_with_grass", {
	...
	groups = {
		...
		compostability = 30,biomecolor = 1,
	},
	drop = "mcl_core:dirt",
...
minetest.register_node("mcl_core:dirt", {
	...
	is_ground_content = true,
	stack_max = 64,
	groups = {handy=1,shovely=1, dirt=1,soil=1, soil_sapling=2, soil_sugarcane=1, soil_bamboo = 1, cultivatable=2, enderman_takable=1, building_block=1},
	sounds = mcl_sounds.node_sound_dirt_defaults(),
	_on_shovel_place = mcl_core.make_dirtpath,
...
minetest.register_node("mcl_core:coarse_dirt", {
	...
	is_ground_content = true,
	stack_max = 64,
	groups = { handy = 1,shovely = 1, dirt = 3, soil = 1, soil_sugarcane = 1, soil_bamboo = 1, cultivatable = 1, enderman_takable = 1, building_block = 1, soil_sapling = 2},
	sounds = mcl_sounds.node_sound_dirt_defaults(),
	_on_shovel_place = mcl_core.make_dirtpath,
	_mcl_blast_resistance = 0.5,
	_mcl_hardness = 0.5,
