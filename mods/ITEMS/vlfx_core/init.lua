...
local source = table.copy(minetest.registered_nodes["vlf_core:water_source"])
source.description = S("River Water Source")
source.liquid_range = 2
source.waving = 3
source.liquid_alternative_flowing = "vlfx_core:river_water_flowing"
source.liquid_alternative_source = "vlfx_core:river_water_source"
...
source.post_entity_effect_color = {a=192, r=0x2c, g=0x88, b=0x8c}
source.tiles = {
...
local flowing = table.copy(minetest.registered_nodes["vlf_core:water_flowing"])
flowing.description = S("Flowing River Water")
flowing.liquid_range = 2
flowing.waving = 3
flowing.liquid_alternative_flowing = "vlfx_core:river_water_flowing"
flowing.liquid_alternative_source = "vlfx_core:river_water_source"
flowing.liquid_renewable = false
flowing.tiles = {"default_river_water_flowing_animated.png^[verticalframe:64:0"}
flowing.post_entity_effect_color = {a=192, r=0x2c, g=0x88, b=0x8c}
...
minetest.register_node("vlfx_core:river_water_source", source)
minetest.register_node("vlfx_core:river_water_flowing", flowing)

if minetest.get_modpath("doc") then
	doc.add_entry_alias("nodes", "vlfx_core:river_water_source", "nodes", "vlfx_core:river_water_flowing")
end
