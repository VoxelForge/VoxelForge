...
local water_s = minetest.registered_nodes["vlf_core:water_source"]
local water_f = minetest.registered_nodes["vlf_core:water_flowing"]
minetest.register_node("vlfx_core:river_water_source", table.merge(water_s, {
	description = S("River Water Source"),
	groups = table.merge(water_s.groups, {river_water = water_s.groups.water}),
	liquid_range = 2,
	waving = 3,
	liquid_alternative_flowing = "vlfx_core:river_water_flowing",
	liquid_alternative_source = "vlfx_core:river_water_source",
...
minetest.register_node("vlfx_core:river_water_flowing", table.merge(water_f, {
