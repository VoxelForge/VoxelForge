...
minetest.register_node("mcl_mud:mud", {
	...
	groups = {handy=1, shovely=1, enderman_takable=1, grass_block=1, soil_sugarcane=1, soil_bamboo=1, soil_nether_fungus=1, building_block=1, soil_propagule=1, converts_to_moss=1},
