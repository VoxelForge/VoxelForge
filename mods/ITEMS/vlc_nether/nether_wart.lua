...
minetest.register_node("vlc_nether:nether_wart_0", {
	...
	walkable = false,
	drawtype = "plantlike",
	drop = "vlc_nether:nether_wart_item",
	tiles = {"vlc_nether_nether_wart_stage_0.png"},
	wield_image = "vlc_nether_nether_wart_stage_0.png",
	inventory_image = "vlc_nether_nether_wart_stage_0.png",
	selection_box = {
		type = "fixed",
		fixed = {
...
minetest.register_node("vlc_nether:nether_wart_1", {
	...
	drawtype = "plantlike",
	drop = "vlc_nether:nether_wart_item",
	tiles = {"vlc_nether_nether_wart_stage_1.png"},
	wield_image = "vlc_nether_nether_wart_stage_1.png",
	inventory_image = "vlc_nether_nether_wart_stage_1.png",
	selection_box = {
		type = "fixed",
		fixed = {
...
minetest.register_node("vlc_nether:nether_wart_2", {
...
minetest.register_node("vlc_nether:nether_wart", {
	...
	drop = {
		max_items = 2,
		items = {
			{ items = {"vlc_nether:nether_wart_item 2"}, rarity = 1 },
			{ items = {"vlc_nether:nether_wart_item 2"}, rarity = 3 },
			{ items = {"vlc_nether:nether_wart_item 1"}, rarity = 3 },
		},
	},
	tiles = {"vlc_nether_nether_wart_stage_2.png"},
	wield_image = "vlc_nether_nether_wart_stage_2.png",
	inventory_image = "vlc_nether_nether_wart_stage_2.png",
	selection_box = {
		type = "fixed",
		fixed = {
	...
	_vlc_fortune_drop = {
		...
		items = {"vlc_nether:nether_wart_item"},
		min_count = 2,
		max_count = 4,
	}
})

minetest.register_craftitem("vlc_nether:nether_wart_item", {
	...
	inventory_image = "vlc_nether_nether_wart.png",
	wield_image = "vlc_nether_nether_wart.png",
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		if chk and chk ~= 0 then
			...
			if minetest.registered_items[minetest.get_node(placepos).name].buildable_to then
				...
				minetest.set_node(placepos, {name="vlc_nether:nether_wart_0", param2 = 3})
...
local names = {"vlc_nether:nether_wart_0", "vlc_nether:nether_wart_1", "vlc_nether:nether_wart_2"}

minetest.register_abm({
	label = "Nether wart growth",
	nodenames = {"vlc_nether:nether_wart_0", "vlc_nether:nether_wart_1", "vlc_nether:nether_wart_2"},
	...
	action = function(pos, node)
		...
		if new_node.name == nil then
			new_node.name = "vlc_nether:nether_wart"
		end
...
if minetest.get_modpath("doc") then
	for i=1,2 do
		doc.add_entry_alias("nodes", "vlc_nether:nether_wart_0", "nodes", "vlc_nether:nether_wart_"..i)
	end
end
