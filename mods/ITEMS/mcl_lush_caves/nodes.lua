...
minetest.register_node("mcl_lush_caves:moss", {
	...
	groups = { handy=1, hoey=2, dirt=1, soil=1, soil_bamboo=1, soil_sapling=2, soil_sugarcane=1, soil_nether_fungus=1, enderman_takable=1, building_block=1, flammable=1, fire_encouragement=60, fire_flammability=20, grass_block_no_snow=1 },
...
minetest.register_node("mcl_lush_caves:rooted_dirt", {
	...
	groups = {handy=1, shovely=1, dirt=1, soil_nether_fungus=1, building_block=1, path_creation_possible=1, converts_to_moss=1},
	sounds = mcl_sounds.node_sound_dirt_defaults(),
