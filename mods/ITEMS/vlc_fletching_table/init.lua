...
minetest.register_node("vlc_fletching_table:fletching_table", {
...
minetest.register_craft({
	output = "vlc_fletching_table:fletching_table",
	recipe = {
		{ "vlc_core:flint", "vlc_core:flint", "" },
...
minetest.register_craft({
	type = "fuel",
	recipe = "vlc_fletching_table:fletching_table",
	burntime = 15,
})
