...
local S = minetest.get_translator("vlf_stonecutter")
...
minetest.register_on_mods_loaded(vlf_stonecutter.refresh_recipes)
...
minetest.register_node("vlf_stonecutter:stonecutter", {
		...
		if fields then
			for k, _ in pairs(fields) do
				if tostring(k) then
					...
					if def and def._vlf_stonecutter_recipes then
...
minetest.register_craft({
	output = "vlf_stonecutter:stonecutter",
	recipe = {
		{ "", "", "" },
		{ "", "vlf_core:iron_ingot", "" },
