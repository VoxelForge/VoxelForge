...
minetest.register_node("vlf_chests:ender_chest", {
	...
	tiles = vlf_chests.tiles.chest_ender_small,
...
minetest.register_node("vlf_chests:ender_chest_small", {
	...
	on_construct = function(pos)
		vlf_chests.create_entity(pos, "vlf_chests:ender_chest_small", vlf_chests.tiles.ender_chest_texture,
			minetest.get_node(pos).param2, false, "vlf_chests_enderchest", "vlf_chests_chest", "chest")
	end,
	on_rightclick = function(pos, node, clicker)
		...
		vlf_chests.player_chest_open(clicker, pos, "vlf_chests:ender_chest_small",
			vlf_chests.tiles.ender_chest_texture, node.param2, false, "vlf_chests_enderchest",
			"vlf_chests_chest")
	end,
...
minetest.register_allow_player_inventory_action(function(player, action, inv, info)
	if inv:get_location().type == "player" and (
		...
		if not minetest.find_node_near(player:get_pos(), range, "vlf_chests:ender_chest_small", true) then
			return 0
		end
	end
end)
