...
local tpl_cocoa = {
	...
	_vlf_hardness = 0.2,
	_vlf_baseitem = "vlf_cocoas:cocoa_beans",
...
for i=1,3 do
	local drop = "vlf_cocoas:cocoa_beans"
	if i == 3 then drop =  "vlf_cocoas:cocoa_beans 3" end
	minetest.register_node("vlf_cocoas:cocoa_"..i, table.merge(tpl_cocoa, {
		description = descs[i],
		_doc_items_create_entry = false,
		groups = table.merge(tpl_cocoa.groups, { cocoa = i }),
		mesh = "vlf_cocoas_cocoa_stage_"..(i - 1)..".obj",
		tiles = {"vlf_cocoas_cocoa_stage_"..(i - 1)..".png"},
		collision_box = {
			type = "fixed",
			fixed = { boxes[i] },
		},
