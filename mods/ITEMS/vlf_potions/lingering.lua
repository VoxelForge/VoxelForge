...
function vlf_potions.register_lingering(name, descr, color, def)
	...
	minetest.register_entity(id.."_flying",{
		...
		on_step = function(self, dtime)
			...
			if n ~= "air" and n ~= "vlf_portals:portal" and n ~= "vlf_portals:portal_end" and g == 0 or vlf_potions.is_obj_hit(self, pos) then
				...
				if name == "water" then
					vlf_potions._extinguish_nearby_fire(pos, d)
				end
				self.object:remove()
			end
		end,
