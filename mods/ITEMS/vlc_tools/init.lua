...
local wield_scale = vlc_vars.tool_wield_scale
...
local function on_tool_place(itemstack, placer, pointed_thing, tool)
	...
	if itemstack and type(ndef["_on_"..tool.."_place"]) == "function" then
		...
		-- _vlc_diggroups. This assumes the tool only has one diggroups
		-- (which is the case in Mineclone).
		local tdef = minetest.registered_tools[itemstack:get_name()]
		if tdef and tdef._vlc_diggroups then
			for group, _ in pairs(tdef._vlc_diggroups) do
				itemstack:add_wear(vlc_autogroup.get_wear(itemstack:get_name(), group))
				return itemstack
			end
		end
		return itemstack
	...
	vlc_offhand.place(placer, pointed_thing)

	return itemstack
end

vlc_tools.tool_place_funcs = {}

for _,tool in pairs({"shovel","shears","axe","sword","pick"}) do
	vlc_tools.tool_place_funcs[tool] = function(itemstack,placer,pointed_thing)
		return on_tool_place(itemstack,placer,pointed_thing,tool)
	end
end

-- Picks
minetest.register_tool("vlc_tools:pick_wood", {
	...
	on_place = vlc_tools.tool_place_funcs.pick,
...
minetest.register_tool("vlc_tools:pick_stone", {
...
minetest.register_tool("vlc_tools:pick_iron", {
	...
	sound = { breaks = "default_tool_breaks" },
	on_place = vlc_tools.tool_place_funcs.pick,
	_repair_material = "vlc_core:iron_ingot",
	_vlc_toollike_wield = true,
	_vlc_diggroups = {
		pickaxey = { speed = 6, level = 4, uses = 251 }
	},
})
minetest.register_tool("vlc_tools:pick_gold", {
	...
	sound = { breaks = "default_tool_breaks" },
	on_place = vlc_tools.tool_place_funcs.pick,
	_repair_material = "vlc_core:gold_ingot",
	_vlc_toollike_wield = true,
	_vlc_diggroups = {
		pickaxey = { speed = 12, level = 2, uses = 33 }
	},
})
minetest.register_tool("vlc_tools:pick_diamond", {
	...
	sound = { breaks = "default_tool_breaks" },
	on_place = vlc_tools.tool_place_funcs.pick,
	_repair_material = "vlc_core:diamond",
	_vlc_toollike_wield = true,
	_vlc_diggroups = {
		pickaxey = { speed = 8, level = 5, uses = 1562 }
	},
	_vlc_upgradable = true,
	_vlc_upgrade_item = "vlc_tools:pick_netherite"
})

minetest.register_tool("vlc_tools:pick_netherite", {
	...
	sound = { breaks = "default_tool_breaks" },
	on_place = vlc_tools.tool_place_funcs.pick,
	_repair_material = "vlc_nether:netherite_ingot",
	_vlc_toollike_wield = true,
	_vlc_diggroups = {
...
-- Shovels
minetest.register_tool("vlc_tools:shovel_wood", {
	...
	on_place = vlc_tools.tool_place_funcs.shovel,
	sound = { breaks = "default_tool_breaks" },
	_repair_material = "group:wood",
	_vlc_toollike_wield = true,
	_vlc_diggroups = {
...
minetest.register_tool("vlc_tools:shovel_stone", {
...
minetest.register_tool("vlc_tools:shovel_iron", {
...
minetest.register_tool("vlc_tools:shovel_gold", {
...
minetest.register_tool("vlc_tools:shovel_diamond", {
	...
	_vlc_upgradable = true,
	_vlc_upgrade_item = "vlc_tools:shovel_netherite"
})

minetest.register_tool("vlc_tools:shovel_netherite", {
...
local function make_stripped_trunk(itemstack, placer, pointed_thing)
    ...
    if noddef._vlc_stripped_variant == nil then
		return itemstack
	else
	if noddef.groups.door == 1 then
			...
			if node_name:find("_b_") then
				...
				minetest.swap_node(top_pos, {name=noddef._vlc_stripped_variant:gsub("_b_", "_t_"), param2=node.param2})
			elseif node_name:find("_t_") then
				local bot_pos = {x = pt_under.x, y = pt_under.y - 1, z = pt_under.z}
				minetest.swap_node(bot_pos, {name=noddef._vlc_stripped_variant:gsub("_t_", "_b_"), param2=node.param2})
			end
		end
		...
		if minetest.get_item_group(node_name, "waxed") ~= 0 then
			awards.unlock(placer:get_player_name(), "vlc:wax_off")
		end
...
minetest.register_tool("vlc_tools:axe_wood", {
...
minetest.register_tool("vlc_tools:axe_stone", {
...
minetest.register_tool("vlc_tools:axe_iron", {
...
minetest.register_tool("vlc_tools:axe_gold", {
...
minetest.register_tool("vlc_tools:axe_diamond", {
	...
	_vlc_upgradable = true,
	_vlc_upgrade_item = "vlc_tools:axe_netherite"
})

minetest.register_tool("vlc_tools:axe_netherite", {
...
-- Swords
minetest.register_tool("vlc_tools:sword_wood", {
	...
	sound = { breaks = "default_tool_breaks" },
	on_place = vlc_tools.tool_place_funcs.sword,
	_repair_material = "group:wood",
	_vlc_toollike_wield = true,
	_vlc_diggroups = {
...
minetest.register_tool("vlc_tools:sword_stone", {
...
minetest.register_tool("vlc_tools:sword_iron", {
...
minetest.register_tool("vlc_tools:sword_gold", {
...
minetest.register_tool("vlc_tools:sword_diamond", {
	...
	_vlc_upgradable = true,
	_vlc_upgrade_item = "vlc_tools:sword_netherite"
})
minetest.register_tool("vlc_tools:sword_netherite", {
...
--Shears
minetest.register_tool("vlc_tools:shears", {
	...
	on_place = vlc_tools.tool_place_funcs.shears,
	sound = { breaks = "default_tool_breaks" },
	_vlc_toollike_wield = true,
	_vlc_diggroups = {
