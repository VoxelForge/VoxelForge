...
local sounds_coral_plant = vlc_sounds.node_sound_leaves_defaults({footstep = vlc_sounds.node_sound_dirt_defaults().footstep})
...
for c=1, #corals do
	...
	-- Coral
	minetest.register_node("vlc_ocean:"..id.."_coral", {
		...
		place_param2 = 1,
		tiles = { "vlc_ocean_"..id.."_coral_block.png" },
		special_tiles = { { name = "vlc_ocean_"..id.."_coral.png" } },
		inventory_image = "vlc_ocean_"..id.."_coral.png",
		selection_box = {
			type = "fixed",
			fixed = {
		...
		drop = "vlc_ocean:dead_"..id.."_coral",
		node_placement_prediction = "",
		node_dig_prediction = "vlc_ocean:"..id.."_coral_block",
		on_place = coral_on_place,
		after_dig_node = function(pos)
			local node = minetest.get_node(pos)
			if minetest.get_item_group(node.name, "coral") == 0 then
				minetest.set_node(pos, {name="vlc_ocean:"..id.."_coral_block"})
			end
		end,
		_vlc_hardness = 0,
	...
	minetest.register_node("vlc_ocean:dead_"..id.."_coral", {
		...
		place_param2 = 1,
		tiles = { "vlc_ocean_dead_"..id.."_coral_block.png" },
		special_tiles = { { name = "vlc_ocean_dead_"..id.."_coral.png" } },
		inventory_image = "vlc_ocean_dead_"..id.."_coral.png",
		...
		sounds = sounds_coral_plant,
		node_placement_prediction = "",
		node_dig_prediction = "vlc_ocean:dead_"..id.."_coral_block",
		on_place = coral_on_place,
		after_dig_node = function(pos)
			local node = minetest.get_node(pos)
			if minetest.get_item_group(node.name, "coral") == 0 then
				minetest.set_node(pos, {name="vlc_ocean:dead_"..id.."_coral_block"})
			end
		end,
		_vlc_hardness = 0,
		_vlc_blast_resistance = 0,
	...
	-- Coral Fan
	minetest.register_node("vlc_ocean:"..id.."_coral_fan", {
		...
		place_param2 = 4,
		tiles = { "vlc_ocean_"..id.."_coral_block.png" },
		special_tiles = { { name = "vlc_ocean_"..id.."_coral_fan.png" } },
		inventory_image = "vlc_ocean_"..id.."_coral_fan.png",
		...
		sounds = sounds_coral_plant,
		drop = "vlc_ocean:dead_"..id.."_coral_fan",
		node_placement_prediction = "",
		node_dig_prediction = "vlc_ocean:"..id.."_coral_block",
		on_place = coral_on_place,
		after_dig_node = function(pos)
	...
	minetest.register_node("vlc_ocean:dead_"..id.."_coral_fan", {
		...
		place_param2 = 4,
		tiles = { "vlc_ocean_dead_"..id.."_coral_block.png" },
		special_tiles = { { name = "vlc_ocean_dead_"..id.."_coral_fan.png" } },
		inventory_image = "vlc_ocean_dead_"..id.."_coral_fan.png",
	...
	if mod_doc then
		doc.add_entry_alias("nodes", "vlc_ocean:"..id.."_coral", "nodes", "vlc_ocean:"..id.."_coral")
		doc.add_entry_alias("nodes", "vlc_ocean:"..id.."_coral_fan", "nodes", "vlc_ocean:"..id.."_coral_fan")
		doc.add_entry_alias("nodes", "vlc_ocean:"..id.."_coral_block", "nodes", "vlc_ocean:"..id.."_coral_block")
		doc.add_entry_alias("nodes", "vlc_ocean:"..id.."_coral", "nodes", "vlc_ocean:dead_"..id.."_coral")
		doc.add_entry_alias("nodes", "vlc_ocean:"..id.."_coral_fan", "nodes", "vlc_ocean:dead_"..id.."_coral_fan")
		doc.add_entry_alias("nodes", "vlc_ocean:"..id.."_coral_block", "nodes", "vlc_ocean:dead_"..id.."_coral_block")
	end
end
...
minetest.register_abm({
	...
	action = function(pos, node, active_object_count, active_object_count_wider)
		...
		if coral_state == 1 then
			...
			if minetest.get_node({x=pos.x, y=pos.y+1, z=pos.z}).name ~= "vlc_core:water_source" then
	...
	action = function(pos, node, active_object_count, active_object_count_wider)
		...
		if coral_state == 1 then
			...
			for p=1, #posses do
				...
				if checknode.name == "vlc_core:water_source" then
