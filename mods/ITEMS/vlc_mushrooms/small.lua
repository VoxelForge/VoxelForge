...
local on_place = vlc_util.generate_on_place_plant_function(function(place_pos, place_node)
	...
	return ((snn == "vlc_core:podzol" or snn == "vlc_core:podzol_snow" or snn == "vlc_core:mycelium" or snn == "vlc_core:mycelium_snow") or (light_ok and minetest.get_item_group(snn, "solid") == 1 and minetest.get_item_group(snn, "opaque") == 1))
end)
...
local function on_bone_meal(itemstack,placer,pointed_thing,pos,n)
	...
	if bn ~= "vlc_core:mycelium" and bn ~= "vlc_core:dirt" and minetest.get_item_group(bn, "grass_block") ~= 1 and bn ~= "vlc_core:coarse_dirt" and bn ~= "vlc_core:podzol" then
		return false
	end
	...
	height = 8
	if n.name == "vlc_mushrooms:mushroom_brown" then
		schematic = minetest.get_modpath("vlc_schematics").."/schems/vlc_mushrooms_huge_brown.mts"
		offset = vector.new(-3,-1,-3)
	elseif n.name == "vlc_mushrooms:mushroom_red" then
		schematic = minetest.get_modpath("vlc_schematics").."/schems/vlc_mushrooms_huge_red.mts"
...
minetest.register_node("vlc_mushrooms:mushroom_brown", {
...
minetest.register_node("vlc_mushrooms:mushroom_red", {
...
vlc_flowerpots.register_potted_flower("vlc_mushrooms:mushroom_brown", {
	name = "mushroom_brown",
	desc = S("Brown Mushroom"),
	image = "farming_mushroom_brown.png",
})

vlc_flowerpots.register_potted_flower("vlc_mushrooms:mushroom_red", {
	name = "mushroom_red",
	desc = S("Red Mushroom"),
	image = "farming_mushroom_red.png",
})

minetest.register_craftitem("vlc_mushrooms:mushroom_stew", {
...
minetest.register_craft({
	type = "shapeless",
	output = "vlc_mushrooms:mushroom_stew",
	recipe = {"vlc_core:bowl", "vlc_mushrooms:mushroom_brown", "vlc_mushrooms:mushroom_red"}
})
...
minetest.register_abm({
	...
	nodenames = {"vlc_mushrooms:mushroom_brown", "vlc_mushrooms:mushroom_red"},
	interval = 11,
	chance = 50,
