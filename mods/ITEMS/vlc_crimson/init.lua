...
-- by debiankaios
-- adapted for vlc2 by cora

local nether_plants = {
	["vlc_crimson:crimson_nylium"] = {
		"vlc_crimson:crimson_roots",
		"vlc_crimson:crimson_fungus",
		"vlc_crimson:warped_fungus",
	},
	["vlc_crimson:warped_nylium"] = {
		"vlc_crimson:warped_roots",
		"vlc_crimson:warped_fungus",
		"vlc_crimson:twisting_vines",
		"vlc_crimson:nether_sprouts",
	},
}

local place_fungus = vlc_util.generate_on_place_plant_function(function(pos, node)
...
local function on_bone_meal(itemstack,user,pt,pos,node)
	...
	if node.name == "vlc_crimson:warped_nylium" or node.name == "vlc_crimson:crimson_nylium" then
		spread_nether_plants(pt.under,node)
	end
end

local function check_for_bedrock(pos)
	local br = minetest.find_nodes_in_area(pos, vector.offset(pos, 0, 12, 0), {"vlc_core:bedrock"})
	return br and #br > 0
end
...
function set_vines_age(pos, node)
	...
	local vpos, i = vlc_util.traverse_tower(pos, -dir)
	for i = 1, i do
...
function grow_vines(pos, amount, vine, dir, max_age)
	...
	local tip, i = vlc_util.traverse_tower(pos, dir)
...
vlc_trees.register_wood("crimson",{
	...
	fence = {
		tiles = { "vlc_crimson_crimson_fence.png" },
	},
	fence_gate = {
		tiles = { "vlc_crimson_crimson_fence.png" },
	},
	door = {
		inventory_image = "vlc_crimson_crimson_door.png",
		tiles_bottom = {"vlc_crimson_crimson_door_bottom.png","vlc_doors_door_crimson_side_upper.png"},
		tiles_top = {"vlc_crimson_crimson_door_top.png","vlc_doors_door_crimson_side_upper.png"},
	},
	trapdoor = {
		tile_front = "vlc_crimson_crimson_trapdoor.png",
		tile_side = "vlc_crimson_crimson_trapdoor_side.png",
		wield_image = "vlc_crimson_crimson_trapdoor.png",
	},
})

vlc_trees.register_wood("warped",{
	...
	fence = {
		tiles = { "vlc_crimson_warped_fence.png" },
	},
	fence_gate = {
		tiles = { "vlc_crimson_warped_fence.png" },
	},
	door = {
		inventory_image = "vlc_crimson_warped_door.png",
		tiles_bottom = {"vlc_crimson_warped_door_bottom.png","vlc_doors_door_warped_side_upper.png"},
		tiles_top = {"vlc_crimson_warped_door_top.png","vlc_doors_door_warped_side_upper.png"},
	},
	trapdoor = {
		tile_front = "vlc_crimson_warped_trapdoor.png",
		tile_side = "vlc_crimson_warped_trapdoor_side.png",
		wield_image = "vlc_crimson_warped_trapdoor.png",
	},
})

minetest.register_node("vlc_crimson:warped_fungus", {
	...
	_on_bone_meal = function(itemstack,placer,pointed_thing,pos,node)
		if minetest.get_node_or_nil(vector.offset(pos,0,-1,0)).name == "vlc_crimson:warped_nylium" then
...
vlc_flowerpots.register_potted_flower("vlc_crimson:warped_fungus", {
	name = "warped_fungus",
...
local call_on_place = function(itemstack, placer, pointed_thing)
	...
	if vlc_util.check_position_protection(pos, placer) then return itemstack end
...
register_vines("vlc_crimson:twisting_vines", {
...
register_vines("vlc_crimson:weeping_vines", {
	description = S("Weeping Vines"),
	tiles = { "vlc_crimson_weeping_vines.png" },
	inventory_image = "vlc_crimson_weeping_vines.png",
...
minetest.register_node("vlc_crimson:nether_sprouts", {
	...
	drop = "",
	_vlc_shears_drop = true,
	_vlc_silk_touch_drop = false,
	_vlc_blast_resistance = 0,
})

minetest.register_node("vlc_crimson:warped_roots", {
...
vlc_flowerpots.register_potted_flower("vlc_crimson:warped_roots", {
	name = "warped_roots",
	desc = S("Warped Roots"),
...
minetest.register_node("vlc_crimson:warped_wart_block", {
...
minetest.register_node("vlc_crimson:shroomlight", {
...
minetest.register_node("vlc_crimson:warped_nylium", {
	description = S("Warped Nylium"),
	tiles = {
		"warped_nylium.png",
		"vlc_nether_netherrack.png",
		"vlc_nether_netherrack.png^warped_nylium_side.png",
		"vlc_nether_netherrack.png^warped_nylium_side.png",
		"vlc_nether_netherrack.png^warped_nylium_side.png",
		"vlc_nether_netherrack.png^warped_nylium_side.png",
	},
	drop = "vlc_nether:netherrack",
...
minetest.register_node("vlc_crimson:crimson_fungus", {
	...
	on_place = place_fungus,
	_on_bone_meal = function(itemstack,placer,pointed_thing,pos,node)
		if minetest.get_node(vector.offset(pos,0,-1,0)).name == "vlc_crimson:crimson_nylium" then
			if math.random() > 0.40 then return end --fungus has a 40% chance to grow when bone mealing
			if check_for_bedrock(pos) then return false end
			minetest.remove_node(pos)
...
vlc_flowerpots.register_potted_flower("vlc_crimson:crimson_fungus", {
	name = "crimson_fungus",
	desc = S("Crimson Fungus"),
	image = "farming_crimson_fungus.png",
})

minetest.register_node("vlc_crimson:crimson_roots", {
...
vlc_flowerpots.register_potted_flower("vlc_crimson:crimson_roots", {
	name = "crimson_roots",
	desc = S("Crimson Roots"),
	image = "crimson_roots.png",
})

minetest.register_node("vlc_crimson:crimson_nylium", {
	description = S("Crimson Nylium"),
	tiles = {
		"crimson_nylium.png",
		"vlc_nether_netherrack.png",
		"vlc_nether_netherrack.png^crimson_nylium_side.png",
		"vlc_nether_netherrack.png^crimson_nylium_side.png",
		"vlc_nether_netherrack.png^crimson_nylium_side.png",
		"vlc_nether_netherrack.png^crimson_nylium_side.png",
	},
...
minetest.register_abm({
	...
	nodenames = { "vlc_crimson:weeping_vines", "vlc_crimson:twisting_vines" },
	interval = 47 * 2.5,
	chance = 4,
	action = function(pos, node)
...
local crimson_wood = "vlc_crimson:crimson_hyphae_wood"
local warped_wood = "vlc_crimson:warped_hyphae_wood"

minetest.register_craft({
	output = "vlc_crimson:crimson_door 3",
	recipe = {
...
minetest.register_craft({
	output = "vlc_crimson:warped_door 3",
	recipe = {
...
minetest.register_craft({
	output = "vlc_crimson:crimson_trapdoor 2",
	recipe = {
...
minetest.register_craft({
	output = "vlc_crimson:warped_trapdoor 2",
	recipe = {
...
minetest.register_craft({
	output = "vlc_crimson:crimson_fence 3",
	recipe = {
		{crimson_wood, "vlc_core:stick", crimson_wood},
		{crimson_wood, "vlc_core:stick", crimson_wood},
	}
})

minetest.register_craft({
	output = "vlc_crimson:warped_fence 3",
	recipe = {
		{warped_wood, "vlc_core:stick", warped_wood},
		{warped_wood, "vlc_core:stick", warped_wood},
	}
})

minetest.register_craft({
	output = "vlc_crimson:crimson_fence_gate",
	recipe = {
		{"vlc_core:stick", crimson_wood, "vlc_core:stick"},
		{"vlc_core:stick", crimson_wood, "vlc_core:stick"},
	}
})

minetest.register_craft({
	output = "vlc_crimson:warped_fence_gate",
	recipe = {
		{"vlc_core:stick", warped_wood, "vlc_core:stick"},
		{"vlc_core:stick", warped_wood, "vlc_core:stick"},
	}
})
