...
function mcl_beds.register_bed(name, def)
	...
	minetest.register_node(name .. "_bottom", {
		...
		stack_max = 1,
		groups = {handy=1, bed = 1, bed_bottom = 1, dig_by_piston=1, bouncy=66, fall_damage_add_percent=-50, deco_block = 1, unsticky = 1, flammable=-1, _mcl_partial=3},
		_mcl_hardness = 0.2,
	...
	minetest.register_node(name .. "_top", {
		...
		paramtype2 = "facedir",
		is_ground_content = false,
		groups = {handy = 1, flammable = -1, bed = 2, bed_top = 1, dig_by_piston=1, bouncy=66, fall_damage_add_percent=-50, not_in_creative_inventory = 1, unsticky = 1, _mcl_partial = 3},
		_mcl_hardness = 0.2,
		_mcl_blast_resistance = 1,
		sounds = def.sounds or default_sounds,
		drop = def.recipe and name or "",
