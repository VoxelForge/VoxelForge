...
minetest.register_alias("vlc_wool:dark_blue", "wool:blue")
minetest.register_alias("vlc_wool:gold", "wool:yellow")
...
local messy_textures = { --translator table for the bed texture filenames names not adhering to the common color names of vlc_dyes
	["light_blue"] = "vlc_wool_light_blue",
	["grey"] = "wool_dark_grey",
	["silver"] = "wool_grey",
...
for color,colordef in pairs(vlc_dyes.colors) do
	...
	minetest.register_node("vlc_wool:"..color, {
	...
	minetest.register_node("vlc_wool:"..color.."_carpet", {
	...
	if mod_doc and not is_canonical then
		doc.add_entry_alias("nodes", "vlc_wool:"..canonical_color, "nodes", "vlc_wool:"..color)
		doc.add_entry_alias("nodes", "vlc_wool:"..canonical_color.."_carpet", "nodes", "vlc_wool:"..color.."_carpet")
	end

	minetest.register_craft({
		type = "shapeless",
		output = "vlc_wool:"..color,
		recipe = { "group:wool", "vlc_dyes:"..color }
	})

	minetest.register_craft({
		output = "vlc_wool:"..color.."_carpet 3",
		recipe = {{"vlc_wool:"..color, "vlc_wool:"..color}},
	})
end

minetest.register_craft({
	output = "vlc_wool:white",
	recipe = {
