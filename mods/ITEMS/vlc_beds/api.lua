...
local function kick_player_after_destruct(destruct_pos)
	for name, player_bed_pos in pairs(vlc_beds.bed_pos) do
...
local default_sounds = vlc_sounds.node_sound_wood_defaults({
	footstep = vlc_sounds.node_sound_wool_defaults().footstep,
})

function vlc_beds.register_bed(name, def)
	local common_box = {
			type = "fixed",
	...
	minetest.register_node(name .. "_bottom", {
		...
		on_rightclick = function(pos, node, clicker, itemstack, pointed_thing)
			vlc_beds.on_rightclick(pos, clicker, false)
			return itemstack
		end,
	...
	minetest.register_node(name .. "_top", {
		...
		on_rightclick = function(pos, node, clicker, itemstack, pointed_thing)
			vlc_beds.on_rightclick(pos, clicker, true)
			return itemstack
		end,
