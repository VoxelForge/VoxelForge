...
-- Flint and Steel
minetest.register_tool("vlf_fire:flint_and_steel", {
	...
	inventory_image = "vlf_fire_flint_and_steel.png",
	stack_max = 1,
	...
	_on_dispense = function(stack, pos, droppos, dropnode, dropdir)
		...
		-- Ignite TNT
		elseif dropnode.name == "vlf_tnt:tnt" then
			tnt.ignite(droppos)
			if not minetest.is_creative_enabled("") then
				stack:add_wear(65535/65) -- 65 uses
			end
...
minetest.register_craft({
	type = "shapeless",
	output = "vlf_fire:flint_and_steel",
	recipe = { "vlf_core:iron_ingot", "vlf_core:flint"},
})
