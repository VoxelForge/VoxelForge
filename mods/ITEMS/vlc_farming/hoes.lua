...
minetest.register_tool("vlc_farming:hoe_wood", {
...
minetest.register_craft({
	type = "fuel",
	recipe = "vlc_farming:hoe_wood",
	burntime = 10,
})

minetest.register_tool("vlc_farming:hoe_stone", {
...
minetest.register_tool("vlc_farming:hoe_iron", {
...
minetest.register_craft({
	...
	recipe = "vlc_farming:hoe_iron",
	cooktime = 10,
})

minetest.register_tool("vlc_farming:hoe_gold", {
...
minetest.register_craft({
	...
	recipe = "vlc_farming:hoe_gold",
	cooktime = 10,
})

minetest.register_tool("vlc_farming:hoe_diamond", {
	...
	_vlc_upgrade_item = "vlc_farming:hoe_netherite"
})

minetest.register_craft({
	output = "vlc_farming:hoe_diamond",
	recipe = {
...
minetest.register_tool("vlc_farming:hoe_netherite", {
