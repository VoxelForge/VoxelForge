...
local function on_bone_meal(itemstack,placer,pointed_thing,pos,node)
	return vlc_farming.on_bone_meal(itemstack,placer,pointed_thing,pos,node,"plant_carrot")
end
...
for i=1, 7 do
	...
	minetest.register_node("vlc_farming:carrot_"..i, {
...
minetest.register_node("vlc_farming:carrot", {
	...
	drop = {
		max_items = 1,
		items = {
			{ items = {"vlc_farming:carrot_item 4"}, rarity = 5 },
			{ items = {"vlc_farming:carrot_item 3"}, rarity = 2 },
			{ items = {"vlc_farming:carrot_item 2"}, rarity = 2 },
			{ items = {"vlc_farming:carrot_item 1"} },
		}
	},
	selection_box = {
		type = "fixed",
...
minetest.register_craftitem("vlc_farming:carrot_item", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		local new = vlc_farming:place_seed(itemstack, placer, pointed_thing, "vlc_farming:carrot_1")
		if new then
			return new
		else
...
minetest.register_craftitem("vlc_farming:carrot_item_gold", {
	...
	_vlc_saturation = 14.4,
})

minetest.register_craft({
	output = "vlc_farming:carrot_item_gold",
	recipe = {
		{"vlc_core:gold_nugget", "vlc_core:gold_nugget", "vlc_core:gold_nugget"},
		{"vlc_core:gold_nugget", "vlc_farming:carrot_item", "vlc_core:gold_nugget"},
		{"vlc_core:gold_nugget", "vlc_core:gold_nugget", "vlc_core:gold_nugget"},
	}
})

vlc_farming:add_plant("plant_carrot", "vlc_farming:carrot", {"vlc_farming:carrot_1", "vlc_farming:carrot_2", "vlc_farming:carrot_3", "vlc_farming:carrot_4", "vlc_farming:carrot_5", "vlc_farming:carrot_6", "vlc_farming:carrot_7"}, 25, 20)

if minetest.get_modpath("doc") then
	for i=2,7 do
		doc.add_entry_alias("nodes", "vlc_farming:carrot_1", "nodes", "vlc_farming:carrot_"..i)
	end
end
