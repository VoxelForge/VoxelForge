...
local function spawn_stand_entity(pos, node)
	local luaentity = minetest.add_entity(pos, "vlf_armor_stand:armor_entity"):get_luaentity()
	if luaentity then
...
minetest.register_node("vlf_armor_stand:armor_stand", {
	...
	tiles = {"default_wood.png", "vlf_stairs_stone_slab_top.png"},
	paramtype = "light",
	paramtype2 = "facedir",
	walkable = false,
...
minetest.register_entity("vlf_armor_stand:armor_entity", {
	initial_properties = {
		physical = true,
		visual = "mesh",
...
minetest.register_lbm({
	...
	name = "vlf_armor_stand:respawn_entities",
	nodenames = {"vlf_armor_stand:armor_stand"},
...
minetest.register_craft({
	output = "vlf_armor_stand:armor_stand",
	recipe = {
		{"vlf_core:stick", "vlf_core:stick", "vlf_core:stick"},
		{"", "vlf_core:stick", ""},
		{"vlf_core:stick", "vlf_stairs:slab_stone", "vlf_core:stick"},
	}
})

-- Legacy handling
minetest.register_alias("3d_armor_stand:armor_stand", "vlf_armor_stand:armor_stand")
minetest.register_entity(":3d_armor_stand:armor_entity", {
	on_activate = function(self)
		minetest.log("action", "[vlf_armor_stand] Removing legacy entity: 3d_armor_stand:armor_entity")
		self.object:remove()
	end,
	static_save = false,
})
