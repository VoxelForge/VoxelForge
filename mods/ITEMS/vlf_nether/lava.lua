...
local lava_src_def = table.copy(minetest.registered_nodes["vlf_core:lava_source"])
...
lava_src_def.liquid_alternative_source = "vlf_nether:nether_lava_source"
lava_src_def.liquid_alternative_flowing = "vlf_nether:nether_lava_flowing"
minetest.register_node("vlf_nether:nether_lava_source", lava_src_def)

local lava_flow_def = table.copy(minetest.registered_nodes["vlf_core:lava_flowing"])
lava_flow_def.description = S("Flowing Nether Lava")
lava_flow_def._doc_items_create_entry = false
lava_flow_def.liquid_range = 7
lava_flow_def.liquid_alternative_flowing = "vlf_nether:nether_lava_flowing"
lava_flow_def.liquid_alternative_source = "vlf_nether:nether_lava_source"
minetest.register_node("vlf_nether:nether_lava_flowing", lava_flow_def)
