...
function vlc_doors:register_door(name, def)
	...
	minetest.register_node(":"..name.."_b_1", {
		...
		_on_wind_charge_hit = function(pos)
			...
			if node.name ~= "vlc_doors:iron_door_b_1" then
	...
	minetest.register_node(":"..name.."_t_1", {
		...
		_on_wind_charge_hit = function(pos)
			local node = minetest.get_node(pos)
			if node.name ~= "vlc_doors:iron_door_t_1" then
	...
	minetest.register_node(":"..name.."_b_2", {
		...
		_on_wind_charge_hit = function(pos)
			local node = minetest.get_node(pos)
			if node.name ~= "vlc_doors:iron_door_b_2" then
	...
	minetest.register_node(":"..name.."_t_2", {
		...
		_on_wind_charge_hit = function(pos)
			local node = minetest.get_node(pos)
			if node.name ~= "vlc_doors:iron_door_t_2" then
