...
minetest.register_abm({
	...
	neighbors = {"vlc_amethyst:budding_amethyst"},
	interval = interval,
	chance = chance,
	action = grow,
})
...
minetest.register_abm({
	...
	nodenames = {"vlc_amethyst:budding_amethyst"},
	...
	action = function(pos)
		...
		local new_node = {name = "vlc_amethyst:small_amethyst_bud", param2 = param2}
