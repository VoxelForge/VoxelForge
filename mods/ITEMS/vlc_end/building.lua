...
minetest.register_node("vlc_end:end_stone", {
	description = S("End Stone"),
	_doc_items_longdesc = doc.sub.items.temp.build,
	tiles = {"vlc_end_end_stone.png"},
	...
	_vlc_blast_resistance = 9,
	_vlc_hardness = 3,
})

minetest.register_node("vlc_end:end_bricks", {
	description = S("End Stone Bricks"),
	_doc_items_longdesc = doc.sub.items.temp.build,
	tiles = {"vlc_end_end_bricks.png"},
	is_ground_content = false,
	groups = {pickaxey=1, building_block=1, material_stone=1, stonecuttable = 1},
	sounds = vlc_sounds.node_sound_stone_defaults(),
	_vlc_blast_resistance = 9,
	_vlc_hardness = 3,
	_vlc_stonecutter_recipes = {"vlc_end:end_stone"},
})

minetest.register_node("vlc_end:purpur_block", {
	description = S("Purpur Block"),
	_doc_items_longdesc = doc.sub.items.temp.build,
	tiles = {"vlc_end_purpur_block.png"},
	is_ground_content = false,
...
minetest.register_node("vlc_end:purpur_pillar", {
	description = S("Purpur Pillar"),
	_doc_items_longdesc = doc.sub.items.temp.build,
	paramtype2 = "facedir",
	is_ground_content = false,
	on_place = vlc_util.rotate_axis,
	tiles = {"vlc_end_purpur_pillar_top.png", "vlc_end_purpur_pillar_top.png", "vlc_end_purpur_pillar.png"},
...
minetest.register_node("vlc_end:end_rod", {
	description = S("End Rod"),
	_doc_items_longdesc = S("End rods are decorative light sources."),
	tiles = {
		"vlc_end_end_rod_top.png",
		"vlc_end_end_rod_bottom.png",
		"vlc_end_end_rod_side.png",
		"vlc_end_end_rod_side.png",
		"vlc_end_end_rod_side.png",
		"vlc_end_end_rod_side.png",
	},
...
vlc_stairs.register_stair_and_slab("end_bricks", {
	baseitem = "vlc_end:end_bricks",
	description_stair = S("End Stone Brick Stairs"),
	description_slab = S("End Stone Brick Slab"),
	overrides = {_vlc_stonecutter_recipes = {"vlc_end:end_bricks","vlc_end:end_stone"}},{_vlc_stonecutter_recipes = {"vlc_end:end_bricks","vlc_end:end_stone"}}
})

vlc_stairs.register_stair_and_slab("purpur_block", {
	baseitem = "vlc_end:purpur_block",
	description_stair = S("Purpur Stairs"),
	description_slab = S("Purpur Slab"),
	recipeitem = "group:purpur_block",
	overrides = {_vlc_stonecutter_recipes = {"vlc_end:purpur_block"}}
})

-- Crafting recipes
minetest.register_craft({
	output = "vlc_end:end_bricks 4",
	recipe = {
		{"vlc_end:end_stone", "vlc_end:end_stone"},
		{"vlc_end:end_stone", "vlc_end:end_stone"},
	}
})

minetest.register_craft({
	output = "vlc_end:purpur_block 4",
	recipe = {
		{"vlc_end:chorus_fruit_popped", "vlc_end:chorus_fruit_popped",},
		{"vlc_end:chorus_fruit_popped", "vlc_end:chorus_fruit_popped",},
	}
})

minetest.register_craft({
	output = "vlc_end:end_rod 4",
	recipe = {
		{"vlc_mobitems:blaze_rod"},
		{"vlc_end:chorus_fruit_popped"},
	},
})
