...
local function get_tiles(state, mode)
	local top = "vlc_comparators_"..state..".png^"..
		"vlc_comparators_"..mode..".png"
	local sides = "vlc_comparators_sides_"..state..".png^"..
		"vlc_comparators_sides_"..mode..".png"
	local ends = "vlc_comparators_ends_"..state..".png^"..
		"vlc_comparators_ends_"..mode..".png"
	return {
		top, "vlc_stairs_stone_slab_top.png",
...
local function make_rightclick_handler(state, mode)
	local newnodename =
		"vlc_comparators:comparator_"..state.."_"..flipmode(mode)
...
local icon = "vlc_comparators_item.png"
...
for _, mode in pairs{"comp", "sub"} do
	for _, state in pairs{mesecon.state.on, mesecon.state.off} do
		...
		local nodename =
			"vlc_comparators:comparator_"..state_str.."_"..mode
		...
		local nodedef = {
			...
			--wield_image = "vlc_comparators_off.png",
			...
			drop = "vlc_comparators:comparator_off_comp",
			on_construct = update_self,
			on_rightclick =
				make_rightclick_handler(state_str, mode),
			comparator_mode = mode,
			comparator_onstate = "vlc_comparators:comparator_on_"..mode,
			comparator_offstate = "vlc_comparators:comparator_off_"..mode,
		...
		vlc_wip.register_wip_item(nodename)
	end
end

-- Register recipies
local rstorch = "mesecons_torch:mesecon_torch_on"
local quartz  = "vlc_nether:quartz"
local stone   = "vlc_core:stone"

minetest.register_craft({
	output = "vlc_comparators:comparator_off_comp",
	recipe = {
		{ "",      rstorch, ""      },
...
minetest.register_abm({
	...
	nodenames = {
		"vlc_comparators:comparator_off_comp",
		"vlc_comparators:comparator_off_sub",
	},
...
minetest.register_abm({
	...
	nodenames = {
		"vlc_comparators:comparator_on_comp",
		"vlc_comparators:comparator_on_sub",
	},
...
if minetest.get_modpath("doc") then
	doc.add_entry_alias("nodes", "vlc_comparators:comparator_off_comp",
				"nodes", "vlc_comparators:comparator_off_sub")
	doc.add_entry_alias("nodes", "vlc_comparators:comparator_off_comp",
				"nodes", "vlc_comparators:comparator_on_comp")
	doc.add_entry_alias("nodes", "vlc_comparators:comparator_off_comp",
				"nodes", "vlc_comparators:comparator_on_sub")
end
