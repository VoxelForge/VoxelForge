...
- One node for the horizontal-facing dispensers (vlf_dispensers:dispenser)
- One node for the upwards-facing dispensers (vlf_dispenser:dispenser_up)
- One node for the downwards-facing dispensers (vlf_dispenser:dispenser_down)
...
local function orientate_dispenser(pos, placer)
	...
	if pitch > 55 then
		minetest.swap_node(pos, { name = "vlf_dispensers:dispenser_up", param2 = node.param2 })
	elseif pitch < -55 then
		minetest.swap_node(pos, { name = "vlf_dispensers:dispenser_down", param2 = node.param2 })
	end
end
...
minetest.register_node("vlf_dispensers:dispenser", horizontal_def)
...
down_def.drop = "vlf_dispensers:dispenser"
minetest.register_node("vlf_dispensers:dispenser_down", down_def)
...
minetest.register_node("vlf_dispensers:dispenser_up", up_def)
...
minetest.register_lbm({
	...
	name = "vlf_dispensers:update_formspecs_0_60_0",
	nodenames = { "vlf_dispensers:dispenser", "vlf_dispensers:dispenser_down", "vlf_dispensers:dispenser_up" },
	action = function(pos, node)
		setup_dispenser(pos)
		minetest.log("action", "[vlf_dispenser] Node formspec updated at " .. minetest.pos_to_string(pos))
	end,
})
