...
local dispenser_formspec = table.concat({
	...
	"label[4.125,0.375;" .. F(C(vlf_formspec.label_color, S("Dispenser"))) .. "]",

	vlf_formspec.get_itemslot_bg_v4(4.125, 0.75, 3, 3),
...
local function orientate(pos, placer, basename)
	...
	if pitch_deg > 55 then
		minetest.swap_node(pos, { name = "vlf_dispensers:"..basename.."_up", param2 = node.param2 })
	elseif pitch_deg < -55 then
		minetest.swap_node(pos, { name = "vlf_dispensers:"..basename.."_down", param2 = node.param2 })
	end
end
...
local function activate_dropper(pos, droppos, dropdir, inv, stack_)
	...
	local dropped = vlf_util.move_item_container(pos, droppos, nil, stack_.stackpos)
	...
	if igroups.armor then -- Armor, mob heads and pumpkins
		...
		for _, objs in ipairs({ minetest.get_objects_inside_radius(droppos, 1),
			...
			for _, obj in ipairs(objs) do
				stack = vlf_armor.equip(stack, obj)
		...
		if not stack:is_empty() then
			if igroups.head or iname == "vlf_farming:pumpkin_face" then
...
do
	...
	minetest.register_node("vlf_dispensers:dispenser", table.merge(dispenserdef, {
		...
		tiles = {
			...
			"default_furnace_side.png", "vlf_dispensers_dispenser_front_horizontal.png"
		},
		paramtype2 = "facedir",
	...
	minetest.register_node("vlf_dispensers:dispenser_down", table.merge(dispenserdef, {
		description = S("Dispenser"),
		after_place_node = setup_dispenser,
		tiles = {
			"default_furnace_top.png", "vlf_dispensers_dispenser_front_vertical.png",
			"default_furnace_side.png", "default_furnace_side.png",
			"default_furnace_side.png", "default_furnace_side.png"
		},
		groups = table.merge(dispenserdef.groups, { not_in_creative_inventory = 1, }),
		_doc_items_create_entry = false,
		drop = "vlf_dispensers:dispenser",
	}))
	minetest.register_node("vlf_dispensers:dispenser_up", table.merge(dispenserdef, {
		description = S("Dispenser"),
		after_place_node = setup_dispenser,
		tiles = {
			"vlf_dispensers_dispenser_front_vertical.png", "default_furnace_bottom.png",
			"default_furnace_side.png", "default_furnace_side.png",
			"default_furnace_side.png", "default_furnace_side.png"
		},
		groups = table.merge(dispenserdef.groups, { not_in_creative_inventory = 1, }),
	...
	minetest.register_craft({
		output = "vlf_dispensers:dispenser",
		recipe = {
			{ "vlf_core:cobble", "vlf_core:cobble", "vlf_core:cobble", },
			{ "vlf_core:cobble", "vlf_bows:bow", "vlf_core:cobble", },
			{ "vlf_core:cobble", "vlf_redstone:redstone", "vlf_core:cobble", },
		}
	})

	doc.add_entry_alias("nodes", "vlf_dispensers:dispenser", "nodes", "vlf_dispensers:dispenser_down")
	doc.add_entry_alias("nodes", "vlf_dispensers:dispenser", "nodes", "vlf_dispensers:dispenser_up")
end
...
do
	...
	minetest.register_node("vlf_dispensers:dropper", table.merge(dropperdef, {
		...
		tiles = {
			"default_furnace_top.png", "default_furnace_bottom.png",
			"default_furnace_side.png", "default_furnace_side.png",
			"default_furnace_side.png", "vlf_droppers_dropper_front_horizontal.png"
		},
		paramtype2 = "facedir",
		after_place_node = function(pos, placer, itemstack, pointed_thing)
			setup_dispenser(pos)
	...
	minetest.register_node("vlf_dispensers:dropper_down", table.merge(dropperdef, {
		description = S("Dropper"),
		after_place_node = setup_dispenser,
		tiles = {
			"default_furnace_top.png", "vlf_droppers_dropper_front_vertical.png",
			"default_furnace_side.png", "default_furnace_side.png",
			"default_furnace_side.png", "default_furnace_side.png"
		},
		groups = table.merge(dropperdef.groups, { not_in_creative_inventory = 1, }),
		_doc_items_create_entry = false,
		drop = "vlf_dispensers:dropper",
	}))
	minetest.register_node("vlf_dispensers:dropper_up", table.merge(dropperdef, {
		description = S("Dropper"),
		after_place_node = setup_dispenser,
		tiles = {
			"vlf_droppers_dropper_front_vertical.png", "default_furnace_bottom.png",
			"default_furnace_side.png", "default_furnace_side.png",
			"default_furnace_side.png", "default_furnace_side.png"
		},
		groups = table.merge(dropperdef.groups, { not_in_creative_inventory = 1, }),
	...
	minetest.register_craft({
		output = "vlf_dispensers:dropper",
		recipe = {
			{ "vlf_core:cobble", "vlf_core:cobble", "vlf_core:cobble", },
			{ "vlf_core:cobble", "", "vlf_core:cobble", },
			{ "vlf_core:cobble", "vlf_redstone:redstone", "vlf_core:cobble", },
		}
	})

	doc.add_entry_alias("nodes", "vlf_droppers:dropper", "nodes", "vlf_droppers:dropper_down")
	doc.add_entry_alias("nodes", "vlf_droppers:dropper", "nodes", "vlf_droppers:dropper_up")
end
