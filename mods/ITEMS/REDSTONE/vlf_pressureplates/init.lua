...
function vlf_redstone.register_pressure_plate(basename, description, textures_off, textures_on, image_w, image_i, recipe, sounds, plusgroups, activated_by, longdesc, burntime)
...
vlf_redstone.register_pressure_plate(
	"vlf_pressureplates:pressure_plate_stone",
...
vlf_redstone.register_pressure_plate(
	"vlf_pressureplates:pressure_plate_polished_blackstone",
