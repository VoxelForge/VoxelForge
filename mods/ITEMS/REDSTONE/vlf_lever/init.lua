...
-- LEVER
minetest.register_node("vlf_lever:lever_off", table.merge(commdef, {
	...
	on_rightclick = function(pos, node)
		minetest.set_node(pos, {name="vlf_lever:lever_on", param2=node.param2})
...
minetest.register_node("vlf_lever:lever_on", table.merge(commdef, {
	drawtype = "mesh",
	mesh = "mesecons_walllever_lever_on.obj",
	groups = table.merge(commdef.groups, {not_in_creative_inventory = 1}),
	_doc_items_create_entry = false,
	on_rightclick = function(pos, node)
		minetest.set_node(pos, {name="vlf_lever:lever_off", param2=node.param2})
...
if minetest.get_modpath("doc") then
	doc.add_entry_alias("nodes", "vlf_lever:lever_off", "nodes", "vlf_lever:lever_on")
end
