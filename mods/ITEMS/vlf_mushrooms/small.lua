...
minetest.register_node("vlf_mushrooms:mushroom_brown", {
...
minetest.register_node("vlf_mushrooms:mushroom_red", {
...
vlf_flowerpots.register_potted_flower("vlf_mushrooms:mushroom_brown", {
	name = "mushroom_brown",
	desc = S("Brown Mushroom"),
	image = "farming_mushroom_brown.png",
})

vlf_flowerpots.register_potted_flower("vlf_mushrooms:mushroom_red", {
	name = "mushroom_red",
	desc = S("Red Mushroom"),
	image = "farming_mushroom_red.png",
})

minetest.register_craftitem("vlf_mushrooms:mushroom_stew", {
...
minetest.register_craft({
	type = "shapeless",
	output = "vlf_mushrooms:mushroom_stew",
	recipe = {"vlf_core:bowl", "vlf_mushrooms:mushroom_brown", "vlf_mushrooms:mushroom_red"}
})
...
minetest.register_abm({
	...
	nodenames = {"vlf_mushrooms:mushroom_brown", "vlf_mushrooms:mushroom_red"},
	interval = 11,
	chance = 50,
