...
red.drop = {
	items = {
		{ items = {"vlf_mushrooms:mushroom_red"}, rarity = 2 },
		{ items = {"vlf_mushrooms:mushroom_red"}, rarity = 2 },
	}
}
...
brown.drop = {
	items = {
		{ items = {"vlf_mushrooms:mushroom_brown"}, rarity = 2 },
		{ items = {"vlf_mushrooms:mushroom_brown"}, rarity = 2 },
	}
}
...
local function register_mushroom(color, species_id, template, d_cap, d_stem, d_stem_all, longdesc_cap, longdesc_stem)
	...
	stem_full.tiles = { "vlf_mushrooms_mushroom_block_skin_stem.png" }
	stem_full.groups.huge_mushroom = species_id
	stem_full.groups.huge_mushroom_stem = 2
	stem_full.groups.compostability = 65
	minetest.register_node("vlf_mushrooms:"..color.."_mushroom_block_stem_full", stem_full)

	-- Stem
	local stem = table.copy(template)
	stem.description = d_stem
	stem._doc_items_longdesc = longdesc_stem
	stem.tiles = { "vlf_mushrooms_mushroom_block_inside.png", "vlf_mushrooms_mushroom_block_inside.png", "vlf_mushrooms_mushroom_block_skin_stem.png" }
	stem.groups.huge_mushroom = species_id
	stem.groups.huge_mushroom_stem = 1
	stem.groups.compostability = 65
	minetest.register_node("vlf_mushrooms:"..color.."_mushroom_block_stem", stem)
	...
	for s=0,63 do
		...
		if s == 63 then
			...
			block.tiles = { "vlf_mushrooms_mushroom_block_skin_"..color..".png" }
			...
			for t=1, string.len(bin) do
				if string.sub(bin, t, t) == "1" then
					block.tiles[t] = "vlf_mushrooms_mushroom_block_skin_"..color..".png"
				else
					block.tiles[t] = "vlf_mushrooms_mushroom_block_inside.png"
				end
			end

			if minetest.get_modpath("doc") then
				doc.add_entry_alias("nodes", "vlf_mushrooms:"..color.."_mushroom_block_cap_111111", "nodes", "vlf_mushrooms:"..color.."_mushroom_block_cap_"..bin)
			end
		end
		...
		-- 0 = pores; 1 = cap.
		minetest.register_node("vlf_mushrooms:"..color.."_mushroom_block_cap_"..bin, block)
	end
...
for c=1, 2 do
	...
	minetest.register_alias("vlf_mushrooms:"..color.."_mushroom_block_cap_full", "vlf_mushrooms:"..color.."_mushroom_block_cap_111111")
	minetest.register_alias("vlf_mushrooms:"..color.."_mushroom_block_cap_top", "vlf_mushrooms:"..color.."_mushroom_block_cap_100000")
	minetest.register_alias("vlf_mushrooms:"..color.."_mushroom_block_pores_full", "vlf_mushrooms:"..color.."_mushroom_block_cap_000000")
end

minetest.register_lbm({
	label = "Replace legacy mushroom cap blocks",
	name = "vlf_mushrooms:replace_legacy_mushroom_caps",
	nodenames = { "vlf_mushrooms:brown_mushroom_block_cap_corner", "vlf_mushrooms:brown_mushroom_block_cap_side", "vlf_mushrooms:red_mushroom_block_cap_corner", "vlf_mushrooms:red_mushroom_block_cap_side" },
	action = function(pos, node)
		for c=1, 2 do
			local color = colors[c]
			if node.name == "vlf_mushrooms:"..color.."_mushroom_block_cap_side" then
				if node.param2 == 0 then
					minetest.set_node(pos, {name = "vlf_mushrooms:"..color.."_mushroom_block_cap_100001"})
				elseif node.param2 == 1 then
					minetest.set_node(pos, {name = "vlf_mushrooms:"..color.."_mushroom_block_cap_100100"}) -- OK
				elseif node.param2 == 2 then
					minetest.set_node(pos, {name = "vlf_mushrooms:"..color.."_mushroom_block_cap_100010"})
				elseif node.param2 == 3 then
					minetest.set_node(pos, {name = "vlf_mushrooms:"..color.."_mushroom_block_cap_101000"})
				else
					-- Fallback
					minetest.set_node(pos, {name = "vlf_mushrooms:"..color.."_mushroom_block_cap_101111"})
				end
			elseif node.name == "vlf_mushrooms:"..color.."_mushroom_block_cap_corner" then
				if node.param2 == 0 then
					minetest.set_node(pos, {name = "vlf_mushrooms:"..color.."_mushroom_block_cap_101001"})
				elseif node.param2 == 1 then
					minetest.set_node(pos, {name = "vlf_mushrooms:"..color.."_mushroom_block_cap_100101"}) -- OK
				elseif node.param2 == 2 then
					minetest.set_node(pos, {name = "vlf_mushrooms:"..color.."_mushroom_block_cap_100110"}) -- OK
				elseif node.param2 == 3 then
					minetest.set_node(pos, {name = "vlf_mushrooms:"..color.."_mushroom_block_cap_101010"})
				else
					-- Fallback
					minetest.set_node(pos, {name = "vlf_mushrooms:"..color.."_mushroom_block_cap_101111"})
				end
