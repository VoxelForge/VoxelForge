...
function vlc_fences.register_fence(id, fence_name, texture, groups, hardness, blast_resistance, connects_to, sounds)
	...
	minetest.register_node(fence_id, {
		...
		tiles = {texture},
		inventory_image = "vlc_fences_fence_mask.png^" .. texture .. "^vlc_fences_fence_mask.png^[makealpha:255,126,126",
		wield_image = "vlc_fences_fence_mask.png^" .. texture .. "^vlc_fences_fence_mask.png^[makealpha:255,126,126",
		paramtype = "light",
		...
		sounds = sounds,
		_vlc_blast_resistance = blast_resistance,
		_vlc_hardness = hardness,
	})

	return fence_id
end

function vlc_fences.register_fence_gate(id, fence_gate_name, texture, groups, hardness, blast_resistance, sounds, sound_open, sound_close, sound_gain_open, sound_gain_close)
	local meta2
	local state2 = 0
	...
	local gate_id = "vlc_fences:"..id.."_gate"
	...
	minetest.register_node(":"..gate_id, {
		...
		tiles = {texture},
		inventory_image = "vlc_fences_fence_gate_mask.png^" .. texture .. "^vlc_fences_fence_gate_mask.png^[makealpha:255,126,126",
		wield_image = "vlc_fences_fence_gate_mask.png^" .. texture .. "^vlc_fences_fence_gate_mask.png^[makealpha:255,126,126",
		paramtype = "light",
		is_ground_content = false,
		paramtype2 = "facedir",
		sunlight_propagates = true,
...
function vlc_fences.register_fence_and_fence_gate(id, fence_name, fence_gate_name, texture_fence, groups, hardness, blast_resistance, connects_to, sounds, sound_open, sound_close, sound_gain_open, sound_gain_close, texture_fence_gate)
	if texture_fence_gate == nil then
		texture_fence_gate = texture_fence
	end
	local fence_id = vlc_fences.register_fence(id, fence_name, texture_fence, groups, hardness, blast_resistance, connects_to, sounds)
	local gate_id, open_gate_id = vlc_fences.register_fence_gate(id, fence_gate_name, texture_fence_gate, groups, hardness, blast_resistance, sounds, sound_open, sound_close, sound_gain_open, sound_gain_close)
