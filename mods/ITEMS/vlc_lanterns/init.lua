...
local modpath = minetest.get_modpath("vlc_lanterns")
...
local allowed_non_solid_nodes_floor = {
	"vlc_core:ice",
	"vlc_nether:soul_sand",
	"vlc_mobspawners:spawner",
	"vlc_core:barrier",
	"vlc_end:chorus_flower",
	"vlc_end:chorus_flower_dead",
	"vlc_end:end_rod",
	"vlc_end:dragon_egg",
	"vlc_portals:end_portal_frame_eye",
	"vlc_lanterns:chain"
}
...
function vlc_lanterns.register_lantern(name, def)
	local itemstring_floor = "vlc_lanterns:"..name.."_floor"
	local itemstring_ceiling = "vlc_lanterns:"..name.."_ceiling"

	local sounds = vlc_sounds.node_sound_metal_defaults()
	...
	minetest.register_node(itemstring_floor, {
		...
		drawtype = "mesh",
		mesh = "vlc_lanterns_lantern_floor.obj",
	...
	minetest.register_node(itemstring_ceiling, {
		...
		drawtype = "mesh",
		mesh = "vlc_lanterns_lantern_ceiling.obj",
		tiles = {
			{
				name = def.texture,
				animation = {type = "vertical_frames", aspect_w = 16, aspect_h = 16, length = 3.3}
...
minetest.register_node("vlc_lanterns:chain", {
	description = S("Chain"),
	_doc_items_longdesc = S("Chains are metallic decoration blocks."),
	inventory_image = "vlc_lanterns_chain_inv.png",
	tiles = {"vlc_lanterns_chain.png"},
	drawtype = "mesh",
	paramtype = "light",
	paramtype2 = "facedir",
	use_texture_alpha = "clip",
	mesh = "vlc_lanterns_chain.obj",
...
minetest.register_craft({
	output = "vlc_lanterns:chain",
	recipe = {
		{"vlc_core:iron_nugget"},
		{"vlc_core:iron_ingot"},
		{"vlc_core:iron_nugget"},
	},
})
