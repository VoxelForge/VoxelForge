...
function vlf_enchanting.depth_strider_level (mob)
	...
	return stack:is_empty () and 0
		or vlf_enchanting.get_enchantment (stack, "depth_strider")
end
...
minetest.register_on_punchplayer(function(player, hitter)
	local wielditem = hitter and vlf_util.get_wielditem (hitter)
	if wielditem then
...
function minetest.calculate_knockback(player, hitter, time_from_last_punch, tool_capabilities, dir, distance, damage)
	-- Core knockback computation is overridden by vlf_player.
	return 0
end
