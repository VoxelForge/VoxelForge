...
minetest.register_alias("vlf_core:redstone_ore_lit", "vlf_core:stone_with_redstone_lit")
...
minetest.register_alias("vlf_deepslate:deepslate_redstone_lit_ore", "vlf_deepslate:deepslate_with_redstone_lit")
...
minetest.register_alias("vlf_deepslate:deepslate_diamond_ore", "vlf_deepslate:deepslate_with_diamond")
-- vlf_structures
...
-- vlf_vaults
minetest.register_alias("vlf_trials:vault", "vlf_vaults:vault")
minetest.register_alias("vlf_trials:vault_on", "vlf_vaults:vault_on")
minetest.register_alias("vlf_trials:ominous_vault", "vlf_vaults:ominous_vault")
minetest.register_alias("vlf_trials:ominous_vault_on", "vlf_vaults:ominous_vault_on")
minetest.register_alias("vlf_trials:ominous_vault_ejecting", "vlf_vaults:ominous_vault_ejecting")
minetest.register_alias("vlf_trials:vault_ejecting", "vlf_vaults:vault_ejecting")
-- vlf_buttons
...
-- vlf_chests
minetest.register_alias("vlf_chests:light_blue_shulker_box_small", "vlf_chests:lightblue_shulker_box_small")
minetest.register_alias("vlf_chests:silver_shulker_box_small", "vlf_chests:grey_shulker_box_small")
minetest.register_alias("vlf_chests:lime_shulker_box_small", "vlf_chests:green_shulker_box_small")
minetest.register_alias("vlf_chests:purple_shulker_box_small", "vlf_chests:violet_shulker_box_small")
-- vlf_amethyst
minetest.register_alias("vlf_amethyst:budding_amethyst", "vlf_amethyst:budding_amethyst_block")
-- vlf_bamboo
